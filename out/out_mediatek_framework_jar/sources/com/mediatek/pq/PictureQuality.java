...
public class PictureQuality {
    ...
    private static native void nativeSetPQLogEnable(boolean z);
    ...
    private static native boolean nativeSetTranPictureMode(int i, int i2, int i3, int i4, int i5, int i6);
    ...
    public static boolean setTranPictureMode(int mode, String packageName, int sha, int sat, int con, int bri, int step) {
        return nativeSetTranPictureMode(mode, sha, sat, con, bri, step);
    }

    public static void setPQLogEnable(boolean enable) {
        nativeSetPQLogEnable(enable);
    }
    ...
    public static void SetESS20Enable(boolean isEnable, int ELVSSPNIndex, boolean choice) {
        nativeSetESS20Enable(isEnable, ELVSSPNIndex, choice);
    }
}
