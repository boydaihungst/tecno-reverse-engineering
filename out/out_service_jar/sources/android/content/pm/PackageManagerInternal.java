...
public abstract class PackageManagerInternal {
    ...
    public abstract boolean filterAppAccess(String str, int i, int i2);
    ...
    public abstract AndroidPackageApi getAndroidPackage(String str);
    ...
    public abstract void pruneCachedApksInApex(List<PackageInfo> list);
    ...
    public abstract boolean setEnabledOverlayPackages(int i, String str, OverlayPaths overlayPaths, Set<String> set);
    ...
    public abstract boolean wasPackageLatestStopped(String str, int i);
    ...
    public static abstract class InstalledLoadingProgressCallback {
        ...
        public class LoadingProgressCallbackBinder extends IPackageLoadingProgressCallback.Stub {
            ...
            public void onPackageLoadingProgressChanged(float progress) {
                ...
                }, InstalledLoadingProgressCallback.this, Float.valueOf(progress)).recycleOnUse());
            }
        }
    }
}
