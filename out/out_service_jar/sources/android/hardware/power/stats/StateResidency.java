...
public class StateResidency implements Parcelable {
    public static final Parcelable.Creator<StateResidency> CREATOR = new Parcelable.Creator<StateResidency>() { // from class: android.hardware.power.stats.StateResidency.1
        ...
        public StateResidency createFromParcel(Parcel _aidl_source) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeLong(this.totalTimeInStateMs);
        _aidl_parcel.writeLong(this.totalStateEntryCount);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.totalTimeInStateMs = _aidl_parcel.readLong();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.totalStateEntryCount = _aidl_parcel.readLong();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
