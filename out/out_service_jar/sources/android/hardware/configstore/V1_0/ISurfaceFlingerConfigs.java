...
public interface ISurfaceFlingerConfigs extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements ISurfaceFlingerConfigs {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-38, 51, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, 68, 3, -1, 93, 96, -13, 71, 55, AcquiredInfo.PAN_TOO_EXTREME, -111, 123, -103, 72, -26, 72, 74, 66, 96, -75, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, 122, -51, -81, -79, AcquiredInfo.PAN_TOO_EXTREME, AcquiredInfo.DARK_GLASSES_DETECTED, 58, -99, -30}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
