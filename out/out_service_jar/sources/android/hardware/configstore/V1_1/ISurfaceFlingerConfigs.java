...
public interface ISurfaceFlingerConfigs extends android.hardware.configstore.V1_0.ISurfaceFlingerConfigs {
    ...
    public static final class Proxy implements ISurfaceFlingerConfigs {
        ...
        public OptionalDisplayOrientation primaryDisplayOrientation() throws RemoteException {
            ...
            try {
                ...
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
                OptionalDisplayOrientation _hidl_out_value = new OptionalDisplayOrientation();
                _hidl_out_value.readFromParcel(_hidl_reply);
                return _hidl_out_value;
            } finally {
                _hidl_reply.release();
    ...
    public static abstract class Stub extends HwBinder implements ISurfaceFlingerConfigs {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-8, 88, 9, 27, 16, -9, -43, -110, 123, -26, 5, 115, -64, 109, -12, Byte.MIN_VALUE, 82, 117, -45, 114, 38, -69, -76, AcquiredInfo.MOUTH_COVERING_DETECTED, 115, UsbDescriptor.DESCRIPTORTYPE_HID, -112, -65, -72, AcquiredInfo.FACE_OBSCURED, 87, -20}, new byte[]{-38, 51, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, 68, 3, -1, 93, 96, -13, 71, 55, AcquiredInfo.PAN_TOO_EXTREME, -111, 123, -103, 72, -26, 72, 74, 66, 96, -75, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, 122, -51, -81, -79, AcquiredInfo.PAN_TOO_EXTREME, AcquiredInfo.DARK_GLASSES_DETECTED, 58, -99, -30}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 13:
                    ...
                    OptionalDisplayOrientation _hidl_out_value13 = primaryDisplayOrientation();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value13.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 256067662:
