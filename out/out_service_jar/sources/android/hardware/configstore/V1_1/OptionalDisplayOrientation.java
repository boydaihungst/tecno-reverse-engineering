...
public final class OptionalDisplayOrientation {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != OptionalDisplayOrientation.class) {
            return false;
        }
        OptionalDisplayOrientation other = (OptionalDisplayOrientation) otherObject;
    ...
    public static final ArrayList<OptionalDisplayOrientation> readVectorFromParcel(HwParcel parcel) {
        ArrayList<OptionalDisplayOrientation> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 2, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            OptionalDisplayOrientation _hidl_vec_element = new OptionalDisplayOrientation();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.value = _hidl_blob.getInt8(1 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<OptionalDisplayOrientation> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8(1 + _hidl_offset, this.value);
    }
}
