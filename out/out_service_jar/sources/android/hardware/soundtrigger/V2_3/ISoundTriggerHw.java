...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_2.ISoundTriggerHw {
    ...
    public static final class Proxy implements ISoundTriggerHw {
        ...
        public void getProperties_2_3(getProperties_2_3Callback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
        ...
        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw
        public int startRecognition_2_3(int modelHandle, RecognitionConfig config) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            config.writeToParcel(_hidl_request);
        ...
        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw
        public int setParameter(int modelHandle, int modelParam, int value) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
        ...
        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw
        public void getParameter(int modelHandle, int modelParam, getParameterCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            _hidl_request.writeInt32(modelParam);
        ...
        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw
        public void queryParameter(int modelHandle, int modelParam, queryParameterCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            _hidl_request.writeInt32(modelParam);
            ...
            try {
                ...
                _hidl_request.releaseTemporaryStorage();
                int _hidl_out_status = _hidl_reply.readInt32();
                OptionalModelParameterRange _hidl_out_retval = new OptionalModelParameterRange();
                _hidl_out_retval.readFromParcel(_hidl_reply);
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 2:
                    ...
                    loadSoundModel(soundModel, callback, cookie, new ISoundTriggerHw.loadSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.2
                ...
                case 3:
                    ...
                    loadPhraseSoundModel(soundModel2, callback2, cookie2, new ISoundTriggerHw.loadPhraseSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.3
                ...
                case 8:
                    ...
                    loadSoundModel_2_1(soundModel3, callback4, cookie4, new ISoundTriggerHw.loadSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.4
                ...
                case 9:
                    ...
                    loadPhraseSoundModel_2_1(soundModel4, callback5, cookie5, new ISoundTriggerHw.loadPhraseSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.5
                ...
                case 13:
                    _hidl_request.enforceInterface(ISoundTriggerHw.kInterfaceName);
                    int modelHandle6 = _hidl_request.readInt32();
                    RecognitionConfig config3 = new RecognitionConfig();
                    config3.readFromParcel(_hidl_request);
                    int _hidl_out_retval7 = startRecognition_2_3(modelHandle6, config3);
                    _hidl_reply.writeStatus(0);
                ...
                case 14:
                    _hidl_request.enforceInterface(ISoundTriggerHw.kInterfaceName);
                    int modelHandle7 = _hidl_request.readInt32();
                    int modelParam = _hidl_request.readInt32();
                    int value = _hidl_request.readInt32();
                    int _hidl_out_status = setParameter(modelHandle7, modelParam, value);
                    _hidl_reply.writeStatus(0);
                ...
                case 15:
                    _hidl_request.enforceInterface(ISoundTriggerHw.kInterfaceName);
                    int modelHandle8 = _hidl_request.readInt32();
                    int modelParam2 = _hidl_request.readInt32();
                    getParameter(modelHandle8, modelParam2, new getParameterCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.7
                        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw.getParameterCallback
                        public void onValues(int status, int value2) {
                            _hidl_reply.writeStatus(0);
                            _hidl_reply.writeInt32(status);
                            _hidl_reply.writeInt32(value2);
                            _hidl_reply.send();
                        }
                    });
                    return;
                case 16:
                    _hidl_request.enforceInterface(ISoundTriggerHw.kInterfaceName);
                    int modelHandle9 = _hidl_request.readInt32();
                    int modelParam3 = _hidl_request.readInt32();
                    queryParameter(modelHandle9, modelParam3, new queryParameterCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.8
                        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw.queryParameterCallback
                        public void onValues(int status, OptionalModelParameterRange retval) {
                            _hidl_reply.writeStatus(0);
                            _hidl_reply.writeInt32(status);
                            retval.writeToParcel(_hidl_reply);
                            _hidl_reply.send();
                        }
                    });
                    return;
