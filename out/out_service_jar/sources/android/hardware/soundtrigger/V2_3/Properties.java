...
public final class Properties {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.base, other.base) && HidlSupport.deepEquals(this.supportedModelArch, other.supportedModelArch) && HidlSupport.deepEquals(Integer.valueOf(this.audioCapabilities), Integer.valueOf(other.audioCapabilities))) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        String string = _hidl_blob.getString(_hidl_offset + 88);
        this.supportedModelArch = string;
        parcel.readEmbeddedBuffer(string.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 88 + 0, false);
