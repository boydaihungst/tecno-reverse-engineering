...
public interface IUsbGadgetCallback extends android.hardware.usb.gadget.V1_0.IUsbGadgetCallback {
    ...
    public static final class Proxy implements IUsbGadgetCallback {
        ...
        @Override // android.hardware.usb.gadget.V1_2.IUsbGadgetCallback, android.hardware.usb.gadget.V1_0.IUsbGadgetCallback, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IUsbGadgetCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-59, 57, 50, 91, UsbDescriptor.DESCRIPTORTYPE_REPORT, -68, -26, -122, -121, 111, 6, 43, AcquiredInfo.SENSOR_DIRTY, UsbDescriptor.DESCRIPTORTYPE_HUB, 32, 56, 85, 90, -30, -123, 126, -115, 52, -86, 99, -87, 117, -33, AcquiredInfo.FIRST_FRAME_RECEIVED, -31, AcquiredInfo.ROLL_TOO_EXTREME, -79}, new byte[]{-83, 10, 98, 12, -38, 8, -16, 27, AcquiredInfo.START, 28, UsbDescriptor.DESCRIPTORTYPE_ENDPOINT_COMPANION, -53, 122, -6, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -80, 99, 124, -56, 67, 64, -49, -115, -20, 0, -84, -114, 50, -49, 84, -88, -37}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
