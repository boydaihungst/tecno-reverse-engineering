...
public interface IHdmiCecCallback extends android.hardware.tv.cec.V1_0.IHdmiCecCallback {
    ...
    static IHdmiCecCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        IHdmiCecCallback proxy = new Proxy(binder);
        try {
    ...
    static IHdmiCecCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IHdmiCecCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IHdmiCecCallback getService(boolean retry) throws RemoteException {
        return getService(HealthServiceWrapperHidl.INSTANCE_VENDOR, retry);
    }

    @Deprecated
    static IHdmiCecCallback getService(String serviceName) throws RemoteException {
    ...
    public static final class Proxy implements IHdmiCecCallback {
        ...
        public void onCecMessage_1_1(CecMessage message) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IHdmiCecCallback.kInterfaceName);
            message.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IHdmiCecCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-71, 104, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_ENDPOINT, -121, 103, 124, -23, -56, 114, -32, 79, AcquiredInfo.RECALIBRATE, -97, -42, -55, -57, -118, 86, -82, 121, 92, 7, -53, -8, -59, 1, 0, -32, 53, 29, 76, 68}, new byte[]{-25, 91, 110, -22, 113, 29, 54, -6, -58, 120, -68, -32, 114, -77, -50, -58, 84, 75, 39, -6, -97, 76, -39, 3, -103, -108, 4, -27, -63, 16, -54, 16}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, AcquiredInfo.ROLL_TOO_EXTREME, -109, UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (IHdmiCecCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
