package com.transsion.hubcore.griffin.lib.pm;
...
public class TranProcessManager {
    public TranProcessManager() {
    }

    public TranProcessManager(Context context) {
    }
    ...
    public boolean limitSendBroadcast(int callerPid, int callerUid, TranProcessWrapper callerProc, Intent intent, boolean serialized, String resolvedType) {
        return false;
    }
    ...
    public void filterReceiveBroadcast(TranProcessWrapper callerProc, int callerPid, int callerUid, Intent intent, List<ResolveInfo> receivers) {
    }
    ...
    public boolean limitStartProcessForService(int callerType, TranProcessWrapper callerProc, ServiceInfo service, Intent intent) {
        return false;
    }

    public boolean limitStartProcessForReceiver(int callerPid, int callerUid, String callerPackage, TranProcessWrapper callerProc, Intent intent, ActivityInfo curReceiver, ComponentName curComponent, boolean ordered) {
        return false;
    }

    public boolean limitStartProcessForProvider(TranProcessWrapper callerProc, String authority, ProviderInfo provider, ComponentName name) {
        return false;
    }
    ...
    public boolean limitDiedProcessRestart(TranProcessWrapper diedProc) {
        return false;
    }

    public boolean limitStartProcess(String hostingType, TranProcessWrapper newProc) {
        return false;
    }

    public int setMaxOomAdj(TranProcessWrapper proc, int maxAdj) {
        return maxAdj;
    }

    public int[] fixOomAdj(TranProcessWrapper proc, int origSchedGroup, int origAdj, int origProcState, String adjType) {
        return new int[]{origSchedGroup, origAdj, origProcState};
    }

    public void onTaskRemoved(List<TranProcessWrapper> procesToKill, ComponentName task, boolean killed) {
    }

    public void onActivityResumed(ActivityInfo activityInfo, TranProcessWrapper proc, boolean switched) {
    }

    public void onActivityIdle(TranProcessWrapper proc, ActivityInfo info, Intent intent) {
    }
    ...
    public int getCurMaxCachedProcesses() {
        return 32;
    }

    public int registrationExemptions(HashMap<String, Long> map) {
        return -1;
    }

    public int unRegistrationExemption(List<String> pkgList) {
        return -1;
    }

    public boolean ensureExemptionProc(String procName, long pss) {
        return false;
    }

    public boolean setScreenOffBlacklist(String packageName, boolean add) {
        return false;
    }
}
