...
import com.transsion.griffin.lib.app.ProcessInfo;
...
public class StateProvider {
    ...
    public Pair<ActivityInfo, ProcessWrapper> getHomeInfo() {
        return null;
    }
    ...
    public Pair<ActivityInfo, ProcessWrapper> getTopInfo() {
        return null;
    }
    ...
    public Pair<ActivityInfo, ProcessWrapper> getPreviousInfo() {
        return null;
    }
    ...
    public ProcessInfo getProcessInfo(String processName, int uid) {
        return null;
    }
    ...
    public ProcessWrapper getProcessWrapper(int pid) {
        return null;
    }

    public ProcessWrapper getProcessWrapper(String processName, int uid) {
        return null;
    }

    public ArrayList<ProcessWrapper> getRunningProcess() {
        return new ArrayList<>();
    }

    public SparseArray<ProcessWrapper> getPersistProcess() {
