            ...
            synchronized (AudioPlayerStateMonitor.this.mLock) {
                ...
                for (int i = 0; i < activeAudioPlaybackConfigs.size(); i++) {
                    ...
                    if (!AudioPlayerStateMonitor.this.mPrevActiveAudioPlaybackConfigs.containsKey(Integer.valueOf(config2.getPlayerInterfaceId()))) {
                        ...
                        int index = AudioPlayerStateMonitor.this.mSortedAudioPlaybackClientUids.indexOf(Integer.valueOf(uid));
                        if (index != 0) {
                            if (index > 0) {
                                AudioPlayerStateMonitor.this.mSortedAudioPlaybackClientUids.remove(index);
                            }
                            AudioPlayerStateMonitor.this.mSortedAudioPlaybackClientUids.add(0, Integer.valueOf(uid));
                        }
                    }
                }
                if (AudioPlayerStateMonitor.this.mActiveAudioUids.size() > 0 && !AudioPlayerStateMonitor.this.mActiveAudioUids.contains(AudioPlayerStateMonitor.this.mSortedAudioPlaybackClientUids.get(0))) {
                    ...
                    while (true) {
                        ...
                        int uid2 = AudioPlayerStateMonitor.this.mSortedAudioPlaybackClientUids.get(i2).intValue();
                    ...
                    AudioPlayerStateMonitor.this.mSortedAudioPlaybackClientUids.set(0, Integer.valueOf(firstActiveUid));
                }
