...
public class KeyChainSystemService extends SystemService {
    ...
    public void startServiceInBackgroundAsUser(Intent intent, UserHandle user) {
        ...
        idleController.addPowerSaveTempWhitelistApp(Process.myUid(), packageName, 30000L, user.getIdentifier(), false, (int) FrameworkStatsLog.APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_KEY_CHAIN, "keychain");
