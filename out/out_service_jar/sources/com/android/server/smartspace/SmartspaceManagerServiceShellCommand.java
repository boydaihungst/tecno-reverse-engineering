...
public class SmartspaceManagerServiceShellCommand extends ShellCommand {
    ...
    public SmartspaceManagerServiceShellCommand(SmartspaceManagerService service) {
            ...
            case false:
                ...
                switch (c) {
                    case 0:
                        ...
                        pw.println("SmartspaceService temporarily set to " + serviceName + " for " + duration + "ms");
                        break;
                }
                return 0;
            default:
