...
public class EventLogTags {
    ...
    public static void writeNotificationAdjusted(String key, String adjustmentType, String newValue) {
        EventLog.writeEvent((int) NOTIFICATION_ADJUSTED, key, adjustmentType, newValue);
    }
    ...
    public static void writePmSnapshotStats(int buildCount, int reuseCount, int bigBuilds, int shortLived, int maxBuildTime, long cummBuildTime) {
        EventLog.writeEvent((int) PM_SNAPSHOT_STATS, Integer.valueOf(buildCount), Integer.valueOf(reuseCount), Integer.valueOf(bigBuilds), Integer.valueOf(shortLived), Integer.valueOf(maxBuildTime), Long.valueOf(cummBuildTime));
    }

    public static void writePmSnapshotRebuild(int buildTime, int lifetime) {
        EventLog.writeEvent((int) PM_SNAPSHOT_REBUILD, Integer.valueOf(buildTime), Integer.valueOf(lifetime));
    }
