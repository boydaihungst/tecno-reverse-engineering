...
public class RemotePrintServiceRecommendationService {
    ...
    public RemotePrintServiceRecommendationService(Context context, UserHandle userHandle, RemotePrintServiceRecommendationServiceCallbacks callbacks) {
        ...
        Connection connection = new Connection(callbacks);
        this.mConnection = connection;
        try {
            Intent serviceIntent = getServiceIntent(userHandle);
            synchronized (obj) {
                boolean bindServiceAsUser = context.bindServiceAsUser(serviceIntent, connection, AudioFormat.AAC_MAIN, userHandle);
