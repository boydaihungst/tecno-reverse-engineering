...
public class EventLogTags {
    ...
    public static void writeUcDispatchUserSwitch(int olduserid, int newuserid) {
        EventLog.writeEvent((int) UC_DISPATCH_USER_SWITCH, Integer.valueOf(olduserid), Integer.valueOf(newuserid));
    }

    public static void writeUcContinueUserSwitch(int olduserid, int newuserid) {
        EventLog.writeEvent((int) UC_CONTINUE_USER_SWITCH, Integer.valueOf(olduserid), Integer.valueOf(newuserid));
    }
    ...
    public static void writeSsmUserStarting(int userid) {
        EventLog.writeEvent((int) SSM_USER_STARTING, userid);
    }

    public static void writeSsmUserSwitching(int olduserid, int newuserid) {
        EventLog.writeEvent((int) SSM_USER_SWITCHING, Integer.valueOf(olduserid), Integer.valueOf(newuserid));
    }

    public static void writeSsmUserUnlocking(int userid) {
        EventLog.writeEvent((int) SSM_USER_UNLOCKING, userid);
    }

    public static void writeSsmUserUnlocked(int userid) {
        EventLog.writeEvent((int) SSM_USER_UNLOCKED, userid);
    }

    public static void writeSsmUserStopping(int userid) {
        EventLog.writeEvent((int) SSM_USER_STOPPING, userid);
    }

    public static void writeSsmUserStopped(int userid) {
        EventLog.writeEvent((int) SSM_USER_STOPPED, userid);
    }

    public static void writeSsmUserCompletedEvent(int userid, int eventflag) {
        EventLog.writeEvent((int) SSM_USER_COMPLETED_EVENT, Integer.valueOf(userid), Integer.valueOf(eventflag));
    }

    public static void writeAmForegroundServiceStart(int user, String componentName, int allowwhileinuse, String startreasoncode, int targetsdk, int callertargetsdk, int notificationwasdeferred, int notificationshown, int durationms, int startforegroundcount, String stopreason) {
        EventLog.writeEvent((int) AM_FOREGROUND_SERVICE_START, Integer.valueOf(user), componentName, Integer.valueOf(allowwhileinuse), startreasoncode, Integer.valueOf(targetsdk), Integer.valueOf(callertargetsdk), Integer.valueOf(notificationwasdeferred), Integer.valueOf(notificationshown), Integer.valueOf(durationms), Integer.valueOf(startforegroundcount), stopreason);
    }

    public static void writeAmForegroundServiceDenied(int user, String componentName, int allowwhileinuse, String startreasoncode, int targetsdk, int callertargetsdk, int notificationwasdeferred, int notificationshown, int durationms, int startforegroundcount, String stopreason) {
        EventLog.writeEvent((int) AM_FOREGROUND_SERVICE_DENIED, Integer.valueOf(user), componentName, Integer.valueOf(allowwhileinuse), startreasoncode, Integer.valueOf(targetsdk), Integer.valueOf(callertargetsdk), Integer.valueOf(notificationwasdeferred), Integer.valueOf(notificationshown), Integer.valueOf(durationms), Integer.valueOf(startforegroundcount), stopreason);
    }

    public static void writeAmForegroundServiceStop(int user, String componentName, int allowwhileinuse, String startreasoncode, int targetsdk, int callertargetsdk, int notificationwasdeferred, int notificationshown, int durationms, int startforegroundcount, String stopreason) {
        EventLog.writeEvent((int) AM_FOREGROUND_SERVICE_STOP, Integer.valueOf(user), componentName, Integer.valueOf(allowwhileinuse), startreasoncode, Integer.valueOf(targetsdk), Integer.valueOf(callertargetsdk), Integer.valueOf(notificationwasdeferred), Integer.valueOf(notificationshown), Integer.valueOf(durationms), Integer.valueOf(startforegroundcount), stopreason);
    }
}
