...
public class OomAdjProfiler {
    ...
    private void scheduleSystemServerCpuTimeUpdate() {
        synchronized (this) {
            ...
            Message scheduledMessage = PooledLambda.obtainMessage(new QuadConsumer() { // from class: com.android.server.am.OomAdjProfiler$$ExternalSyntheticLambda0
            ...
            }, this, Boolean.valueOf(this.mLastScheduledOnBattery), Boolean.valueOf(this.mLastScheduledScreenOff), true);
