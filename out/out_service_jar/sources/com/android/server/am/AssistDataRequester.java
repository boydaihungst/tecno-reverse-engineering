...
public class AssistDataRequester extends IAssistDataReceiver.Stub {
    ...
    public void requestAutofillData(List<IBinder> activityTokens, int callingUid, String callingPackage) {
        requestData(activityTokens, true, true, false, true, true, false, false, callingUid, callingPackage);
    }
    ...
    public void requestAssistData(List<IBinder> activityTokens, boolean fetchData, boolean fetchScreenshot, boolean allowFetchData, boolean allowFetchScreenshot, int callingUid, String callingPackage) {
        requestAssistData(activityTokens, fetchData, fetchScreenshot, true, allowFetchData, allowFetchScreenshot, false, callingUid, callingPackage);
    }

    public void requestAssistData(List<IBinder> activityTokens, boolean fetchData, boolean fetchScreenshot, boolean fetchStructure, boolean allowFetchData, boolean allowFetchScreenshot, boolean ignoreTopActivityCheck, int callingUid, String callingPackage) {
        requestData(activityTokens, false, fetchData, fetchScreenshot, fetchStructure, allowFetchData, allowFetchScreenshot, ignoreTopActivityCheck, callingUid, callingPackage);
    }

    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:93:0x00e5 */
    ...
    private void requestData(List<IBinder> activityTokens, boolean requestAutofillData, boolean fetchData, boolean fetchScreenshot, boolean fetchStructure, boolean allowFetchData, boolean allowFetchScreenshot, boolean ignoreTopActivityCheck, int callingUid, String callingPackage) {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        if (requestAutofillData) {
                            ...
                            int i4 = (i3 != 0 || ignoreTopActivityCheck) ? i2 : 1;
                            int i5 = i3 == 0 ? 1 : i2;
                            i = i3;
                            numActivities = numActivities2;
                            bundle = r7;
                            result = iActivityTaskManager.requestAssistContextExtras(requestType, this, receiverExtras, topActivity, i4, i5);
                        }
                        if (result) {
                            try {
