...
public final class BugReportHandlerUtil {
    ...
    public static boolean launchBugReportHandlerApp(Context context) {
        ...
        try {
            try {
                UserHandle of = UserHandle.of(handlerUser);
                BugreportHandlerResponseBroadcastReceiver bugreportHandlerResponseBroadcastReceiver = new BugreportHandlerResponseBroadcastReceiver(handlerApp, handlerUser);
                str = TAG;
                try {
