...
public class SecurityLogMonitor implements Runnable {
    ...
    private void getNextBatch(ArrayList<SecurityLog.SecurityEvent> newLogs) throws IOException {
        ...
        while (true) {
            if (i >= newLogs.size() - 1) {
                ...
                newLogs.sort(new Comparator() { // from class: com.android.server.devicepolicy.SecurityLogMonitor$$ExternalSyntheticLambda0
    ...
    private void notifyDeviceOwnerOrProfileOwnerIfNeeded(boolean force) throws InterruptedException {
