    ...
    public void start() {
        BackgroundThread.getHandler().post(new Runnable() { // from class: com.android.server.content.SyncManagerConstants$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SyncManagerConstants.this.m2883lambda$start$0$comandroidservercontentSyncManagerConstants();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$start$0$com-android-server-content-SyncManagerConstants  reason: not valid java name */
    public /* synthetic */ void m2883lambda$start$0$comandroidservercontentSyncManagerConstants() {
