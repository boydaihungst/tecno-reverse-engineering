...
public class FingerprintRevokeChallengeClient extends RevokeChallengeClient<AidlSession> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public FingerprintRevokeChallengeClient(Context context, Supplier<AidlSession> lazyDaemon, IBinder token, int userId, String owner, int sensorId, BiometricLogger logger, BiometricContext biometricContext, long challenge) {
