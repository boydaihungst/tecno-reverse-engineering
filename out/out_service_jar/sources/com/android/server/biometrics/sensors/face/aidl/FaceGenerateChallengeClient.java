...
public class FaceGenerateChallengeClient extends GenerateChallengeClient<AidlSession> {
    ...
    public FaceGenerateChallengeClient(Context context, Supplier<AidlSession> lazyDaemon, IBinder token, ClientMonitorCallbackConverter listener, int userId, String owner, int sensorId, BiometricLogger logger, BiometricContext biometricContext) {
