...
public class FaceStopUserClient extends StopUserClient<AidlSession> {
    ...
    public FaceStopUserClient(Context context, Supplier<AidlSession> lazyDaemon, IBinder token, int userId, int sensorId, BiometricLogger logger, BiometricContext biometricContext, StopUserClient.UserStoppedCallback callback) {
