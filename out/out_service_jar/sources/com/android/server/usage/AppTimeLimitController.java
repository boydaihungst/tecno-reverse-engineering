...
public class AppTimeLimitController {
    ...
    public abstract class UsageGroup {
        ...
        void noteUsageStop(long stopTimeMs) {
            ...
            if (i == 0) {
                ...
                boolean limitNotCrossed = j < j2;
                long j3 = j + (stopTimeMs - this.mLastKnownUsageTimeMs);
                this.mUsageTimeMs = j3;
                this.mLastUsageEndTimeMs = stopTimeMs;
                if (limitNotCrossed && j3 >= j2) {
    ...
    public class SessionUsageGroup extends UsageGroup implements AlarmManager.OnAlarmListener {
        ...
        public void noteUsageStop(long stopTimeMs) {
            ...
            if (this.mActives == 0 && this.mUsageTimeMs >= this.mTimeLimitMs) {
                AppTimeLimitController.this.getAlarmManager().setExact(3, AppTimeLimitController.this.getElapsedRealtime() + this.mNewSessionThresholdMs, AppTimeLimitController.TAG, this, AppTimeLimitController.this.mHandler);
            }
        }
    ...
    public class AppUsageLimitGroup extends UsageGroup {
        ...
        long getUsageRemaining() {
            if (this.mActives > 0) {
                return (this.mTimeLimitMs - this.mUsageTimeMs) - (AppTimeLimitController.this.getElapsedRealtime() - this.mLastKnownUsageTimeMs);
            }
    ...
    public class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    synchronized (AppTimeLimitController.this.mLock) {
                        ((UsageGroup) msg.obj).checkTimeout(AppTimeLimitController.this.getElapsedRealtime());
                    }
                    return;
                case 2:
                    synchronized (AppTimeLimitController.this.mLock) {
    ...
    public AppTimeLimitController(Context context, TimeLimitCallbackListener listener, Looper looper) {
