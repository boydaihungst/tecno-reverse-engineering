...
public final class OverlayDisplayWindow implements DumpUtils.Dump {
    ...
    private void resize(int width, int height, int densityDpi, boolean doLayout) {
        ...
        this.mTitle = this.mContext.getResources().getString(17040166, this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi));
        if (this.mSecure) {
            this.mTitle += this.mContext.getResources().getString(17040165);
        }
        if (doLayout) {
            relayout();
        }
    ...
    private void createWindow() {
        ...
        View inflate = inflater.inflate(17367252, (ViewGroup) null);
        this.mWindowContent = inflate;
        inflate.setOnTouchListener(this.mOnTouchListener);
        TextureView textureView = (TextureView) this.mWindowContent.findViewById(16909325);
        ...
        TextView textView = (TextView) this.mWindowContent.findViewById(16909326);
