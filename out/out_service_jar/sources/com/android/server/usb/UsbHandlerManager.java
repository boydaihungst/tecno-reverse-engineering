...
class UsbHandlerManager {
    ...
    public void showUsbAccessoryUriActivity(UsbAccessory accessory, UserHandle user) {
        ...
        if (uri != null && uri.length() > 0) {
            ...
            dialogIntent.setComponent(ComponentName.unflattenFromString(this.mContext.getResources().getString(17040051)));
    ...
    public void confirmUsbHandler(ResolveInfo rInfo, UsbDevice device, UsbAccessory accessory) {
        ...
        resolverIntent.setComponent(ComponentName.unflattenFromString(this.mContext.getResources().getString(17040052)));
    ...
    public void selectUsbHandler(ArrayList<ResolveInfo> matches, UserHandle user, Intent intent) {
        Intent resolverIntent = createDialogIntent();
        resolverIntent.setComponent(ComponentName.unflattenFromString(this.mContext.getResources().getString(17040055)));
