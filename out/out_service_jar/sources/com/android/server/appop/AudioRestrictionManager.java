...
public class AudioRestrictionManager {
    ...
    static {
        ...
        sparseArray.append(3, vibrationMutedUsages);
    }
    ...
    public int checkAudioOperation(int code, int usage, int uid, String packageName) {
        ...
        synchronized (this) {
            int i = this.mCameraAudioRestriction;
            if (i != 0 && ((code == 3 || (code == 28 && i == 3)) && (mutedUsages = CAMERA_AUDIO_RESTRICTIONS.get(code)) != null && mutedUsages.get(usage))) {
                return 1;
            }
