...
public final class TvRemoteProviderWatcher {
    ...
    TvRemoteProviderWatcher(Context context, Object lock, Handler handler) {
        ...
        splitter.setString(context.getString(17040050));
        splitter.forEach(new Consumer() { // from class: com.android.server.tv.TvRemoteProviderWatcher$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                TvRemoteProviderWatcher.this.m7150lambda$new$0$comandroidservertvTvRemoteProviderWatcher((String) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$new$0$com-android-server-tv-TvRemoteProviderWatcher  reason: not valid java name */
    public /* synthetic */ void m7150lambda$new$0$comandroidservertvTvRemoteProviderWatcher(String packageName) {
