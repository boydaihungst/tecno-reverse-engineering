...
public class DataMaintenanceService extends JobService {
    ...
    public boolean onStartJob(final JobParameters params) {
        ...
        new Thread(new Runnable() { // from class: com.android.server.people.data.DataMaintenanceService$$ExternalSyntheticLambda0
            ...
            public final void run() {
                DataMaintenanceService.this.m5313xabf59d50(userId, params);
            }
        }).start();
        return true;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$onStartJob$0$com-android-server-people-data-DataMaintenanceService  reason: not valid java name */
    public /* synthetic */ void m5313xabf59d50(int userId, JobParameters params) {
