...
public class RecoverySessionStorage implements Destroyable {
    ...
    public void remove(int uid, final String sessionId) {
        ...
        this.mSessionsByUid.get(uid).removeIf(new Predicate() { // from class: com.android.server.locksettings.recoverablekeystore.storage.RecoverySessionStorage$$ExternalSyntheticLambda0
