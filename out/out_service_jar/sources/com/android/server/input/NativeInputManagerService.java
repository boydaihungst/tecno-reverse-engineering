...
public interface NativeInputManagerService {
    ...
    boolean ignoreMultiWindowGesture();
    ...
    void setBlockUntrustedTouchesMode(int i);

    void setConnectScreenActive(boolean z);
    ...
    boolean setInTouchMode(boolean z, int i, int i2, boolean z2);

    void setInputDispatchMode(boolean z, boolean z2);

    void setInputFilterEnabled(boolean z);

    void setInputRspDumpEnabled(boolean z);

    void setInputRspTimeEnabled(boolean z);
    ...
    public static class NativeImpl implements NativeInputManagerService {
        ...
        private native long init(InputManagerService inputManagerService, Context context, MessageQueue messageQueue);
        ...
        @Override // com.android.server.input.NativeInputManagerService
        public native boolean ignoreMultiWindowGesture();
        ...
        @Override // com.android.server.input.NativeInputManagerService
        public native void setBlockUntrustedTouchesMode(int i);

        @Override // com.android.server.input.NativeInputManagerService
        public native void setConnectScreenActive(boolean z);
        ...
        @Override // com.android.server.input.NativeInputManagerService
        public native boolean setInTouchMode(boolean z, int i, int i2, boolean z2);
        ...
        @Override // com.android.server.input.NativeInputManagerService
        public native void setInputRspDumpEnabled(boolean z);

        @Override // com.android.server.input.NativeInputManagerService
        public native void setInputRspTimeEnabled(boolean z);
        ...
        public NativeImpl(InputManagerService service, Context context, MessageQueue messageQueue) {
            this.mPtr = init(service, context, messageQueue);
        }
    }
}
