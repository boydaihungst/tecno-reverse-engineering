...
public final class DumpUtils {
    ...
    public static boolean isPlatformPackage(String packageName) {
        return packageName != null && (packageName.equals(PackageManagerService.PLATFORM_PACKAGE_NAME) || packageName.startsWith("android.") || packageName.startsWith("com.android."));
    }
