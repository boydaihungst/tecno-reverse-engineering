package vendor.mediatek.hardware.nvram.V1_0;
...
public interface INvram extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.nvram@1.0::INvram";
    ...
    String readFileByName(String str, int i) throws RemoteException;
    ...
    byte writeFileByNamevec(String str, int i, ArrayList<Byte> arrayList) throws RemoteException;
    ...
    public static abstract class Stub extends HwBinder implements INvram {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(INvram.kInterfaceName, IBase.kInterfaceName));
        }
