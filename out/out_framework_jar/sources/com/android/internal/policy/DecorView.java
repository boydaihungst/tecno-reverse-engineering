...
import com.android.internal.widget.TranMultiDecorCaptionViewV3;
import com.android.internal.widget.TranMultiDecorCaptionViewV4;
...
public class DecorView extends FrameLayout implements RootViewSurfaceTaker, WindowCallbacks {
    ...
    private boolean isCaptionShowByViewRootImplSet;
    ...
    private float mBackgroundBlurSaturation;
    ...
    public /* synthetic */ boolean m6881lambda$new$0$comandroidinternalpolicyDecorView() {
    ...
    public DecorView(Context context, int featureId, PhoneWindow window, WindowManager.LayoutParams params) {
        ...
        this.mOriginalBackgroundSaturation = -2.0f;
        this.mBackgroundBlurSaturation = -2.0f;
        this.mBackgroundBlurOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: com.android.internal.policy.DecorView$$ExternalSyntheticLambda0
            ...
            public final boolean onPreDraw() {
                return DecorView.this.m6881lambda$new$0$comandroidinternalpolicyDecorView();
            }
        };
        this.isCaptionShowByViewRootImplSet = false;
        this.mIsFocus = false;
        this.mMultiWindowConfiguration = null;
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        int action = event.getAction();
        ITranDecorView.Instance().multiWindowOnLayout(event, this, this.mDecorCaptionView);
    ...
    */
    ...
    public void adjustLayoutParamsForWhiteNavigationBar(WindowManager.LayoutParams inOutParams) {
        int color = calculateNavigationBarColor(inOutParams.insetsFlags.appearance);
        ITranInternalView.Instance().adjustLayoutParamsForWhiteNavigationBar(inOutParams, color, this.mContext);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Code restructure failed: missing block: B:142:0x027b, code lost:
        if (r15.isRequestedVisible(1) == false) goto L110;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:178:0x02ce, code lost:
        if (r15.isRequestedVisible(0) == false) goto L100;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:186:0x02db A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:236:0x035f A[ADDED_TO_REGION] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public WindowInsets updateColorViews(WindowInsets insets, boolean animate) {
        ...
        boolean isInSplitScreen = getResources().getConfiguration().windowConfiguration.getWindowingMode() == 6;
        if (!this.mWindow.mIsFloating || isImeWindow) {
            ...
            if (insets == null) {
                ...
                boolean clearsCompatInsets = InsetsState.clearsCompatInsets(attrs3.type, attrs3.flags, getResources().getConfiguration().windowConfiguration.getWindowingMode());
            ...
            int navigationBarColor2 = calculateNavigationBarColor(appearance);
            ITranInternalView.Instance().setSystemUIVisibility(this, getSystemUiVisibility(), this.mWindow, getContext().getApplicationInfo().processName, navigationBarColor2);
            if (navBarSize <= ViewRootImpl.GESTURE_NAV_HEIGHT && navigationBarColor2 != -32640 && (navigationBarColor2 != 0 || this.mWindow.mEnsureNavigationBarContrastWhenTransparent)) {
                navigationBarColor = -16514044;
            } else {
                navigationBarColor = navigationBarColor2;
            }
            attrs = attrs3;
            updateColorViewInt(this.mNavigationColorViewState, navigationBarColor, this.mWindow.mNavigationBarDividerColor, navBarSize, navBarToRightEdge || navBarToLeftEdge, navBarToLeftEdge, 0, animate && !disallowAnimate, this.mForceWindowDrawsBarBackgrounds, controller);
            ...
            if (oldDrawLegacy != z) {
                this.mDrawLegacyNavigationBarBackgroundHandled = this.mWindow.onDrawLegacyNavigationBarBackgroundChanged(z);
                if (viewRoot != null) {
            ...
            if (this.mHasCaption) {
                if (ThunderbackConfig.isVersion3()) {
                    if (!ITranDecorView.Instance().multiWindowUpdateColorViews(getResources().getConfiguration().windowConfiguration.isThunderbackWindow(), this.mDecorCaptionView, statusBarColor)) {
                        this.mDecorCaptionView.getCaption().setBackgroundColor(statusBarColor);
                        updateDecorCaptionShade();
                    }
                } else if (ThunderbackConfig.isVersion4()) {
                    if (!ITranDecorView.Instance().multiWindowUpdateColorViews(hasWindowDecorCaption() || getResources().getConfiguration().windowConfiguration.isSplitScreenWindow(), this.mDecorCaptionView, statusBarColor)) {
                        this.mDecorCaptionView.getCaption().setBackgroundColor(statusBarColor);
                        updateDecorCaptionShade();
                    }
                }
        ...
        if ((sysUiVisibility & 2) != 0) {
            ...
            if (this.mLastShouldAlwaysConsumeSystemBars || i8 == 0) {
                ...
                if ((sysUiVisibility & 4) == 0 || (attrs2.flags & 1024) != 0) {
                    ...
                    if (i4 != 0 || i8 != 0 || this.mDrawLegacyNavigationBarBackgroundHandled) {
                        this.mBackgroundInsets = Insets.NONE;
                    } else {
            ...
            if (this.mCrossWindowBlurEnabledListener == null) {
                this.mCrossWindowBlurEnabledListener = new Consumer() { // from class: com.android.internal.policy.DecorView$$ExternalSyntheticLambda1
                    ...
                    public final void accept(Object obj) {
                        DecorView.this.m6882xc6f1df0a((Boolean) obj);
                    }
                };
    ...
    public /* synthetic */ void m6882xc6f1df0a(Boolean enabled) {
        this.mCrossWindowBlurEnabled = enabled.booleanValue();
        updateBackgroundBlurRadius();
        updateBackgroundBlurSaturation();
    }
    ...
    private void updateBackgroundBlurSaturation() {
        if (getViewRootImpl() == null) {
            return;
        }
        float f = (this.mCrossWindowBlurEnabled && this.mWindow.isTranslucent()) ? this.mOriginalBackgroundSaturation : -2.0f;
        this.mBackgroundBlurSaturation = f;
        if (this.mBackgroundBlurDrawable == null && f > -2.0f) {
            this.mBackgroundBlurDrawable = getViewRootImpl().createBackgroundBlurDrawable();
            updateBackgroundDrawable();
        }
        BackgroundBlurDrawable backgroundBlurDrawable = this.mBackgroundBlurDrawable;
        if (backgroundBlurDrawable != null) {
            float f2 = this.mBackgroundBlurSaturation;
            if (f2 > -2.0f) {
                backgroundBlurDrawable.setBlurSaturation(f2);
            }
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setBackgroundBlurSaturation(float saturation) {
        this.mOriginalBackgroundSaturation = saturation;
        if (saturation > -2.0f) {
            updateBackgroundBlurSaturation();
        }
    }
    ...
    */
    private void updateColorViewInt(final ColorViewState state, int color, int dividerColor, int size, boolean verticalBar, boolean seascape, int sideMargin, boolean animate, boolean force, WindowInsetsController controller) {
        ...
        state.visible = show;
        state.color = color;
        IInternalViewLice.Instance().onUpdateColorViewInt(view, color, "END");
    }

    private static void setColor(View v, int color, int dividerColor, boolean verticalBar, boolean seascape) {
        int color2 = IInternalViewLice.Instance().onUpdateColorViewInt(v, color, "setColor");
        if (dividerColor != 0) {
            ...
            if (dir == null || ((Boolean) dir.first).booleanValue() != verticalBar || ((Boolean) dir.second).booleanValue() != seascape) {
                ...
                v.setBackground(new LayerDrawable(new Drawable[]{new ColorDrawable(dividerColor), new InsetDrawable((Drawable) new ColorDrawable(color2), (!verticalBar || seascape) ? 0 : size, !verticalBar ? size : 0, (verticalBar && seascape) ? size : 0, 0)}));
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        if (decorCaptionView != null && (decorCaptionView instanceof TranMultiDecorCaptionViewV4)) {
            decorCaptionView.onWindowFocusChanged(hasWindowFocus);
        }
    ...
    public int getCurrentMultiWindowMode() {
        DecorCaptionView decorCaptionView = this.mDecorCaptionView;
        if (decorCaptionView != null && (decorCaptionView instanceof TranMultiDecorCaptionViewV4) && decorCaptionView.getConfiguration() != null) {
            return this.mDecorCaptionView.getConfiguration().windowConfiguration.getMultiWindowingMode();
        }
        return -1;
    }

    private void updateDecorCaptionStatus(Configuration config) {
        updateDecorCaptionStatus(config, false);
    }

    private void updateDecorCaptionStatus(Configuration config, boolean fromMultiWindow) {
        Log.i("config_debug", "updateDecorCaptionStatus: " + config + " fromMultiWindow: " + fromMultiWindow);
        if (fromMultiWindow) {
            updateMultiWindowDecorCaptionStatus(config);
            return;
        }
        boolean displayWindowDecor = false;
        if (ThunderbackConfig.isVersion3()) {
            boolean isThunderbackActivity = false;
            boolean z = true;
            if (getViewRootImpl() == null) {
                config.windowConfiguration.mIsThunderbackActivity = false;
                getResources().getConfiguration().windowConfiguration.mIsThunderbackActivity = false;
            } else {
                isThunderbackActivity = getViewRootImpl().shouldShowCaptionView() && this.isCaptionShowByViewRootImplSet;
                config.windowConfiguration.mIsThunderbackActivity = isThunderbackActivity;
                getResources().getConfiguration().windowConfiguration.mIsThunderbackActivity = isThunderbackActivity;
            }
            if (isThunderbackActivity) {
                displayWindowDecor = true;
            } else {
                if (!config.windowConfiguration.hasWindowDecorCaption() || isFillingScreen(config)) {
                    z = false;
                }
                displayWindowDecor = z;
            }
        }
        DecorCaptionView decorCaptionView = this.mDecorCaptionView;
        if (decorCaptionView == null && displayWindowDecor) {
            ...
            if (createDecorCaptionView != null) {
                if (ThunderbackConfig.isVersion3()) {
                    if (!config.windowConfiguration.isThunderbackWindow()) {
                    ...
                    if (this.mDecorCaptionView.getParent() == null) {
                        addView(this.mDecorCaptionView, -1, new ViewGroup.LayoutParams(-1, -1));
                    }
                    this.mDecorCaptionView.updateConfiguration(config);
                } else if (ThunderbackConfig.isVersion4() && !config.windowConfiguration.isThunderbackWindow() && !config.windowConfiguration.isSplitScreenWindow() && !hasWindowDecorCaption()) {
                    if (this.mDecorCaptionView.getParent() == null) {
                        addView(this.mDecorCaptionView, 0, new ViewGroup.LayoutParams(-1, -1));
                    }
                    removeView(this.mContentRoot);
        ...
        } else if (decorCaptionView == null || (decorCaptionView instanceof TranMultiDecorCaptionViewV4)) {
        } else {
            decorCaptionView.onConfigurationChanged(displayWindowDecor);
            enableCaption(displayWindowDecor);
            if (!config.windowConfiguration.hasWindowDecorCaption()) {
                DecorCaptionView decorCaptionView2 = this.mDecorCaptionView;
                if (decorCaptionView2 instanceof TranMultiDecorCaptionViewV3) {
                    decorCaptionView2.updateConfiguration(config);
                    this.mDecorCaptionView.onWindowFocusChanged(this.mIsFocus);
                    removeView(this.mDecorCaptionView);
                    this.mDecorCaptionView = null;
                    return;
                }
                decorCaptionView2.removeView(this.mContentRoot);
                addView(this.mContentRoot, new ViewGroup.MarginLayoutParams(-1, -1));
                removeView(this.mDecorCaptionView);
    ...
    public void onResourcesLoaded(LayoutInflater inflater, int layoutResource) {
        ...
        if (this.mDecorCaptionView != null) {
            WindowConfiguration winConfig = getResources().getConfiguration().windowConfiguration;
            if (!winConfig.isThunderbackWindow() && !winConfig.isSplitScreenWindow() && !hasWindowDecorCaption()) {
                if (this.mDecorCaptionView.getParent() == null) {
                ...
                DecorCaptionView decorCaptionView = this.mDecorCaptionView;
                if (decorCaptionView instanceof TranMultiDecorCaptionViewV3) {
                    decorCaptionView.updateConfiguration(getResources().getConfiguration());
                }
            }
        } else {
    ...
    private DecorCaptionView createDecorCaptionView(LayoutInflater inflater) {
        return createDecorCaptionView(inflater, false);
    }

    private DecorCaptionView createDecorCaptionView(LayoutInflater inflater, boolean needReCreate) {
        ...
        WindowConfiguration winConfig = getResources().getConfiguration().windowConfiguration;
        if (needReCreate || (!this.mWindow.isFloating() && isApplication && (((winConfig.hasWindowDecorCaption() && ThunderbackConfig.isVersion3()) || hasWindowDecorCaption()) && !ViewRootImpl.CAPTION_ON_SHELL))) {
            if (decorCaptionView == null) {
                decorCaptionView = inflateDecorCaptionView(inflater);
            }
            decorCaptionView.setPhoneWindow(this.mWindow, true);
            if (decorCaptionView instanceof TranMultiDecorCaptionViewV4) {
                decorCaptionView.updateConfiguration(this.mMultiWindowConfiguration);
                decorCaptionView.onWindowFocusChanged(this.mIsFocus);
            }
        } else {
    ...
    private DecorCaptionView inflateDecorCaptionView(LayoutInflater inflater) {
        ...
        if (ThunderbackConfig.isVersion3()) {
            if (getResources().getConfiguration().windowConfiguration.isThunderbackWindow() || getResources().getConfiguration().windowConfiguration.isSplitScreenWindow()) {
                view = (TranMultiDecorCaptionViewV3) inflater2.inflate(R.layout.zzzz_tran_multi_decor_captionV3, (ViewGroup) null);
            }
        } else if (ThunderbackConfig.isVersion4()) {
            if (this.mMultiWindowConfiguration.windowConfiguration.getInLargeScreen() == 0) {
                view = (TranMultiDecorCaptionViewV4) inflater2.inflate(R.layout.zzzz_tran_multi_large_decor_captionV4, (ViewGroup) null);
            } else {
                view = (TranMultiDecorCaptionViewV4) inflater2.inflate(R.layout.zzzz_tran_multi_decor_captionV4, (ViewGroup) null);
            }
        } else {
            view = ITranInternalView.Instance().inflateDecorCaptionView(inflater2);
        }
        if (view == null) {
            view = (DecorCaptionView) inflater2.inflate(R.layout.decor_caption, (ViewGroup) null);
        }
    ...
    private void setDecorCaptionShade(DecorCaptionView view) {
        if (ITranDecorView.Instance().multiWindowIsThunderbackWindow(view)) {
            return;
        }
    ...
    private void setLightDecorCaptionShade(DecorCaptionView view) {
        if (ITranInternalView.Instance().setLightDecorCaptionShade(view)) {
            return;
        }
    ...
    private void setDarkDecorCaptionShade(DecorCaptionView view) {
        if (ITranInternalView.Instance().setDarkDecorCaptionShade(view)) {
            return;
        }
    ...
    public void setDecorViewInThunderBack(boolean isCaptionShow) {
        this.isCaptionShowByViewRootImplSet = isCaptionShow;
    }

    public String getTitleLast() {
        PhoneWindow phoneWindow = this.mWindow;
        if (phoneWindow != null) {
            return getTitleSuffix(phoneWindow.getAttributes());
        }
        return null;
    }

    private boolean isInThunderbackWindowByVersion4() {
        return ThunderbackConfig.isVersion4() && getResources().getConfiguration().windowConfiguration.isThunderbackWindow();
    }

    public void performMultiConfigurationChange(Configuration multiConfiguration) {
        this.mMultiWindowConfiguration = multiConfiguration;
        updateDecorCaptionStatus(multiConfiguration, true);
    }

    private boolean hasWindowDecorCaption() {
        Configuration configuration;
        if (ThunderbackConfig.isVersion3() || (configuration = this.mMultiWindowConfiguration) == null) {
            return false;
        }
        return configuration.windowConfiguration.hasWindowDecorCaption();
    }

    private void updateMultiWindowDecorCaptionStatus(Configuration config) {
        boolean displayWindowDecor = false;
        if (config.windowConfiguration.isThunderbackWindow()) {
            displayWindowDecor = config.windowConfiguration.hasWindowDecorCaption();
        }
        DecorCaptionView decorCaptionView = this.mDecorCaptionView;
        if (decorCaptionView == null && displayWindowDecor) {
            LayoutInflater inflater = this.mWindow.getLayoutInflater();
            DecorCaptionView createDecorCaptionView = createDecorCaptionView(inflater);
            this.mDecorCaptionView = createDecorCaptionView;
            if (createDecorCaptionView != null && ThunderbackConfig.isVersion4() && this.mDecorCaptionView.getParent() == null) {
                addView(this.mDecorCaptionView, -1, new ViewGroup.LayoutParams(-1, -1));
            }
            ...
            if (!config.windowConfiguration.hasWindowDecorCaption()) {
                DecorCaptionView decorCaptionView2 = this.mDecorCaptionView;
                if (decorCaptionView2 instanceof TranMultiDecorCaptionViewV4) {
                    decorCaptionView2.updateConfiguration(config);
                    this.mDecorCaptionView.onWindowFocusChanged(this.mIsFocus);
                    removeView(this.mDecorCaptionView);
                    this.mDecorCaptionView = null;
            ...
            Configuration mCaptionConfig = this.mDecorCaptionView.getConfiguration();
            boolean oldIsNight = false;
            boolean newIsNight = false;
            if (mCaptionConfig != null) {
                oldIsNight = (mCaptionConfig.uiMode & 48) == 32;
                newIsNight = (config.uiMode & 48) == 32;
            }
            Log.d("config_debug", "decorview updateDecorCaptionStatus mCaptionConfig: " + mCaptionConfig + " config: " + config);
            if ((mCaptionConfig != null && mCaptionConfig.windowConfiguration.getInLargeScreen() != config.windowConfiguration.getInLargeScreen()) || oldIsNight != newIsNight) {
                removeView(this.mDecorCaptionView);
                this.mDecorCaptionView = null;
                LayoutInflater inflater2 = this.mWindow.getLayoutInflater();
                DecorCaptionView createDecorCaptionView2 = createDecorCaptionView(inflater2, true);
                this.mDecorCaptionView = createDecorCaptionView2;
                if (createDecorCaptionView2 != null) {
                    addView(createDecorCaptionView2, -1, new ViewGroup.LayoutParams(-1, -1));
                }
            }
            this.mDecorCaptionView.updateConfiguration(config);
            this.mDecorCaptionView.onWindowFocusChanged(this.mIsFocus);
