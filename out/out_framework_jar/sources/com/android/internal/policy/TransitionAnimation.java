...
public class TransitionAnimation {
    ...
    private final Interpolator mThumbnailFadeInInterpolator = new Interpolator() { // from class: com.android.internal.policy.TransitionAnimation$$ExternalSyntheticLambda0
        ...
        public final float getInterpolation(float f) {
            return TransitionAnimation.this.m6892lambda$new$0$comandroidinternalpolicyTransitionAnimation(f);
        }
    };
    private final Interpolator mThumbnailFadeOutInterpolator = new Interpolator() { // from class: com.android.internal.policy.TransitionAnimation$$ExternalSyntheticLambda1
        @Override // android.animation.TimeInterpolator
        public final float getInterpolation(float f) {
            return TransitionAnimation.this.m6893lambda$new$1$comandroidinternalpolicyTransitionAnimation(f);
        }
    };
    ...
    public /* synthetic */ float m6892lambda$new$0$comandroidinternalpolicyTransitionAnimation(float input) {
        if (input >= 0.5f) {
    ...
    public /* synthetic */ float m6893lambda$new$1$comandroidinternalpolicyTransitionAnimation(float input) {
        if (input < 0.5f) {
            float t = input / 0.5f;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r7v6, resolved type: android.view.animation.AnimationSet */
