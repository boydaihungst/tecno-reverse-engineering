...
public interface IKeyguardService extends IInterface {
    ...
    void onStartFaceUnlock() throws RemoteException;

    void onStartedGoingToSleep(int i) throws RemoteException;

    void onStartedNotifyFaceunlock(int i) throws RemoteException;
    ...
    public static class Default implements IKeyguardService {
        ...
        @Override // com.android.internal.policy.IKeyguardService
        public void onStartedNotifyFaceunlock(int reason) throws RemoteException {
        }

        @Override // com.android.internal.policy.IKeyguardService
        public void onStartFaceUnlock() throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IKeyguardService {
        ...
        static final int TRANSACTION_onStartFaceUnlock = 26;
        static final int TRANSACTION_onStartedGoingToSleep = 7;
        static final int TRANSACTION_onStartedNotifyFaceunlock = 25;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 25:
                    return "onStartedNotifyFaceunlock";
                case 26:
                    return "onStartFaceUnlock";
                default:
                    return null;
            }
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 25:
                            ...
                            data.enforceNoDataAvail();
                            onStartedNotifyFaceunlock(_arg016);
                            break;
                        case 26:
                            onStartFaceUnlock();
                            break;
