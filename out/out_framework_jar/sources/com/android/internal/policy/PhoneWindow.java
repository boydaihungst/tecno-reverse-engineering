...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    @Override // android.view.Window
    public final void setBackgroundBlurSaturation(float saturation) {
        super.setBackgroundBlurSaturation(saturation);
        if (CrossWindowBlurListeners.CROSS_WINDOW_BLUR_SUPPORTED && this.mBackgroundBlurSaturation != Math.max(saturation, -2.0f)) {
            float max = Math.max(saturation, -2.0f);
            this.mBackgroundBlurSaturation = max;
            this.mDecor.setBackgroundBlurSaturation(max);
        }
    }
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        if (!this.mForcedNavigationBarColor) {
            ...
            this.mNavigationBarColor = ITranInternalView.Instance().modifyDefaultNaviBarColor(this, this.mNavigationBarColor, a.getDrawable(1), this.mIsTranslucent);
