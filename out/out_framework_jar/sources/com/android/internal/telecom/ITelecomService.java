...
public interface ITelecomService extends IInterface {
    ...
    String getPhoneNumberByIms(int i) throws RemoteException;
    ...
    boolean isVsimSlot(int i) throws RemoteException;
    ...
    boolean shouldRingForContact() throws RemoteException;
    ...
    public static class Default implements ITelecomService {
        ...
        @Override // com.android.internal.telecom.ITelecomService
        public boolean shouldRingForContact() throws RemoteException {
            return false;
        }

        @Override // com.android.internal.telecom.ITelecomService
        public String getPhoneNumberByIms(int phoneId) throws RemoteException {
            return null;
        }

        @Override // com.android.internal.telecom.ITelecomService
        public boolean isVsimSlot(int slotId) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements ITelecomService {
        ...
        static final int TRANSACTION_getPhoneNumberByIms = 73;
        ...
        static final int TRANSACTION_isVsimSlot = 74;
        ...
        static final int TRANSACTION_shouldRingForContact = 72;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 72:
                    return "shouldRingForContact";
                case 73:
                    return "getPhoneNumberByIms";
                case 74:
                    return "isVsimSlot";
                default:
                    return null;
                ...
                default:
                    switch (code) {
                        ...
                        case 68:
                            ...
                            data.enforceNoDataAvail();
                            setSystemDialer(_arg053);
                            reply.writeNoException();
                            break;
                        case 69:
                            String _arg054 = data.readString();
                            data.enforceNoDataAvail();
                            setTestDefaultDialer(_arg054);
                            reply.writeNoException();
                            break;
                        case 70:
                            String _arg055 = data.readString();
                            data.enforceNoDataAvail();
                            setTestCallDiagnosticService(_arg055);
                            reply.writeNoException();
                            break;
                        case 71:
                            String _arg056 = data.readString();
                            UserHandle _arg131 = (UserHandle) data.readTypedObject(UserHandle.CREATOR);
                            String _arg211 = data.readString();
                            data.enforceNoDataAvail();
                            boolean _result42 = isInSelfManagedCall(_arg056, _arg131, _arg211);
                            reply.writeNoException();
                            reply.writeBoolean(_result42);
                            break;
                        case 72:
                            boolean _result43 = shouldRingForContact();
                            reply.writeNoException();
                        ...
                        case 73:
                            ...
                            data.enforceNoDataAvail();
                            String _result44 = getPhoneNumberByIms(_arg057);
                            reply.writeNoException();
                        ...
                        case 74:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result45 = isVsimSlot(_arg058);
                            reply.writeNoException();
