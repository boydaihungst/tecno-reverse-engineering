...
public final class TwofishEngine implements BlockCipher {
        ...
        while (i6 < 256) {
            ...
            switch (this.k64Cnt & i5) {
                case 0:
                    ...
                    byte[] bArr4 = bArr3[0];
                    k32e = k32e2;
                    this.gSBox[i6 * 2] = iArr2[(bArr4[(bArr4[b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)];
                    ...
                    byte[] bArr5 = bArr3[1];
                    this.gSBox[(i6 * 2) + 513] = iArr3[(bArr5[(bArr5[b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
                    break;
                case 1:
                    int[] iArr4 = this.gMDS0;
                    byte[][] bArr6 = P;
                    this.gSBox[i6 * 2] = iArr4[(bArr6[i4][b0] & 255) ^ b0(k0)];
                    this.gSBox[(i6 * 2) + 1] = this.gMDS1[(bArr6[0][b1] & 255) ^ b1(k0)];
                    this.gSBox[(i6 * 2) + 512] = this.gMDS2[(bArr6[1][b2] & 255) ^ b2(k0)];
                    this.gSBox[(i6 * 2) + 513] = this.gMDS3[(bArr6[1][b3] & 255) ^ b3(k0)];
                    k32e = k32e2;
                    break;
                case 2:
                    ...
                    k32e = k32e2;
                    this.gSBox[i6 * 2] = iArr22[(bArr42[(bArr42[b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)];
                    ...
                    this.gSBox[(i6 * 2) + 513] = iArr32[(bArr52[(bArr52[b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
                    break;
                case 3:
                    c = 1;
                    byte[][] bArr22 = P;
                    ...
                    k32e = k32e2;
                    this.gSBox[i6 * 2] = iArr222[(bArr422[(bArr422[b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)];
                    ...
                    this.gSBox[(i6 * 2) + 513] = iArr322[(bArr522[(bArr522[b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
                    break;
                default:
                    k32e = k32e2;
                    break;
    ...
    private int F32(int x, int[] k32) {
        ...
        byte[][] bArr4 = P;
        byte[] bArr5 = bArr4[0];
        int i = (this.gMDS1[(bArr4[0][(bArr4[1][b1] & 255) ^ b1(k1)] & 255) ^ b1(k0)] ^ iArr2[(bArr5[(bArr5[b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)]) ^ this.gMDS2[(bArr4[1][(bArr4[0][b2] & 255) ^ b2(k1)] & 255) ^ b2(k0)];
        int[] iArr3 = this.gMDS3;
        byte[] bArr6 = bArr4[1];
        int result2 = i ^ iArr3[(bArr6[(bArr6[b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
        return result2;
    }
