...
public abstract class Primes {
    ...
    public static class MROutput {
        ...
        static /* bridge */ /* synthetic */ MROutput m6760$$Nest$smprobablyPrime() {
            return probablyPrime();
        }

        /* renamed from: -$$Nest$smprovablyCompositeNotPrimePower  reason: not valid java name */
        static /* bridge */ /* synthetic */ MROutput m6761$$Nest$smprovablyCompositeNotPrimePower() {
    ...
    public static MROutput enhancedMRProbablePrimeTest(BigInteger candidate, SecureRandom random, int iterations) {
        ...
        if (candidate.bitLength() == 2) {
            return MROutput.m6760$$Nest$smprobablyPrime();
        }
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            if (!z.equals(bigInteger) && !z.equals(wSubOne)) {
                ...
                if (!primeToBase) {
                    ...
                    return MROutput.m6761$$Nest$smprovablyCompositeNotPrimePower();
                }
            }
        }
        return MROutput.m6760$$Nest$smprobablyPrime();
