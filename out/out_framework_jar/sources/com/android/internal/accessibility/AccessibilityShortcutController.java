...
public class AccessibilityShortcutController {
    ...
    public static Map<ComponentName, ToggleableFrameworkFeatureInfo> getFrameworkShortcutFeaturesMap() {
        if (sFrameworkShortcutFeaturesMap == null) {
            ...
            featuresMap.put(COLOR_INVERSION_COMPONENT_NAME, new ToggleableFrameworkFeatureInfo(Settings.Secure.ACCESSIBILITY_DISPLAY_INVERSION_ENABLED, "1", AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS, R.string.color_inversion_feature_name));
            featuresMap.put(DALTONIZER_COMPONENT_NAME, new ToggleableFrameworkFeatureInfo(Settings.Secure.ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED, "1", AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS, R.string.color_correction_feature_name));
            featuresMap.put(ONE_HANDED_COMPONENT_NAME, new ToggleableFrameworkFeatureInfo(Settings.Secure.ONE_HANDED_MODE_ACTIVATED, "1", AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS, R.string.one_handed_mode_feature_name));
            featuresMap.put(REDUCE_BRIGHT_COLORS_COMPONENT_NAME, new ToggleableFrameworkFeatureInfo(Settings.Secure.REDUCE_BRIGHT_COLORS_ACTIVATED, "1", AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS, R.string.reduce_bright_colors_feature_name));
    ...
    private AlertDialog createShortcutWarningDialog(final int userId) {
        ...
        AlertDialog alertDialog = frameworkObjectProvider.getAlertDialogBuilder(frameworkObjectProvider.getSystemUiContext()).setTitle(getShortcutWarningTitle(targets)).setMessage(getShortcutWarningMessage(targets)).setCancelable(false).setNegativeButton(R.string.accessibility_shortcut_on, (DialogInterface.OnClickListener) null).setPositiveButton(R.string.accessibility_shortcut_off, new DialogInterface.OnClickListener() { // from class: com.android.internal.accessibility.AccessibilityShortcutController$$ExternalSyntheticLambda0
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                AccessibilityShortcutController.this.m6332x26b5297e(userId, dialogInterface, i);
            }
            ...
            public final void onCancel(DialogInterface dialogInterface) {
                AccessibilityShortcutController.this.m6333xc32325dd(userId, dialogInterface);
            }
        }).create();
        return alertDialog;
    }

    /* renamed from: lambda$createShortcutWarningDialog$0$com-android-internal-accessibility-AccessibilityShortcutController */
    public /* synthetic */ void m6332x26b5297e(int userId, DialogInterface d, int which) {
    ...
    /* renamed from: lambda$createShortcutWarningDialog$1$com-android-internal-accessibility-AccessibilityShortcutController */
    public /* synthetic */ void m6333xc32325dd(int userId, DialogInterface d) {
        Settings.Secure.putIntForUser(this.mContext.getContentResolver(), Settings.Secure.ACCESSIBILITY_SHORTCUT_DIALOG_SHOWN, 0, userId);
    }
    ...
    public class TtsPrompt implements TextToSpeech.OnInitListener {
        ...
        TtsPrompt(String serviceName) {
            ...
            this.mText = r4.mContext.getString(R.string.accessibility_shortcut_spoken_feedback, serviceName);
