...
public class AndroidFuture<T> extends CompletableFuture<T> implements Parcelable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.android.internal.infra.AndroidFuture<T> */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: TT */
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public static class ThenCombine<T, U, V> extends AndroidFuture<V> implements BiConsumer<Object, Throwable> {
        ...
        public void accept(Object res, Throwable err) {
            if (err != null) {
                ...
                this.mSourceU.whenComplete(new BiConsumer() { // from class: com.android.internal.infra.AndroidFuture$ThenCombine$$ExternalSyntheticLambda0
                    @Override // java.util.function.BiConsumer
                    public final void accept(Object obj, Object obj2) {
                        AndroidFuture.ThenCombine.this.m6614xbe86c220(obj, (Throwable) obj2);
                    }
                });
            } else {
                try {
        ...
        public /* synthetic */ void m6614xbe86c220(Object r, Throwable e) {
            this.mSourceU = null;
            accept(r, e);
        }
    }
