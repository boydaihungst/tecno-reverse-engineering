...
public class OverlayConfig {
    ...
    private static final String OS_SETTINGS_OVERLAY_PKG = "com.android.settings.os.overlay";
    private static final String OS_SYSTEMUI_OVERLAY_PKG = "com.android.systemui.os.overlay";
    ...
    public static native String[] createIdmap(String str, String[] strArr, String[] strArr2, boolean z);
    ...
    public boolean isEnabled(String packageName) {
        if (OS_SYSTEMUI_OVERLAY_PKG.equals(packageName) || OS_SETTINGS_OVERLAY_PKG.equals(packageName)) {
            return true;
        }
    ...
    public static class TranOverlayConfigTroy implements ITranOverlayConfigTroy {
        ...
        @Override // com.transsion.hubcore.content.om.ITranOverlayConfigTroy
        public ArrayList<Configuration> getSortedOverlays() {
            return mOverlayConfig.getSortedOverlays();
        }

        @Override // com.transsion.hubcore.content.om.ITranOverlayConfigTroy
        public String[] createIdmap(String targetPath, String[] overlayPath, String[] policies, boolean enforceOverlayable) {
            return OverlayConfig.createIdmap(targetPath, overlayPath, policies, enforceOverlayable);
        }
