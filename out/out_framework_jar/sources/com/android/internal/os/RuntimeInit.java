...
import com.transsion.exception.ExceptionHandle;
...
public class RuntimeInit {
    ...
    public static class LoggingHandler implements Thread.UncaughtExceptionHandler {
        ExceptionHandle mExceptionHandle;
        public volatile boolean mTriggered;

        private LoggingHandler() {
            this.mTriggered = false;
            this.mExceptionHandle = new ExceptionHandle();
        }
        ...
        public void uncaughtException(Thread t, Throwable e) {
            ...
            if (RuntimeInit.mApplicationObject == null && 1000 == Process.myUid()) {
                ...
                if ("true".equals(SystemProperties.get("persist.sys.usic.support", "false"))) {
                    this.mExceptionHandle.handleException(true, e);
                }
                String FILE_NAME = Os.getpid() + ".hprof";
                ApplicationErrorReport.CrashInfo mCrashInfo = new ApplicationErrorReport.CrashInfo(e);
                if ("java.lang.OutOfMemoryError".equals(mCrashInfo.exceptionClassName) && !"user".equals(Build.TYPE)) {
            ...
            if ("true".equals(SystemProperties.get("persist.sys.usic.support", "false"))) {
                this.mExceptionHandle.handleException(false, e);
            }
        }
    }
