...
public class BinderCallsStats implements BinderInternal.Observer {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (uidEntry != null) {
                            ...
                            for (int j = 0; j < csize; j++) {
                                tmpCallStats.add(callStats.valueAt(j).m6842clone());
                            }
    ...
    /* JADX DEBUG: Type inference failed for r2v0. Raw type applied. Possible types: java.lang.Class<?>, java.lang.Class<? extends android.os.Binder> */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [358=6] */
