...
public abstract class KernelCpuUidTimeReader<T> {
    ...
    public static class KernelCpuUidFreqTimeReader extends KernelCpuUidTimeReader<long[]> {
        ...
        /* JADX DEBUG: Type inference failed for r0v0. Raw type applied. Possible types: android.util.SparseArray<T>, android.util.SparseArray<long[]> */
        ...
        private void processUidDelta(Callback<long[]> cb) {
            ...
            while (true) {
                ...
                if (i < i2) {
                    ...
                    jArr[i] = j;
                    if (j < 0) {
                        Slog.e(this.mTag, "Negative delta from freq time for uid: " + uid + ", delta: " + this.mDeltaTimes[i]);
                        return;
                    } else {
                        notify |= j > 0;
                        i++;
        ...
        private void processUidDelta(Callback<Long> cb) {
            ...
            if (cpuActiveTime > 0) {
                ...
                if (delta > 0) {
                    ...
                    Slog.e(this.mTag, "Negative delta from active time for uid: " + uid + ", delta: " + delta);
                }
            }
        }
        ...
        void processUidDelta(Callback<long[]> cb) {
            ...
            while (true) {
                ...
                if (i < i2) {
                    ...
                    jArr[i] = j;
                    if (j < 0) {
                        Slog.e(this.mTag, "Negative delta from cluster time for uid: " + uid + ", delta: " + this.mDeltaTime[i]);
                        return;
                    } else {
                        notify |= j > 0;
                        i++;
