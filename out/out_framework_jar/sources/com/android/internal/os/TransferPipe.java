...
public class TransferPipe implements Runnable, Closeable {
    ...
    public void goAsyncBegin(FileDescriptor out) {
        goAsyncBegin(out, 5000L);
    }

    public void goAsyncBegin(FileDescriptor out, long timeout) {
        synchronized (this) {
            this.mOutFd = out;
            this.mEndTime = SystemClock.uptimeMillis() + timeout;
            this.mThread.start();
    ...
    */
    public void goAsyncEnd() throws IOException {
        try {
            synchronized (this) {
                closeFd(1);
                while (true) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [359=4, 364=6] */
    ...
    public void run() {
        ...
        synchronized (this) {
            ...
            byte[] bufferPrefix = str != null ? str.getBytes() : null;
            while (true) {
                try {
                    try {
