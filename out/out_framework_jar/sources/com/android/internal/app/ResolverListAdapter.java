...
public class ResolverListAdapter extends BaseAdapter {
    ...
    static /* bridge */ /* synthetic */ ColorMatrixColorFilter m6478$$Nest$smgetSuspendedColorMatrix() {
    ...
    public TargetInfo targetInfoForPosition(int position, boolean filtered) {
        ...
        if (this.mDisplayList.size() > position && position >= 0) {
    ...
    Drawable loadIconForResolveInfo(ResolveInfo ri) {
        ...
        UserManager userManager = (UserManager) this.mContext.getSystemService("user");
        return makePresentationGetter(ri).getIcon(userManager.isDualProfile(userHandle.getIdentifier()) ? new UserHandle(0) : userHandle);
    }
    ...
    public static class ViewHolder {
        ...
        public void bindIcon(TargetInfo info) {
            ...
            if (info.isSuspended()) {
                this.icon.setColorFilter(ResolverListAdapter.m6478$$Nest$smgetSuspendedColorMatrix());
            } else {
