...
public class LocalePicker extends ListFragment {
    ...
    public static List<LocaleInfo> getAllAssetLocales(Context context, boolean isInDeveloperMode) {
        ...
        for (String locale : localeList) {
            ...
            if (l != null && !"und".equals(l.getLanguage()) && (!"en".equals(l.getLanguage()) || !"HK".equals(l.getCountry()))) {
                if (!l.getLanguage().isEmpty() && !l.getCountry().isEmpty() && (isInDeveloperMode || !LocaleList.isPseudoLocale(l))) {
