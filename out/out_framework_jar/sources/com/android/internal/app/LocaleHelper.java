...
public class LocaleHelper {
    ...
    public static String getDisplayName(Locale locale, Locale displayLocale, boolean sentenceCase) {
        ...
        if ("ar_EG".equals(locale.toString())) {
            result = locale.getDisplayLanguage(displayLocale);
        }
        if ("sw_TZ".equals(locale.toString())) {
            result = locale.getDisplayLanguage(displayLocale);
        }
        if ("zh_CN_#Hans".contains(locale.toString())) {
            ULocale zh_Hans = new ULocale("zh", "Hans");
            result = zh_Hans.getDisplayNameWithDialect(zh_Hans);
        }
        if ("zh_TW_#Hant".contains(locale.toString())) {
            ULocale zh_Hant = new ULocale("zh", "Hant");
            result = zh_Hant.getDisplayNameWithDialect(zh_Hant);
        }
    ...
    public static String getDisplayCountry(Locale locale, Locale displayLocale) {
        ...
        if (locale.toString().equals("ar_EG")) {
            return "افتراضي";
        }
