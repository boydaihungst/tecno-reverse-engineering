...
public final class DumpUtils {
    ...
    static {
        ...
        STATE_NAMES_CSV = r1;
        String[] strArr3 = {"pers", "top", "btop", "fgs", "bfgs", "impfg", "impbg", Context.BACKUP_SERVICE, "service", "service-rs", IncidentManager.URI_PARAM_RECEIVER_CLASS, "heavy", "home", "lastact", "cached", "frzn"};
        STATE_TAGS = r1;
        String[] strArr4 = {"p", "t", "z", "g", "y", FullBackup.FILES_TREE_TOKEN, XmlTags.TAG_BLOB, XmlTags.ATTR_UID, XmlTags.TAG_SESSION, "x", "r", "w", "h", XmlTags.TAG_LEASEE, FullBackup.APK_TREE_TOKEN, "e"};
