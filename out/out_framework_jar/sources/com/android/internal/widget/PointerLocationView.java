...
public class PointerLocationView extends View implements InputManager.InputDeviceListener, WindowManagerPolicyConstants.PointerEventListener {
    ...
    public static class PointerState {
        ...
        public void addTrace(float x, float y, boolean current) {
            ...
            if (i == 4096) {
                Log.d(PointerLocationView.TAG, "mTraceCount==4096, now is maxValue");
                int i2 = this.mTraceCount / 2;
                this.mTraceCount = i2;
                float[] newTraceX = new float[traceCapacity];
                System.arraycopy(this.mTraceX, i2, newTraceX, 0, i2);
                this.mTraceX = newTraceX;
                float[] newTraceY = new float[traceCapacity];
                float[] fArr2 = this.mTraceY;
                int i3 = this.mTraceCount;
                System.arraycopy(fArr2, i3, newTraceY, 0, i3);
                ...
                System.arraycopy(zArr, i4, newTraceCurrent, 0, i4);
                this.mTraceCurrent = newTraceCurrent;
            } else if (i == traceCapacity) {
                int traceCapacity2 = traceCapacity * 2;
                float[] newTraceX2 = new float[traceCapacity2];
                System.arraycopy(fArr, 0, newTraceX2, 0, i);
                this.mTraceX = newTraceX2;
                float[] newTraceY2 = new float[traceCapacity2];
                System.arraycopy(this.mTraceY, 0, newTraceY2, 0, this.mTraceCount);
                this.mTraceY = newTraceY2;
                boolean[] newTraceCurrent2 = new boolean[traceCapacity2];
                System.arraycopy(this.mTraceCurrent, 0, newTraceCurrent2, 0, this.mTraceCount);
                this.mTraceCurrent = newTraceCurrent2;
            }
            float[] fArr3 = this.mTraceX;
            int i5 = this.mTraceCount;
            fArr3[i5] = x;
            this.mTraceY[i5] = y;
            this.mTraceCurrent[i5] = current;
            this.mTraceCount = i5 + 1;
        }
    }
    ...
    public void onPointerEvent(MotionEvent event) {
        ...
        if (action == 0 || (action & 255) == 5) {
            ...
            if (i3 < 0 || i3 >= NP2 || !this.mPointers.get(i3).mCurDown) {
    ...
    public void onDetachedFromWindow() {
        ...
        try {
            if (dm.getDisplay(this.mContext.getDisplayId()) != null) {
            ...
            if (dm.getDisplay(this.mContext.getDisplayId()) == null) {
                Slog.w(TAG, "display " + this.mContext.getDisplayId() + " has been removed, no need to unregisterSystemGesture");
                return;
            }
            throw e.rethrowFromSystemServer();
        }
    ...
    public class AnonymousClass1 extends ISystemGestureExclusionListener.Stub {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.android.internal.widget.PointerLocationView$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        PointerLocationView.AnonymousClass1.this.m7094x6282264d(exclusion, rejected);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m7094x6282264d(Region exclusion, Region rejected) {
