...
public final class LocalFloatingToolbarPopup implements FloatingToolbarPopup {
    ...
    private final ViewTreeObserver.OnComputeInternalInsetsListener mInsetsComputer = new ViewTreeObserver.OnComputeInternalInsetsListener() { // from class: com.android.internal.widget.floatingtoolbar.LocalFloatingToolbarPopup$$ExternalSyntheticLambda1
        ...
        public final void onComputeInternalInsets(ViewTreeObserver.InternalInsetsInfo internalInsetsInfo) {
            LocalFloatingToolbarPopup.this.m7221x4c6a9db2(internalInsetsInfo);
        }
    };
    ...
    public /* synthetic */ void m7221x4c6a9db2(ViewTreeObserver.InternalInsetsInfo info) {
    ...
    private ImageButton createOverflowButton() {
        ImageButton osOverflowButton = ITranInternalView.Instance().createOverflowButton(this.mContext);
        final ImageButton overflowButton = osOverflowButton != null ? osOverflowButton : (ImageButton) LayoutInflater.from(this.mContext).inflate(R.layout.floating_popup_overflow_button, (ViewGroup) null);
        ...
        overflowButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.widget.floatingtoolbar.LocalFloatingToolbarPopup$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                LocalFloatingToolbarPopup.this.m7219xdabd3e5d(overflowButton, view);
            }
        });
    ...
    public /* synthetic */ void m7219xdabd3e5d(ImageButton overflowButton, View v) {
        if (this.mIsOverflowOpen) {
    ...
    private OverflowPanel createOverflowPanel() {
        ...
        overflowPanel.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.android.internal.widget.floatingtoolbar.LocalFloatingToolbarPopup$$ExternalSyntheticLambda2
            ...
            public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                LocalFloatingToolbarPopup.this.m7220x8c66de1a(overflowPanel, adapterView, view, i, j);
            }
        });
    ...
    public /* synthetic */ void m7220x8c66de1a(OverflowPanel overflowPanel, AdapterView parent, View view, int position, long id) {
    ...
    public class AnonymousClass13 implements Animation.AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            LocalFloatingToolbarPopup.this.mContentContainer.post(new Runnable() { // from class: com.android.internal.widget.floatingtoolbar.LocalFloatingToolbarPopup$13$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    LocalFloatingToolbarPopup.AnonymousClass13.this.m7222x49aabae4();
                }
            });
        }
        ...
        public /* synthetic */ void m7222x49aabae4() {
            LocalFloatingToolbarPopup.this.setPanelsStatesAtRestingPosition();
            LocalFloatingToolbarPopup.this.setContentAreaAsTouchableSurface();
        }
    ...
    public static View createMenuItemButton(Context context, MenuItem menuItem, int iconTextSpacing, boolean showIcon) {
        View osMenuItemButton = ITranInternalView.Instance().createMenuItemButton(context);
        View menuItemButton = osMenuItemButton != null ? osMenuItemButton : LayoutInflater.from(context).inflate(R.layout.floating_popup_menu_button, (ViewGroup) null);
        if (menuItem != null) {
    ...
    public static void updateMenuItemButton(View menuItemButton, MenuItem menuItem, int iconTextSpacing, boolean showIcon) {
        ...
        if (menuItem.getItemId() == 101122054 || menuItem.getItemId() == 101122055) {
    ...
    private static ViewGroup createContentContainer(Context context) {
        ViewGroup osContentContainer = ITranInternalView.Instance().createContentContaine(context);
        ViewGroup contentContainer = osContentContainer != null ? osContentContainer : (ViewGroup) LayoutInflater.from(context).inflate(R.layout.floating_popup_container, (ViewGroup) null);
