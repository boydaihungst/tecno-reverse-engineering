...
public interface ILockSettings extends IInterface {
    ...
    void setLockNoneCredential(LockscreenCredential lockscreenCredential, int i, int i2) throws RemoteException;
    ...
    public static class Default implements ILockSettings {
        ...
        @Override // com.android.internal.widget.ILockSettings
        public void setLockNoneCredential(LockscreenCredential credential, int userId, int flag) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements ILockSettings {
        ...
        static final int TRANSACTION_setLockNoneCredential = 53;
                ...
                default:
                    switch (code) {
                        ...
                        case 52:
                            ...
                            break;
                        case 53:
                            LockscreenCredential _arg048 = (LockscreenCredential) data.readTypedObject(LockscreenCredential.CREATOR);
                            int _arg127 = data.readInt();
                            int _arg219 = data.readInt();
                            data.enforceNoDataAvail();
                            setLockNoneCredential(_arg048, _arg127, _arg219);
                            reply.writeNoException();
                            break;
                        default:
