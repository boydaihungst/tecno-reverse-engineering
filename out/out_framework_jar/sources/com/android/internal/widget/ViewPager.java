...
public class ViewPager extends ViewGroup {
    ...
    private boolean performDrag(float x, float y) {
        ...
        int offsetBound2 = isLayoutRtl() ? width : 0;
        if (startAbsolute) {
            offsetBound = offsetBound2;
            startBound = (startItem.offset * width) + offsetBound;
        } else {
            offsetBound = offsetBound2;
        ...
        if (!endAbsolute) {
            ...
            endBound = (endItem.offset * width) + offsetBound;
        }
