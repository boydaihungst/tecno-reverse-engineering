...
public class LockPatternView extends View {
    ...
    private static final boolean SUPPORT_CUSTOM_WRONG_ANIMATION = "1".equals(SystemProperties.get("ro.os_lock_screen_wrong_support"));
    ...
    private boolean mPathTransparent;
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        int integer = getResources().getInteger(R.integer.zzzzz_os_lock_pattern_dot_line_alpha);
        this.mPathAlpha = integer;
        boolean z = integer != 255;
        this.mPathTransparent = z;
        this.mFadePattern = !z;
        ...
        boolean z2 = getResources().getBoolean(R.bool.use_lock_pattern_drawable);
        this.mUseLockPatternDrawable = z2;
        if (z2) {
    ...
    public void setDisplayMode(DisplayMode displayMode) {
        ...
        boolean z = SUPPORT_CUSTOM_WRONG_ANIMATION;
        if (z) {
        ...
        if (displayMode == DisplayMode.Animate) {
            ...
            clearPatternDrawLookup();
        } else if (z && displayMode == DisplayMode.Wrong) {
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.5f, 1.0f, 0.5f);
            this.mValueAnimator = ofFloat;
            ofFloat.setDuration(500L);
            this.mValueAnimator.setRepeatCount(2);
            this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    LockPatternView.this.m7083xb1388e0f(valueAnimator);
                }
            });
            this.mValueAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.android.internal.widget.LockPatternView.1
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                    if (LockPatternView.this.mOnAnimationListener != null) {
                        LockPatternView.this.mOnAnimationListener.onErrorAnimationEnd();
                    }
                }
                ...
                public void onAnimationStart(Animator animation) {
                    ...
                    if (LockPatternView.this.mOnAnimationListener != null) {
                        LockPatternView.this.mOnAnimationListener.onErrorAnimationStarted();
                    }
                }
            });
    ...
    /* renamed from: lambda$setDisplayMode$0$com-android-internal-widget-LockPatternView  reason: not valid java name */
    public /* synthetic */ void m7083xb1388e0f(ValueAnimator animation) {
        this.mPathAlpha = (int) (((Float) animation.getAnimatedValue()).floatValue() * 255.0f);
        changeCellRadiusSize(((Float) animation.getAnimatedValue()).floatValue());
        invalidate();
    }
    ...
    private void changeCellRadiusSize(float x) {
        for (int i = 0; i < this.mPattern.size(); i++) {
            Cell cell = this.mPattern.get(i);
            CellState cellState = this.mCellStates[cell.row][cell.column];
            float radius = this.mDotSize * x;
            BigDecimal bg = new BigDecimal(radius);
            cellState.radius = bg.setScale(2, 4).floatValue();
        }
    }
    ...
    private void startCellStateAnimationSw(final CellState cellState, final float startAlpha, final float endAlpha, final float startTranslationY, final float endTranslationY, final float startScale, final float endScale, long delay, long duration, Interpolator interpolator, final Runnable finishRunnable) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView.2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        ...
        animator.addListener(new AnimatorListenerAdapter() { // from class: com.android.internal.widget.LockPatternView.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
    ...
    private void startCellStateAnimationHw(final CellState cellState, float startAlpha, float endAlpha, float startTranslationY, float endTranslationY, float startScale, float endScale, long delay, long duration, Interpolator interpolator, final Runnable finishRunnable) {
        ...
        startRtAlphaAnimation(cellState, endAlpha, delay, duration, interpolator, new AnimatorListenerAdapter() { // from class: com.android.internal.widget.LockPatternView.4
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
    ...
    private void clearPatternDrawLookup() {
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                ...
                if (this.mPathTransparent) {
                    this.mCellStates[i][j].radius = this.mDotSize / 2;
                    this.mCellStates[i][j].alpha = 0.8f;
                }
            }
        }
    }
    ...
    private Animator createDotActivationColorAnimation(final CellState cellState) {
        ValueAnimator.AnimatorUpdateListener updateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                LockPatternView.this.m7079xa3c48e57(cellState, valueAnimator);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$createDotActivationColorAnimation$1$com-android-internal-widget-LockPatternView  reason: not valid java name */
    public /* synthetic */ void m7079xa3c48e57(CellState cellState, ValueAnimator valueAnimator) {
    ...
    private Animator createLineEndAnimation(final CellState state, final float startX, final float startY, final float targetX, final float targetY) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                LockPatternView.this.m7082xa4c42be7(state, startX, targetX, startY, targetY, valueAnimator2);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$createLineEndAnimation$2$com-android-internal-widget-LockPatternView  reason: not valid java name */
    public /* synthetic */ void m7082xa4c42be7(CellState state, float startX, float targetX, float startY, float targetY, ValueAnimator animation) {
        float t = ((Float) animation.getAnimatedValue()).floatValue();
    ...
    private Animator createLineDisappearingAnimation() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                LockPatternView.this.m7081x9d20a02a(valueAnimator2);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$createLineDisappearingAnimation$3$com-android-internal-widget-LockPatternView  reason: not valid java name */
    public /* synthetic */ void m7081x9d20a02a(ValueAnimator animation) {
        invalidate();
    }
    ...
    private Animator createDotRadiusAnimation(final CellState state) {
        ...
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.LockPatternView$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                LockPatternView.this.m7080xd118535(state, valueAnimator);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$createDotRadiusAnimation$4$com-android-internal-widget-LockPatternView  reason: not valid java name */
    public /* synthetic */ void m7080xd118535(CellState state, ValueAnimator animation) {
        state.radius = ((Float) animation.getAnimatedValue()).floatValue();
        if (this.mPathTransparent) {
            state.alpha = (animation.getAnimatedFraction() * 0.2f) + 0.8f;
        }
        invalidate();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (this.mInputEnabled && isEnabled()) {
            switch (event.getAction()) {
                case 0:
                    Log.v(TAG, "event is action down");
                    ValueAnimator valueAnimator = this.mValueAnimator;
                    if (valueAnimator != null && valueAnimator.isRunning()) {
                        this.mValueAnimator.cancel();
                        this.mPathAlpha = getResources().getInteger(R.integer.zzzzz_os_lock_pattern_dot_line_alpha);
                    }
                    handleActionDown(event);
                    return true;
                case 1:
                    Log.v(TAG, "event is action up");
                    handleActionUp();
                    return true;
                case 2:
                    Log.v(TAG, "event is action move");
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (drawPath) {
            if (!SUPPORT_CUSTOM_WRONG_ANIMATION) {
                this.mPathPaint.setColor(getCurrentColor(true));
            ...
            if ((this.mPatternInProgress || this.mPatternDisplayMode == DisplayMode.Animate) && anyCircles) {
                ...
                this.mPathPaint.setAlpha((int) (calculateLastSegmentAlpha(this.mInProgressX, this.mInProgressY, lastX, lastY) * this.mPathAlpha));
    ...
    private int getDotColor(boolean partOfPattern) {
        if (this.mInStealthMode) {
            return this.mDotColor;
        }
        if ((partOfPattern || !this.mPathTransparent) && this.mPatternDisplayMode == DisplayMode.Wrong) {
            return this.mErrorColor;
        }
        return this.mDotColor;
    }
    ...
    private void drawCircle(Canvas canvas, float centerX, float centerY, float radius, boolean partOfPattern, float alpha, float activationAnimationProgress) {
        if (this.mFadePattern && !this.mInStealthMode) {
            ColorUtils.blendARGB(this.mDotColor, this.mDotActivatedColor, activationAnimationProgress);
            this.mPaint.setColor(getDotColor(partOfPattern));
        } else {
            this.mPaint.setColor(getDotColor(partOfPattern));
        }
