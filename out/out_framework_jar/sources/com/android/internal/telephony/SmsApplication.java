...
public final class SmsApplication {
    ...
    public static SmsApplicationData getApplication(Context context, boolean updateIfNeeded, int userId) {
        ...
        if (updateIfNeeded && applicationData == null) {
            ...
            if (SystemProperties.get("ro.tran_rcs_support").equals("1")) {
                defaultPackage = r.getString(R.string.default_google_sms_application);
                Log.i(LOG_TAG, "defaultPackage=" + defaultPackage);
            }
