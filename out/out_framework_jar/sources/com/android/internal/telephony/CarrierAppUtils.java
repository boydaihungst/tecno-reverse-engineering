...
public final class CarrierAppUtils {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [322=9] */
    ...
    public static void disableCarrierAppsUntilPrivileged(String callingPackage, TelephonyManager telephonyManager, ContentResolver contentResolver, int userId, Set<String> systemCarrierAppsDisabledUntilUsed, Map<String, List<CarrierAssociatedAppEntry>> systemCarrierAssociatedAppsDisabledUntilUsed, Context context) {
        ...
        if (candidates != null && !candidates.isEmpty()) {
            ...
            try {
                                                        ...
                                                        for (AssociatedAppInfo associatedApp2 : associatedAppList) {
                                                            if (hasRunEver) {
                                                                ...
                                                                if (!allowDisable && associatedAppEnabledSetting == 0 && associatedAppInstalled) {
                                                                    Log.i(TAG, "Update associated state (" + associatedApp2.appInfo.packageName + "): DISABLED_UNTIL_USED for user " + userId);
                                                                    c = 3;
                                                                    context.createContextAsUser(UserHandle.of(userId), 0).getPackageManager().setSystemAppState(associatedApp2.appInfo.packageName, 3);
                                                                } else {
                                                                    c = 3;
                                                                }
                                                            ...
                                                            allowDisable = true;
                                                            int associatedAppEnabledSetting2 = context.createContextAsUser(UserHandle.of(userId), 0).getPackageManager().getApplicationEnabledSetting(associatedApp2.appInfo.packageName);
                                                ...
                                                try {
                                                    ...
                                                    if (associatedAppList != null) {
                                                        ...
                                                        while (it2.hasNext()) {
                                                            ...
                                                            String str6 = str4;
                                                            int associatedAppEnabledSetting3 = context.createContextAsUser(UserHandle.of(userId), 0).getPackageManager().getApplicationEnabledSetting(associatedApp3.appInfo.packageName);
                                                            ...
                                                            try {
                                                                ...
                                                                Log.i(TAG, "Update associated state (" + associatedApp3.appInfo.packageName + str5 + userId);
                                                                str2 = str5;
                                                                context.createContextAsUser(UserHandle.of(userId), 0).getPackageManager().setSystemAppState(associatedApp3.appInfo.packageName, 2);
                                                                context.createPackageContextAsUser(str3, 0, UserHandle.of(userId)).getPackageManager().setApplicationEnabledSetting(associatedApp3.appInfo.packageName, 1, 1);
                                                                it2 = it3;
                                                                str4 = str6;
                                                                carrierAppsHandledSdk4 = carrierAppsHandledSdk2;
                                                                str5 = str2;
                ...
                try {
                    permissionManager4.grantDefaultPermissionsToEnabledCarrierApps(packageNames, UserHandle.of(userId), TelephonyUtils.DIRECT_EXECUTOR, new Consumer() { // from class: com.android.internal.telephony.CarrierAppUtils$$ExternalSyntheticLambda0
