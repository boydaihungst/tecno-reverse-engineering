    ...
    public BaseParceledListSlice(Parcel p, ClassLoader loader) {
        ...
        while (i < N && p.readInt() != 0) {
            ...
            if (DEBUG) {
                ...
                Log.d(str, append.append(list2.get(list2.size() - 1)).toString());
            }
            i++;
        }
        if (i >= N) {
        ...
        while (i2 < N) {
            ...
            try {
                ...
                while (i2 < N && reply.readInt() != 0) {
                    ...
                    if (DEBUG) {
                        Log.d(TAG, new StringBuilder().append("Read extra #").append(i2).append(": ").append(this.mList.get(list.size() - 1)).toString());
                    }
                    i2++;
                }
                reply.recycle();
