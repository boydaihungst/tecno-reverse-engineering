...
public final class Call {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        String string = _hidl_blob.getString(_hidl_offset + 96);
        this.forwardedNumber = string;
        parcel.readEmbeddedBuffer(string.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 96 + 0, false);
    }
