...
public class MarshalQueryableEnum<T extends Enum<T>> implements MarshalQueryable<T> {
    ...
    private class MarshalerEnum extends Marshaler<T> {
        ...
        /* JADX DEBUG: Type inference failed for r1v1. Raw type applied. Possible types: java.lang.Class<? super T extends java.lang.Enum<T>>, java.lang.Class<T extends java.lang.Enum<T>> */
