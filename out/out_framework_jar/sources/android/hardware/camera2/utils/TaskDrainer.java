...
public class TaskDrainer<T> {
    ...
    private void postDrained() {
        this.mExecutor.execute(new Runnable() { // from class: android.hardware.camera2.utils.TaskDrainer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                TaskDrainer.this.m1505lambda$postDrained$0$androidhardwarecamera2utilsTaskDrainer();
            }
        });
    }
    ...
    public /* synthetic */ void m1505lambda$postDrained$0$androidhardwarecamera2utilsTaskDrainer() {
