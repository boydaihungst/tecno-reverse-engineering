...
public interface ICameraService extends IInterface {
    ...
    void setCustomTorchMode(String str, String str2, IBinder iBinder) throws RemoteException;
    ...
    public static class Default implements ICameraService {
        ...
        @Override // android.hardware.ICameraService
        public void setCustomTorchMode(String cameraId, String customKey, IBinder clientBinder) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements ICameraService {
        ...
        static final int TRANSACTION_setCustomTorchMode = 19;
                ...
                default:
                    switch (code) {
                        ...
                        case 19:
                            ...
                            data.enforceNoDataAvail();
                            setCustomTorchMode(_arg016, _arg19, _arg26);
                            reply.writeNoException();
                            break;
                        case 20:
                            ...
                            data.enforceNoDataAvail();
                            notifySystemEvent(_arg017, _arg110);
                            break;
                        case 21:
