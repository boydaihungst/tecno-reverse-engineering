...
public interface IGnssDebug extends IInterface {
    ...
    public static class TimeDebug implements Parcelable {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [240=6, 241=5, 243=5] */
    ...
    public static class PositionDebug implements Parcelable {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [328=14, 329=13, 331=13] */
        /* JADX DEBUG: Finally have unexpected throw blocks count: 2, expect 1 */
        public final void readFromParcel(Parcel _aidl_parcel) {
            int _aidl_start_pos = _aidl_parcel.dataPosition();
            int _aidl_parcelable_size = _aidl_parcel.readInt();
    ...
    public static class SatelliteData implements Parcelable {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [404=11, 405=10, 407=10] */
        /* JADX DEBUG: Finally have unexpected throw blocks count: 2, expect 1 */
        public final void readFromParcel(Parcel _aidl_parcel) {
            int _aidl_start_pos = _aidl_parcel.dataPosition();
            int _aidl_parcelable_size = _aidl_parcel.readInt();
    ...
    public static class DebugData implements Parcelable {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [460=6, 461=5, 463=5] */
        /* JADX DEBUG: Finally have unexpected throw blocks count: 2, expect 1 */
        public final void readFromParcel(Parcel _aidl_parcel) {
            int _aidl_start_pos = _aidl_parcel.dataPosition();
            int _aidl_parcelable_size = _aidl_parcel.readInt();
