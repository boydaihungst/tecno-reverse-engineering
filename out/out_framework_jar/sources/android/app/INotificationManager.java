...
public interface INotificationManager extends IInterface {
    ...
    boolean canPlaySound(String str, int i) throws RemoteException;

    boolean canPlayVibration(String str, int i) throws RemoteException;
    ...
    void setPlaySound(String str, int i, boolean z) throws RemoteException;

    void setPlayVibration(String str, int i, boolean z) throws RemoteException;
    ...
    public static class Default implements INotificationManager {
        ...
        @Override // android.app.INotificationManager
        public boolean canPlaySound(String pkg, int uid) throws RemoteException {
            return false;
        }

        @Override // android.app.INotificationManager
        public void setPlaySound(String pkg, int uid, boolean playSound) throws RemoteException {
        }

        @Override // android.app.INotificationManager
        public boolean canPlayVibration(String pkg, int uid) throws RemoteException {
            return false;
        }

        @Override // android.app.INotificationManager
        public void setPlayVibration(String pkg, int uid, boolean playVibration) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements INotificationManager {
        ...
        static final int TRANSACTION_canPlaySound = 148;
        static final int TRANSACTION_canPlayVibration = 150;
        ...
        static final int TRANSACTION_setPlaySound = 149;
        static final int TRANSACTION_setPlayVibration = 151;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 149:
                    return "setPlaySound";
                case 150:
                    return "canPlayVibration";
                case 151:
                    return "setPlayVibration";
                default:
                    return null;
            }
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 148:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result79 = canPlaySound(_arg0136, _arg198);
                            reply.writeNoException();
                        ...
                        case 149:
                            ...
                            data.enforceNoDataAvail();
                            setPlaySound(_arg0137, _arg199, _arg247);
                            reply.writeNoException();
                            break;
                        case 150:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result80 = canPlayVibration(_arg0138, _arg1100);
                            reply.writeNoException();
                        ...
                        case 151:
                            ...
                            data.enforceNoDataAvail();
                            setPlayVibration(_arg0139, _arg1101, _arg248);
                            reply.writeNoException();
                            break;
                        default:
        ...
        public static class Proxy implements INotificationManager {
            ...
            public void setPlayVibration(String pkg, int uid, boolean playVibration) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(pkg);
                    _data.writeInt(uid);
                    _data.writeBoolean(playVibration);
