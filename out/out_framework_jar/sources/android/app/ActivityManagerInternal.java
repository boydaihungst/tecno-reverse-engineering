...
public abstract class ActivityManagerInternal {
    ...
    public abstract void adjustProcessesPreloadState(String str);
    ...
    public abstract void clearMuteProcessList();

    public abstract void clearMuteProcessList(int i);
    ...
    public abstract boolean isCurrentScreenAwake();
    ...
    public abstract void removeFromMuteProcessList(String str, int i);

    public abstract void removeFromMuteProcessList(String str, int i, int i2);
    ...
    public abstract void startProcess(String str, ApplicationInfo applicationInfo, boolean z, boolean z2, String str2, ComponentName componentName, boolean z3);
    ...
    public abstract void updateMultiWindowProcessList(int i, String str);

    public abstract void updateMultiWindowProcessList(int i, String str, int i2);
