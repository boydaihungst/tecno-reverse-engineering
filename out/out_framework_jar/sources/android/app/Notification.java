...
public class Notification implements Parcelable {
    ...
    public void cloneInto(Notification that, boolean heavy) {
        ...
        if (heavy && (remoteViews4 = this.tickerView) != null) {
            that.tickerView = remoteViews4.mo398clone();
        }
        if (heavy && (remoteViews3 = this.contentView) != null) {
            that.contentView = remoteViews3.mo398clone();
        }
        ...
        if (actionArr != null) {
            ...
            while (true) {
                ...
                if (action != null) {
                    that.actions[i] = action.m371clone();
                }
                i++;
            }
        }
        if (heavy && (remoteViews2 = this.bigContentView) != null) {
            that.bigContentView = remoteViews2.mo398clone();
        }
        if (heavy && (remoteViews = this.headsUpContentView) != null) {
            that.headsUpContentView = remoteViews.mo398clone();
        }
    ...
    public void visitUris(Consumer<Uri> visitor) {
        ...
        if (bundle2 != null) {
            ...
            RemoteInputHistoryItem[] history = (RemoteInputHistoryItem[]) this.extras.getParcelableArray(EXTRA_REMOTE_INPUT_HISTORY_ITEMS);
            if (history != null) {
        ...
        if (isStyle(MessagingStyle.class) && (bundle = this.extras) != null) {
            ...
            visitIconUri(visitor, (Icon) this.extras.getParcelable(EXTRA_CONVERSATION_ICON));
        }
        boolean isStyle = isStyle(CallStyle.class);
        Bundle bundle3 = this.extras;
        if (isStyle & (bundle3 != null)) {
            Person callPerson = (Person) bundle3.getParcelable(EXTRA_CALL_PERSON);
            if (callPerson != null) {
                visitor.accept(callPerson.getIconUri());
            }
            visitIconUri(visitor, (Icon) this.extras.getParcelable(EXTRA_VERIFICATION_ICON));
        }
    ...
    public void writeToParcel(final Parcel parcel, int flags) {
        ...
        synchronized (this) {
            collectPendingIntents = this.allPendingIntents == null;
            if (collectPendingIntents) {
                PendingIntent.setOnMarshaledListener(new PendingIntent.OnMarshaledListener() { // from class: android.app.Notification$$ExternalSyntheticLambda0
                    ...
                    public final void onMarshaled(PendingIntent pendingIntent, Parcel parcel2, int i) {
                        Notification.this.m367lambda$writeToParcel$0$androidappNotification(parcel, pendingIntent, parcel2, i);
                    }
                });
            }
    ...
    public /* synthetic */ void m367lambda$writeToParcel$0$androidappNotification(Parcel parcel, PendingIntent intent, Parcel out, int outFlags) {
        if (parcel == out) {
            synchronized (this) {
    ...
    public static boolean areActionsVisiblyDifferent(Notification first, Notification second) {
        ...
        if (firstAs != null && secondAs != null) {
            ...
            for (int i = 0; i < firstAs.length; i++) {
                if (firstAs[i] != null && secondAs[i] != null) {
    ...
    public static class Builder {
        ...
        public Builder setWhen(long when) {
            this.mN.when = when != 0 ? when : System.currentTimeMillis();
            return this;
        }
        ...
        public RemoteViews applyStandardTemplate(int resId, StandardTemplateParams p, TemplateBindResult result) {
            p.headerless(resId == getBaseLayoutResource() || resId == getHeadsUpBaseLayoutResource() || resId == getMessagingLayoutResource() || resId == 17367232);
            ...
            boolean showProgress = handleProgressBar(resId, contentView, ex, p);
            ...
            if (p.text != null && p.text.length() != 0 && (!showProgress || p.mAllowTextWithProgress)) {
                ...
                hasSecondLine = true;
            } else if (p.mTextViewId != 16909580) {
            ...
            ITranActivityThread.Instance().setButtonVisible(contentView, this.mN, getNonContextualActions().size());
            return contentView;
        }
        ...
        private boolean handleProgressBar(int resId, RemoteViews contentView, Bundle ex, StandardTemplateParams p) {
            ...
            if (!p.mHideProgress && (max != 0 || ind)) {
                if (resId != getBaseLayoutResource() && ((p.text == null || p.text.length() == 0 || !p.hasTitle()) && this.mN.mLargeIcon != null)) {
                    contentView.setViewLayoutWidthDimen(16908301, R.dimen.zzzz_os_notification_progress_width);
                }
                contentView.setViewVisibility(16908301, 0);
                contentView.setProgressBar(16908301, max, progress, ind);
                contentView.setProgressBackgroundTintList(16908301, this.mContext.getColorStateList(R.color.zzzz_os_notification_progress_background_color));
                ColorStateList progressTint = ColorStateList.valueOf(this.mContext.getColor(R.color.os_basic_brand_color));
        ...
        private void bindLargeIconAndApplyMargin(RemoteViews contentView, StandardTemplateParams p, TemplateBindResult result) {
            ...
            if (!p.mHeaderless) {
                ...
                contentView.setInt(p.mTextViewId, "setNumIndentLines", p.hasTitle() ? 1 : 2);
            }
        }
        ...
        private void bindExpandButton(RemoteViews contentView, StandardTemplateParams p) {
            ...
            int pillColor = this.mContext.getColor(R.color.os_action_button_background_color);
            ...
            contentView.setInt(R.id.expand_button, "setHighlightPillColor", this.mContext.getColor(R.color.os_expand_button_background));
        }
        ...
        private boolean isBackgroundColorized(StandardTemplateParams p) {
            return !(this.mN.bigContentView == null && this.mN.headsUpContentView == null && this.mN.contentView == null) && p.allowColorization && this.mN.isColorized();
        }
        ...
        private void bindSmallIcon(RemoteViews contentView, StandardTemplateParams p) {
            ...
            if (this.mContext.getPackageName().contains("google") || this.mContext.getPackageName().contains("com.android.vending")) {
                contentView.setInt(16908294, "setBackgroundResource", R.drawable.zzzz_os_notification_icon_circle);
                contentView.setImageViewIcon(16908294, this.mN.mSmallIcon);
                int padding = this.mContext.getResources().getDimensionPixelSize(R.dimen.notification_icon_circle_padding);
        ...
        public RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p, TemplateBindResult result) {
            ...
            ColorStateList actionColor_bubble = this.mContext.getColorStateList(R.color.zzzz_os_notification_thunderback_button_color);
            big.setColorStateList(R.id.snooze_button, "setImageTintList", actionColor);
            big.setColorStateList(R.id.bubble_button, "setImageTintList", actionColor_bubble);
            ...
            ITranActivityThread.Instance().updateButtonVisible(big, this.mN, numActions);
            ...
            if (numActions <= 0 || p.mHideActions) {
                ...
                big.setViewLayoutMarginDimen(R.id.notification_action_list_margin_target, 3, 0);
                for (int i4 = 0; i4 < numActions; i4++) {
                    Action action = nonContextualActions.get(i4);
            ...
            if (validRemoteInput && replyText != null && replyText.length > 0 && !TextUtils.isEmpty(replyText[i2].getText()) && p.maxRemoteInputHistory > 0) {
                boolean showSpinner = this.mN.extras.getBoolean(Notification.EXTRA_SHOW_REMOTE_INPUT_SPINNER);
                big.setViewVisibility(R.id.notification_material_reply_container, i2);
                big.setViewVisibility(R.id.notification_material_reply_text_1_container, i2);
                big.setTextViewText(R.id.notification_material_reply_text_1, processTextSpans(replyText[i2].getText()));
                setTextViewColorSecondary(big, R.id.notification_material_reply_text_1, p);
                big.setViewVisibility(R.id.notification_material_reply_progress, showSpinner ? i2 : i3);
                ...
                if (replyText.length > 1 && !TextUtils.isEmpty(replyText[1].getText()) && p.maxRemoteInputHistory > 1) {
                    big.setViewVisibility(R.id.notification_material_reply_text_2, i2);
                    ...
                    if (replyText.length > 2 && !TextUtils.isEmpty(replyText[2].getText()) && p.maxRemoteInputHistory > 2) {
                        big.setViewVisibility(R.id.notification_material_reply_text_3, i2);
        ...
        public RemoteViews createHeadsUpContentViewGame(boolean increasedHeight, boolean isGameMode) {
            if (isGameMode) {
                return createGameHeadsUpView(increasedHeight);
            }
            return createHeadsUpContentView(increasedHeight);
        }

        public RemoteViews createGameHeadsUpView(boolean increasedHeight) {
            RemoteViews contenView = ITranActivityThread.Instance().createGameHeadsUpViewLice(this.mContext, this.mN, increasedHeight, this);
            if (contenView != null) {
                return contenView;
            }
            return createHeadsUpContentView(increasedHeight);
        ...
        public RemoteViews createContentViewAppLock(boolean increasedHeight, boolean isGameMode, boolean isAppLockMode) {
            if (isAppLockMode && !isGameMode) {
                return createAppLockView(increasedHeight);
            }
            if (isAppLockMode && isGameMode) {
                return createAppLockAndGameModeView(increasedHeight);
            }
            return null;
        }

        private RemoteViews createAppLockView(boolean increasedHeight) {
            RemoteViews contenView = ITranActivityThread.Instance().createAppLockViewLice(this.mContext, this.mN, increasedHeight, this);
            if (contenView != null) {
                return contenView;
            }
            return null;
        ...
        private RemoteViews createAppLockAndGameModeView(boolean increasedHeight) {
            RemoteViews contenView = ITranActivityThread.Instance().createAppLockAndGameModeViewLice(this.mContext, this.mN, increasedHeight, this);
            if (contenView != null) {
                return contenView;
            }
            return null;
        ...
        public RemoteViews createHeadsUpContentView(boolean increasedHeight) {
            ...
            } else if (this.mActions.size() == 0 && ITranActivityThread.Instance().enableHeadsUpContentView(this.mN)) {
                return null;
            }
        ...
        public RemoteViews makePublicContentView(boolean isLowPriority) {
            ...
            RemoteViews appLockView = createAppLockView(true);
            if (appLockView != null) {
                return appLockView;
            }
        ...
        private RemoteViews generateActionButton(Action action, boolean emphasizedMode, StandardTemplateParams p) {
            ...
            RemoteViews button;
            CharSequence title;
            int actionTombstoneLayoutResource2;
            boolean tombstone = action.actionIntent == null;
            if (Notification.IS_SUPPORT_NOTIFICATION_UI) {
                ApplicationInfo applicationInfo = this.mContext.getApplicationInfo();
                if (emphasizedMode) {
                    actionTombstoneLayoutResource2 = getActionLayoutResource();
                } else {
                    actionTombstoneLayoutResource2 = tombstone ? getActionTombstoneLayoutResource() : getActionLayoutResource();
                }
                button = new BuilderRemoteViews(applicationInfo, actionTombstoneLayoutResource2);
            } else {
                ...
                button = new BuilderRemoteViews(applicationInfo2, actionTombstoneLayoutResource);
            }
            if (!tombstone) {
            ...
            if (Notification.IS_SUPPORT_NOTIFICATION_UI) {
                emphasizedMode = false;
            }
            int actionTextColor = this.mContext.getColor(R.color.os_basic_brand_color);
            if (!emphasizedMode) {
                button.setTextViewText(R.id.action0, processTextSpans(processLegacyText(action.title)));
                button.setTextColor(R.id.action0, actionTextColor);
            } else {
        ...
        private void processSmallIconColor(Icon smallIcon, RemoteViews contentView, StandardTemplateParams p) {
            ...
            contentView.setInt(16908294, "setOriginalIconColor", colorable ? this.mContext.getColor(R.color.os_action_button_color) : 1);
        }
        ...
        public static Notification maybeCloneStrippedForDelivery(Notification n) {
            ...
            Notification clone = n.m368clone();
            if (stripContentView) {
        ...
        private int getActionLayoutResource() {
            if (Notification.IS_SUPPORT_NOTIFICATION_UI) {
                return R.layout.os_notification_material_action;
            }
        ...
        private int getEmphasizedActionLayoutResource() {
            if (Notification.IS_SUPPORT_NOTIFICATION_UI) {
                return R.layout.os_notification_material_action_emphasized;
            }
        ...
        private int getActionTombstoneLayoutResource() {
            if (Notification.IS_SUPPORT_NOTIFICATION_UI) {
                return R.layout.os_notification_material_action_tombstone;
            }
    ...
    public static void buildCustomContentIntoTemplate(Context context, RemoteViews template, RemoteViews customContent, StandardTemplateParams p, TemplateBindResult result) {
        ...
        if (customContent != null) {
            RemoteViews customContent2 = customContent.mo398clone();
            if (p.mHeaderless) {
                ...
                if (totalNumRows2 > maxRows2) {
                    ...
                    while (totalNumRows < this.mTexts.size() && totalNumRows < overflow) {
                        ...
                        if (TextUtils.isEmpty(str)) {
                            if (this.mBuilder.mN.mLargeIcon != null) {
                                contentView.setViewLayoutMarginDimen(R.id.inbox_text0, 5, R.dimen.zzzz_os_notification_inbox_text_margin_end);
                            }
    ...
    public static class CallStyle extends Style {
        ...
        private Action makeAnswerAction() {
            ...
            return makeAction(z ? R.drawable.ic_call_answer_video : R.drawable.ic_call_answer, z ? 17039828 : 17039827, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews makeStandardTemplateWithCustomContent(RemoteViews customContent) {
            ...
            remoteViews.setInt(16908304, "setMaxLines", 1);
            return remoteViews;
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX DEBUG: Method merged with bridge method */
        /* renamed from: clone */
        public WearableExtender m403clone() {
            WearableExtender that = new WearableExtender();
    ...
    public static class BuilderRemoteViews extends RemoteViews {
        ...
        /* renamed from: clone */
        public BuilderRemoteViews mo398clone() {
    ...
    public static class TemplateBindResult {
        ...
        public void setRightIconState(boolean visible, float widthDp, float heightDp, float marginEndDpIfVisible, float expanderSizeDp) {
            ...
            this.mHeadingFullMarginSet.setValues(expanderSizeDp, marginEndDpIfVisible);
            this.mTitleMarginSet.setValues(0.0f, marginEndDpIfVisible);
        }
        ...
        public class MarginSet {
            ...
            public void applyToView(RemoteViews views, int viewId, float extraMarginDp) {
                ...
                } else if (viewId == 16909580 || viewId == 16908822) {
