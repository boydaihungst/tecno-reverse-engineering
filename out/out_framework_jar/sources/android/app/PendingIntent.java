...
public final class PendingIntent implements Parcelable {
        ...
        for (int i = 0; i < size; i++) {
            ...
            ((Executor) pair.first).execute(new Runnable() { // from class: android.app.PendingIntent$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    PendingIntent.this.m418lambda$notifyCancelListeners$0$androidappPendingIntent(pair);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m418lambda$notifyCancelListeners$0$androidappPendingIntent(Pair pair) {
