...
public class StatusBarManager {
    ...
    public static final int CAMERA_LAUNCH_SOURCE_VOLUME_DOUBLE_TAP = 3;
    ...
    public static final class RequestResultCallback extends IAddTileResultCallback.Stub {
        ...
        public /* synthetic */ void m483xcc4523f6(int userResponse) {
        ...
        public void onTileRequest(final int userResponse) {
            this.mExecutor.execute(new Runnable() { // from class: android.app.StatusBarManager$RequestResultCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    StatusBarManager.RequestResultCallback.this.m483xcc4523f6(userResponse);
                }
            });
        }
    }
    ...
    public void showInCallUIStatuBar(String callState, long baseTime) {
        try {
            IStatusBarService svc = getService();
            if (svc != null) {
                this.mService.showInCallUIStatuBar(callState, baseTime);
            }
        } catch (RemoteException ex) {
    ...
    public void hideInCallUIStatuBar() {
        try {
            IStatusBarService svc = getService();
            if (svc != null) {
                this.mService.hideInCallUIStatuBar();
            }
        } catch (RemoteException ex) {
            throw new RuntimeException(ex);
        }
