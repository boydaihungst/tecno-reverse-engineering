...
import com.transsion.hubcore.app.ITranActivity;
...
public class Activity extends ContextThemeWrapper implements LayoutInflater.Factory2, Window.Callback, KeyEvent.Callback, View.OnCreateContextMenuListener, ComponentCallbacks2, Window.OnWindowDismissedCallback, ContentCaptureManager.ContentCaptureClient {
    ...
    public void onResume() {
        ITranActivity.Instance().onResumeHork(this);
    ...
    public final void performTopResumedActivityChanged(boolean isTopResumedActivity, String reason) {
        ...
        if (isTopResumedActivity) {
            ITranActivityThread.Instance().onActivityLifecycleEvent(30064, getComponentName());
            EventLogTags.writeWmOnTopResumedGainedCalled(this.mIdent, getComponentName().getClassName(), reason);
            return;
        }
        ITranActivityThread.Instance().onActivityLifecycleEvent(30065, getComponentName());
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void onPause() {
        ITranActivity.Instance().onPauseHook(this);
    ...
    public void setRequestedOrientation(int requestedOrientation) {
        if (getResources().getConfiguration().windowConfiguration.isThunderbackWindow()) {
            StringWriter sw = new StringWriter();
            PrintWriter pw = new PrintWriter(sw);
            Exception e = new Exception("");
            e.printStackTrace(pw);
            if (sw.toString().contains("SensorManager")) {
                Slog.i(TAG, " Ignore the orieantion request of multiWindow activity.");
                return;
            }
        }
        Activity activity = this.mParent;
    ...
    public final void attach(Context context, ActivityThread aThread, Instrumentation instr, IBinder token, int ident, Application application, Intent intent, ActivityInfo info, CharSequence title, Activity parent, String id, NonConfigurationInstances lastNonConfigurationInstances, Configuration config, String referrer, IVoiceInteractor voiceInteractor, Window window, ViewRootImpl.ActivityConfigCallback activityConfigCallback, IBinder assistToken, IBinder shareableActivityToken) {
        ...
        ITranActivity.Instance().attach(this);
    }
    ...
    public final void performCreate(Bundle icicle, PersistableBundle persistentState) {
        ...
        ITranActivityThread.Instance().onActivityLifecycleEvent(30057, getComponentName());
        ...
        TypedArray ta = obtainStyledAttributes(com.transsion.R.styleable.OSWindow);
        boolean isGravityBottom = ta.getBoolean(0, false);
        if (isGravityBottom) {
    ...
    public final void performStart(String reason) {
        ...
        ITranActivityThread.Instance().onActivityLifecycleEvent(30059, getComponentName());
    ...
    public final void performRestart(boolean start, String reason) {
        ...
        if (this.mStopped) {
            ...
            ITranActivityThread.Instance().onActivityLifecycleEvent(30058, getComponentName());
    ...
    public final void performResume(boolean followedByPause, String reason) {
        ...
        ITranActivityThread.Instance().onActivityLifecycleEvent(30022, getComponentName());
    ...
    public final void performPause() {
        ...
        this.mCalled = false;
        onPause();
        ITranActivityThread.Instance().onActivityLifecycleEvent(30021, getComponentName());
    ...
    public final void performStop(boolean preserveWindow, String reason) {
        ...
        if (!this.mStopped) {
            ...
            ITranActivityThread.Instance().onActivityLifecycleEvent(30049, getComponentName());
    ...
    public final void performDestroy() {
        ...
        onDestroy();
        ITranActivityThread.Instance().onActivityLifecycleEvent(30060, getComponentName());
    ...
    public void dispatchActivityResult(String who, int requestCode, int resultCode, Intent data, String reason) {
        ...
        ITranActivityThread.Instance().onActivityLifecycleEvent(30062, getComponentName());
