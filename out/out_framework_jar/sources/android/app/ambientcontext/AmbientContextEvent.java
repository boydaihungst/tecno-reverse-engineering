...
public final class AmbientContextEvent implements Parcelable {
    ...
    public static final class Builder {
        ...
        public AmbientContextEvent build() {
            ...
            if ((j & 1) == 0) {
                this.mEventType = AmbientContextEvent.m525$$Nest$smdefaultEventType();
            }
            if ((this.mBuilderFieldsSet & 2) == 0) {
                this.mStartTime = AmbientContextEvent.m526$$Nest$smdefaultStartTime();
            }
            if ((this.mBuilderFieldsSet & 4) == 0) {
                this.mEndTime = AmbientContextEvent.m524$$Nest$smdefaultEndTime();
            }
            if ((this.mBuilderFieldsSet & 8) == 0) {
                this.mConfidenceLevel = AmbientContextEvent.m522$$Nest$smdefaultConfidenceLevel();
            }
            if ((this.mBuilderFieldsSet & 16) == 0) {
                this.mDensityLevel = AmbientContextEvent.m523$$Nest$smdefaultDensityLevel();
            }
