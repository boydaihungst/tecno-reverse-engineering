...
public class LayoutTransition {
    ...
    public LayoutTransition() {
        ...
        if (defaultChangeIn == null) {
            ...
            ObjectAnimator mo54clone = defaultChangeIn.mo54clone();
            defaultChangeOut = mo54clone;
            mo54clone.setStartDelay(this.mChangingDisappearingDelay);
            defaultChangeOut.setInterpolator(this.mChangingDisappearingInterpolator);
            ObjectAnimator mo54clone2 = defaultChangeIn.mo54clone();
            defaultChange = mo54clone2;
            mo54clone2.setStartDelay(this.mChangingDelay);
