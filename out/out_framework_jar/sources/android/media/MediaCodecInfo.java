...
public final class MediaCodecInfo {
    ...
    static /* bridge */ /* synthetic */ Range m2122$$Nest$smgetSizeRange() {
        return getSizeRange();
    }
    ...
    public static final class VideoCapabilities {
        ...
        private void initWithPlatformLimits() {
            ...
            this.mWidthRange = MediaCodecInfo.m2122$$Nest$smgetSizeRange();
            this.mHeightRange = MediaCodecInfo.m2122$$Nest$smgetSizeRange();
            this.mFrameRateRange = MediaCodecInfo.FRAME_RATE_RANGE;
            this.mHorizontalBlockRange = MediaCodecInfo.m2122$$Nest$smgetSizeRange();
            this.mVerticalBlockRange = MediaCodecInfo.m2122$$Nest$smgetSizeRange();
            ...
            this.mBlockWidth = 2;
            this.mBlockHeight = 2;
            this.mSmallerDimensionUpperLimit = ((Integer) MediaCodecInfo.m2122$$Nest$smgetSizeRange().getUpper()).intValue();
        }
        ...
        private void parseFromInfo(MediaFormat info) {
            ...
            if (map.containsKey("feature-can-swap-width-height")) {
                if (widths3 != null) {
                    ...
                    if (widths2 != null) {
                        this.mWidthRange = MediaCodecInfo.m2122$$Nest$smgetSizeRange().intersect(widths2);
                    }
                    if (heights3 != null) {
                        this.mHeightRange = MediaCodecInfo.m2122$$Nest$smgetSizeRange().intersect(heights3);
                    }
                    if (counts != null) {
