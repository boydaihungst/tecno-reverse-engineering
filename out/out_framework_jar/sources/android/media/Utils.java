...
public class Utils {
    ...
    public static class ListenerList<V> {
        ...
        public class AnonymousClass1 implements ListenerWithCancellation<V> {
            ...
            public void onEvent(final int eventCode, final V info) {
                ...
                executor.execute(new Runnable() { // from class: android.media.Utils$ListenerList$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        Utils.ListenerList.AnonymousClass1.this.m2310lambda$onEvent$0$androidmediaUtils$ListenerList$1(listener, eventCode, info);
                    }
                });
            }
            ...
            public /* synthetic */ void m2310lambda$onEvent$0$androidmediaUtils$ListenerList$1(Listener listener, int eventCode, Object info) {
