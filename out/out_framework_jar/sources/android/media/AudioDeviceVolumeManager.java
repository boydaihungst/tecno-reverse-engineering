...
public class AudioDeviceVolumeManager {
    ...
    static /* bridge */ /* synthetic */ IAudioService m1969$$Nest$smgetService() {
        return getService();
    }
    ...
    public final class DeviceVolumeDispatcherStub extends IAudioDeviceVolumeDispatcher.Stub {
        ...
        public void register(boolean register, AudioDeviceAttributes device, List<VolumeInfo> volumes, boolean handlesVolumeAdjustment) {
            try {
                AudioDeviceVolumeManager.m1969$$Nest$smgetService().registerDeviceVolumeDispatcherForAbsoluteVolume(register, this, AudioDeviceVolumeManager.this.mPackageName, (AudioDeviceAttributes) Objects.requireNonNull(device), (List) Objects.requireNonNull(volumes), handlesVolumeAdjustment);
    ...
    public void addOnDeviceVolumeBehaviorChangedListener(Executor executor, OnDeviceVolumeBehaviorChangedListener listener) throws SecurityException {
        this.mDeviceVolumeBehaviorChangedListenerMgr.addListener(executor, listener, "addOnDeviceVolumeBehaviorChangedListener", new Supplier() { // from class: android.media.AudioDeviceVolumeManager$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return AudioDeviceVolumeManager.this.m1970xda30fbc2();
            }
        });
    }
    ...
    public /* synthetic */ CallbackUtil.DispatcherStub m1970xda30fbc2() {
    ...
    private final class DeviceVolumeBehaviorDispatcherStub extends IDeviceVolumeBehaviorDispatcher.Stub implements CallbackUtil.DispatcherStub {
        ...
        public void register(boolean register) {
            try {
                AudioDeviceVolumeManager.m1969$$Nest$smgetService().registerDeviceVolumeBehaviorDispatcher(register, this);
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
            }
        }
