...
public class Filter implements AutoCloseable {
            ...
            if (this.mCallback != null && (executor = this.mExecutor) != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.filter.Filter$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        Filter.this.m2676lambda$onFilterStatus$0$androidmediatvtunerfilterFilter(status);
                    }
                });
            }
        }
    ...
    public /* synthetic */ void m2676lambda$onFilterStatus$0$androidmediatvtunerfilterFilter(int status) {
        synchronized (this.mCallbackLock) {
        ...
        synchronized (this.mCallbackLock) {
            if (this.mCallback == null || (executor = this.mExecutor) == null) {
                ...
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.filter.Filter$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        Filter.this.m2675lambda$onFilterEvent$1$androidmediatvtunerfilterFilter(events);
                    }
                });
            }
        }
    ...
    public /* synthetic */ void m2675lambda$onFilterEvent$1$androidmediatvtunerfilterFilter(FilterEvent[] events) {
        synchronized (this.mCallbackLock) {
            FilterCallback filterCallback = this.mCallback;
            if (filterCallback != null) {
