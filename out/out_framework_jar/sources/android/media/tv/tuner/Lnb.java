...
public class Lnb implements AutoCloseable {
                ...
                if (callback != null && executor != null) {
                    executor.execute(new Runnable() { // from class: android.media.tv.tuner.Lnb$$ExternalSyntheticLambda1
                        ...
                        public final void run() {
                            Lnb.this.m2643lambda$onEvent$0$androidmediatvtunerLnb(callback, eventType);
                        }
                    });
                }
            }
    ...
    public /* synthetic */ void m2643lambda$onEvent$0$androidmediatvtunerLnb(LnbCallback callback, int eventType) {
        synchronized (this.mCallbackLock) {
            if (callback != null) {
            ...
            for (final LnbCallback callback : this.mCallbackMap.keySet()) {
                ...
                if (callback != null && executor != null) {
                    executor.execute(new Runnable() { // from class: android.media.tv.tuner.Lnb$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            Lnb.this.m2642lambda$onDiseqcMessage$1$androidmediatvtunerLnb(callback, diseqcMessage);
                        }
                    });
                }
            }
    ...
    public /* synthetic */ void m2642lambda$onDiseqcMessage$1$androidmediatvtunerLnb(LnbCallback callback, byte[] diseqcMessage) {
        synchronized (this.mCallbackLock) {
            if (callback != null) {
