...
public interface ILocationManager extends IInterface {
    ...
    List<String> getCurrentActive() throws RemoteException;
    ...
    public static class Default implements ILocationManager {
        ...
        @Override // android.location.ILocationManager
        public List<String> getCurrentActive() throws RemoteException {
            return null;
        }
    ...
    public static abstract class Stub extends Binder implements ILocationManager {
        ...
        static final int TRANSACTION_getCurrentActive = 62;
                ...
                default:
                    switch (code) {
                        ...
                        case 61:
                            ...
                            return true;
                        case 62:
                            List<String> _result25 = getCurrentActive();
                            reply.writeNoException();
