...
public final class Magnifier {
        ...
        if (sourceCenterX != this.mPrevShowSourceCoords.x || sourceCenterY != this.mPrevShowSourceCoords.y || this.mDirtyState) {
            ...
            sPixelCopyHandlerThread.getThreadHandler().post(new Runnable() { // from class: android.widget.Magnifier$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    Magnifier.this.m5758lambda$show$0$androidwidgetMagnifier(currentWindowInstance, windowCoords);
                }
            });
            magnifierCenterX3 = magnifierCenterX2;
            magnifierCenterY3 = magnifierCenterY2;
    ...
    public /* synthetic */ void m5758lambda$show$0$androidwidgetMagnifier(InternalPopupWindow currentWindowInstance, Point windowCoords) {
        synchronized (this.mLock) {
    ...
    private void performPixelCopy(int startXInSurface, int startYInSurface, final boolean updateWindowPosition) {
        ...
        PixelCopy.request(this.mContentCopySurface.mSurface, this.mPixelCopyRequestRect, bitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: android.widget.Magnifier$$ExternalSyntheticLambda1
            ...
            public final void onPixelCopyFinished(int i) {
                Magnifier.this.m5757lambda$performPixelCopy$1$androidwidgetMagnifier(currentWindowInstance, updateWindowPosition, windowCoords, bitmap, i);
            }
    ...
    public /* synthetic */ void m5757lambda$performPixelCopy$1$androidwidgetMagnifier(InternalPopupWindow currentWindowInstance, boolean updateWindowPosition, Point windowCoords, Bitmap bitmap, int result) {
        if (result != 0) {
            onPixelCopyFailed();
            return;
        }
    ...
    private void onPixelCopyFailed() {
        ...
        Handler.getMain().postAtFrontOfQueue(new Runnable() { // from class: android.widget.Magnifier$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Magnifier.this.m5756lambda$onPixelCopyFailed$2$androidwidgetMagnifier();
            }
        });
    }
    ...
    public /* synthetic */ void m5756lambda$onPixelCopyFailed$2$androidwidgetMagnifier() {
        dismiss();
    ...
    public static class InternalPopupWindow {
        ...
        */
                ...
                try {
                    ...
                    HardwareRenderer.FrameDrawingCallback callback2 = new HardwareRenderer.FrameDrawingCallback() { // from class: android.widget.Magnifier$InternalPopupWindow$$ExternalSyntheticLambda0
                        ...
                        public final void onFrameDraw(long j) {
                            Magnifier.InternalPopupWindow.this.m5797lambda$doDraw$0$androidwidgetMagnifier$InternalPopupWindow(updateWindowPosition, pendingX, pendingY, firstDraw, j);
                        }
                    };
                    if (!this.mIsFishEyeStyle) {
        ...
        public /* synthetic */ void m5797lambda$doDraw$0$androidwidgetMagnifier$InternalPopupWindow(boolean updateWindowPosition, int pendingX, int pendingY, boolean firstDraw, long frame) {
            if (!this.mSurface.isValid()) {
                return;
            }
            if (updateWindowPosition) {
