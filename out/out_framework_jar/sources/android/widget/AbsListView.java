...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher, ViewTreeObserver.OnGlobalLayoutListener, Filter.FilterListener, ViewTreeObserver.OnTouchModeChangeListener, RemoteViewsAdapter.RemoteAdapterConnectionCallback {
    ...
    private boolean mTranBounceEffectSupport;
    ...
    public AbsListView(Context context) {
        ...
        this.mTranBounceEffectSupport = false;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        SparseBooleanArray sparseBooleanArray = this.mCheckStates;
        if (sparseBooleanArray != null) {
            ss.checkState = sparseBooleanArray.m4678clone();
        }
    ...
    public void reportScrollStateChange(int newState) {
        if (newState != this.mLastScrollState) {
            ITranAbsListView.Instance().reportScrollStateChange(newState);
            OnScrollListener onScrollListener = this.mOnScrollListener;
            if (onScrollListener != null) {
    ...
    public class FlingRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (crossUp) {
                if (AbsListView.this.mTranBounceEffectSupport) {
                    edgeReachedBouceEffect(delta);
                    return;
                }
                if (motionView != null) {
        ...
        private void edgeReachedBouceEffect(int delta) {
            int overscrollMode = AbsListView.this.getOverScrollMode();
            if (overscrollMode == 0 || (overscrollMode == 1 && !AbsListView.this.contentFits())) {
                int vel = (int) this.mScroller.getCurrVelocity();
                if (delta > 0) {
            ...
            } else if (AbsListView.this.mPositionScroller != null) {
                AbsListView.this.mPositionScroller.stop();
            }
            AbsListView.this.invalidate();
            endFling();
    ...
    */
    ...
    public void enableTranBounceEffect() {
        this.mTranBounceEffectSupport = true;
        this.mEdgeGlowTop = new BounceEdgeEffect(this, 1);
        this.mEdgeGlowBottom = new BounceEdgeEffect(this, 3);
    ...
    public void cancelTranBounceAnimation() {
        ...
        if (edgeEffect instanceof BounceEdgeEffect) {
            ((BounceEdgeEffect) edgeEffect).cancelBounceAnimation();
        }
        EdgeEffect edgeEffect2 = this.mEdgeGlowBottom;
        if (edgeEffect2 instanceof BounceEdgeEffect) {
            ((BounceEdgeEffect) edgeEffect2).cancelBounceAnimation();
        }
    }
}
