...
public class Editor {
    ...
    public Editor(TextView textView) {
        ...
        this.mBackCallback = new OnBackInvokedCallback() { // from class: android.widget.Editor$$ExternalSyntheticLambda2
            ...
            public final void onBackInvoked() {
                Editor.this.m5697lambda$startActionModeInternal$0$androidwidgetEditor();
            }
        };
    ...
    public void prepareCursorControllers() {
        ...
        if (!this.mSelectionControllerEnabled) {
            m5697lambda$startActionModeInternal$0$androidwidgetEditor();
            SelectionModifierCursorController selectionModifierCursorController = this.mSelectionModifierCursorController;
            if (selectionModifierCursorController != null) {
                selectionModifierCursorController.onDetached();
    ...
    public void startDragAndDrop() {
        ...
        if (!IWidgetLice.Instance().startDragAndDrop(this.mTextView, data, localState, selectedText.toString())) {
    ...
    public void m5697lambda$startActionModeInternal$0$androidwidgetEditor() {
        ActionMode actionMode = this.mTextActionMode;
        if (actionMode != null) {
            actionMode.finish();
        }
    ...
    public final class SuggestionsPopupWindow extends PinnedPopupWindow implements AdapterView.OnItemClickListener {
        ...
        private boolean updateSuggestions() {
            ...
            try {
                ...
                Log.w("Editor", "Editor # updateSuggestions() Catch Exception e = " + e);
            }
    ...
    public class TextActionModeCallback extends ActionMode.Callback2 {
        ...
        private void populateMenuWithItems(Menu menu) {
            ...
            ITranInternalView.Instance().onPopulateMenuWithItems(menu, Editor.this.mTextView.getContext(), Editor.this.getTextState());
        ...
        private MenuItem addAssistMenuItem(Menu menu, RemoteAction action, int itemId, int order, int showAsAction) {
            ...
            ITranInternalView.Instance().onAddAssistMenuItem(item, Editor.this.getSelectionActionModeHelper().getTextClassification().getEntity(0), (String) TextUtils.trimToParcelableSize(Editor.this.mTextView.getSelectedText()), Editor.this.mTextView.getContext(), this.mAssistClickHandlers);
            return item;
        }
    ...
    public static class MagnifierMotionAnimator {
        ...
        private MagnifierMotionAnimator(Magnifier magnifier) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.widget.Editor$MagnifierMotionAnimator$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    Editor.MagnifierMotionAnimator.this.m5715lambda$new$0$androidwidgetEditor$MagnifierMotionAnimator(valueAnimator);
                }
            });
        }
        ...
        public /* synthetic */ void m5715lambda$new$0$androidwidgetEditor$MagnifierMotionAnimator(ValueAnimator animation) {
    ...
    public abstract class HandleView extends View implements TextViewPositionListener {
        ...
        public void show() {
            ...
            IMessageBankLice.Instance().onTextSelectedChanged(Editor.this.mTextView, "select handle view show");
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:70:0x01f7 A[ADDED_TO_REGION, ORIG_RETURN, RETURN] */
        /*
    ...
    public int getTextState() {
        ...
        if (!this.mTextView.hasSelection() && !this.mTextView.hasPasswordTransformationMethod() && this.mTextView.canSelectText()) {
            flags |= 1 << 1;
        }
        if (this.mTextView.supportCommonPhrase()) {
            if (this.mTextView.needCreatePhrase()) {
                return flags | (1 << 2);
            }
            return flags | (1 << 3);
        }
