...
public class HorizontalScrollView extends FrameLayout {
        ...
        if (this.mScroller.computeScrollOffset()) {
            ...
            if (oldX != x || oldY != y) {
                ...
                if (canOverscroll) {
                    ...
                    if (this.mTranBounceEffectSupport && ((x < 0 && oldX >= 0) || (x > range && oldX <= range))) {
                        this.mScroller.abortAnimation();
                    }
                }
            }
    ...
    public void enableTranBounceEffect() {
        ...
        this.mEdgeGlowLeft = new BounceEdgeEffect(this, 0);
        this.mEdgeGlowRight = new BounceEdgeEffect(this, 2);
