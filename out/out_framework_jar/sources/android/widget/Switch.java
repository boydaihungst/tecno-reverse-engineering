...
public class Switch extends CompoundButton {
    ...
    private static final float OS_FOLEABLE_BOUNCE_DAMPINGRATIO = 0.625f;
    private static final float OS_FOLEABLE_BOUNCE_STIFFNESS = 400.0f;
    private static boolean OS_FOLEABLE_SCREEN_SUPPORT = false;
    private static final int SANS = 1;
    private static final int SERIF = 2;
    private static final int THUMB_ANIMATION_DURATION = 250;
    private static final int THUMB_FOLD_ANIMATION_DURATION = 600;
    ...
    static {
        ...
        THUMB_POS = new FloatProperty<Switch>("thumbPos") { // from class: android.widget.Switch.1
    ...
    public void m6087lambda$setTrackResourceAsync$0$androidwidgetSwitch(Drawable track) {
    ...
    public void setTrackResource(int resId) {
        m6087lambda$setTrackResourceAsync$0$androidwidgetSwitch(getContext().getDrawable(resId));
    }
    ...
    public Runnable setTrackResourceAsync(int resId) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda2
            ...
            public final void run() {
                Switch.this.m6087lambda$setTrackResourceAsync$0$androidwidgetSwitch(drawable);
            }
        };
    }
    ...
    public void setTrackIcon(Icon icon) {
        m6087lambda$setTrackResourceAsync$0$androidwidgetSwitch(icon == null ? null : icon.loadDrawable(getContext()));
    }
    ...
    public Runnable setTrackIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                Switch.this.m6086lambda$setTrackIconAsync$1$androidwidgetSwitch(track);
            }
        };
    }
    ...
    public void m6085lambda$setThumbResourceAsync$2$androidwidgetSwitch(Drawable thumb) {
    ...
    public void setThumbResource(int resId) {
        m6085lambda$setThumbResourceAsync$2$androidwidgetSwitch(getContext().getDrawable(resId));
    }
    ...
    public Runnable setThumbResourceAsync(int resId) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                Switch.this.m6085lambda$setThumbResourceAsync$2$androidwidgetSwitch(drawable);
            }
        };
    }
    ...
    public void setThumbIcon(Icon icon) {
        m6085lambda$setThumbResourceAsync$2$androidwidgetSwitch(icon == null ? null : icon.loadDrawable(getContext()));
    }
    ...
    public Runnable setThumbIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Switch.this.m6084lambda$setThumbIconAsync$3$androidwidgetSwitch(track);
            }
        };
    }
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        ...
        if (OS_FOLEABLE_SCREEN_SUPPORT) {
            ofFloat.setInterpolator(new OSSpringInterpolator(400.0f, OS_FOLEABLE_BOUNCE_DAMPINGRATIO));
            this.mPositionAnimator.setDuration(600L);
        } else {
    ...
    /* loaded from: classes4.dex */
    public class OSSpringInterpolator implements Interpolator {
        float dampingRatio;
        float stiffness;

        public OSSpringInterpolator(float stiffness, float dampingRatio) {
        ...
        public float getInterpolation(float x) {
            double w_0 = Math.sqrt(this.stiffness);
            float f = this.dampingRatio;
            double w_d = Math.sqrt(1.0f - (f * f)) * w_0;
            float f2 = this.dampingRatio;
            double lamd = f2 * w_0;
            if (f2 < 1.0f) {
                return (float) (1.0d - (Math.exp((-lamd) * x) * ((Math.cos(x * w_d) * 1.0d) + ((lamd / w_d) * Math.sin(x * w_d)))));
            }
            return (float) (1.0d - (Math.exp((-w_0) * x) * ((x * w_0) + 1.0d)));
        }
    }
