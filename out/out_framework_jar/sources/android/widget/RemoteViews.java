...
public class RemoteViews implements Parcelable, LayoutInflater.Filter {
    ...
    public class SetPendingIntentTemplate extends Action {
            ...
            if (target instanceof AdapterView) {
                ...
                AdapterView.OnItemClickListener listener = new AdapterView.OnItemClickListener() { // from class: android.widget.RemoteViews$SetPendingIntentTemplate$$ExternalSyntheticLambda0
                    ...
                    public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                        RemoteViews.SetPendingIntentTemplate.this.m5969xa91820b(handler, adapterView, view, i, j);
                    }
                };
        ...
        public /* synthetic */ void m5969xa91820b(InteractionHandler handler, AdapterView parent, View view, int position, long id) {
    ...
    public class SetRemoteViewsAdapterIntent extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            if (!(rootParent instanceof AppWidgetHostView)) {
                Log.e(RemoteViews.LOG_TAG, "setRemoteAdapter can only be used for AppWidgets (root id: " + this.viewId + NavigationBarInflaterView.KEY_CODE_END);
            } else if (!(target instanceof AbsListView) && !(target instanceof AdapterViewAnimator) && !(target instanceof SlideAdapterView)) {
                Log.e(RemoteViews.LOG_TAG, "Cannot setRemoteAdapter on a view which is not an AbsListView or AdapterViewAnimator or SlideAdapterView (id: " + this.viewId + NavigationBarInflaterView.KEY_CODE_END);
            } else {
                ...
                } else if (target instanceof SlideAdapterView) {
                    SlideAdapterView v3 = (SlideAdapterView) target;
                    v3.setRemoteViewsAdapter(this.intent, this.isAsync);
                    v3.setRemoteViewsOnClickHandler(handler);
                }
            }
        }
    ...
    public class SetOnClickResponse extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, final InteractionHandler handler, ColorResources colorResources) {
            ...
            target.setOnClickListener(new View.OnClickListener() { // from class: android.widget.RemoteViews$SetOnClickResponse$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    RemoteViews.SetOnClickResponse.this.m5968lambda$apply$0$androidwidgetRemoteViews$SetOnClickResponse(handler, view);
                }
            });
        }
        ...
        public /* synthetic */ void m5968lambda$apply$0$androidwidgetRemoteViews$SetOnClickResponse(InteractionHandler handler, View v) {
    ...
    public class SetOnCheckedChangeResponse extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, final InteractionHandler handler, ColorResources colorResources) {
            ...
            CompoundButton.OnCheckedChangeListener onCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: android.widget.RemoteViews$SetOnCheckedChangeResponse$$ExternalSyntheticLambda0
                ...
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    RemoteViews.SetOnCheckedChangeResponse.this.m5967x2f2d0d7(handler, compoundButton, z);
                }
            };
        ...
        public /* synthetic */ void m5967x2f2d0d7(InteractionHandler handler, CompoundButton v, boolean isChecked) {
            this.mResponse.handleViewInteraction(v, handler);
        }
    ...
    private abstract class BaseReflectionAction extends Action {
        ...
        @Override // android.widget.RemoteViews.Action
        public final void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            View view = root.findViewById(this.viewId);
            if (view == null) {
                return;
            }
        ...
        @Override // android.widget.RemoteViews.Action
        public final Action initActionAsync(ViewTree root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            View view = root.findViewById(this.viewId);
            if (view == null) {
    ...
    public final class AttributeReflectionAction extends BaseReflectionAction {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [2189=7] */
        @Override // android.widget.RemoteViews.BaseReflectionAction
        protected Object getParameterValue(View view) throws ActionException {
    ...
    public class ViewGroupActionAdd extends Action {
            ...
            if (nextChild < 0 || this.mStableId == -1) {
                ...
                final int recycledViewIndex = target.findChildIndex(nextChild, new Predicate() { // from class: android.widget.RemoteViews$ViewGroupActionAdd$$ExternalSyntheticLambda0
                    ...
                    public final boolean test(Object obj) {
                        return RemoteViews.ViewGroupActionAdd.this.m5970xe3b44cf9((View) obj);
                    }
                });
        ...
        public /* synthetic */ boolean m5970xe3b44cf9(View view) {
    ...
    public class ViewGroupActionRemove extends Action {
        ...
        public Action initActionAsync(ViewTree root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            if (this.mViewIdToKeep == -2) {
                ...
                target.mChildren.removeIf(new Predicate() { // from class: android.widget.RemoteViews$ViewGroupActionRemove$$ExternalSyntheticLambda1
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        return RemoteViews.ViewGroupActionRemove.this.m5973x41894b4b((RemoteViews.ViewTree) obj);
                    }
                });
        ...
        public /* synthetic */ boolean m5973x41894b4b(ViewTree childTree) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public View applyNestedViews(Context context, ViewGroup directParent, ViewGroup rootParent, InteractionHandler handler, SizeF size, ColorResources colorResources) {
        RemoteViews rvToApply = getRemoteViewsToApply(context, size);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void reapplyNestedViews(Context context, View v, ViewGroup rootParent, InteractionHandler handler, SizeF size, ColorResources colorResources) {
        RemoteViews rvToApply = getRemoteViewsToReapply(context, v, size);
    ...
    public static class RemoteResponse {
        ...
        private static AdapterView<?> getAdapterViewAncestor(View view) {
            ...
            while (parent != null && !(parent instanceof AdapterView) && (!(parent instanceof AppWidgetHostView) || (parent instanceof RemoteViewsAdapter.RemoteViewsFrameLayout) || (parent instanceof SlideViewAdapter.RemoteViewsFrameLayout))) {
    ...
    public static boolean startPendingIntent(View view, PendingIntent pendingIntent, Pair<Intent, ActivityOptions> options) {
        try {
            Context context = view.getContext();
            ITranView.Instance().setStartInMultiWindow(view.getId(), pendingIntent.getCreatorPackage());
            context.startIntentSender(pendingIntent.getIntentSender(), options.first, 0, 0, 0, options.second.toBundle());
            ITranView.Instance().collapsePanels(view.getId());
            return true;
