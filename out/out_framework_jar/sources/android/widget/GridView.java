...
public class GridView extends AbsListView {
    ...
    private View makeRow(int startPos, int y, boolean flow) {
        ...
        if (this.mAdapter instanceof BaseAdapter) {
            ((BaseAdapter) this.mAdapter).setCanLoadIconTask(true);
        }
        int pos = startPos2;
        View selectedView = null;
        ...
        View child = null;
        while (pos < last) {
            boolean selected = pos == selectedPosition ? z : false;
        ...
        View child2 = child;
        if (this.mAdapter instanceof BaseAdapter) {
            ((BaseAdapter) this.mAdapter).setCanLoadIconTask(false);
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [1434=5, 1435=4] */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:172:0x02b8 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:179:0x00d5 */
    /* JADX INFO: Access modifiers changed from: protected */
