...
public class AutoCompleteTextView extends EditText implements Filter.FilterListener {
    ...
    public /* synthetic */ void m5557lambda$new$0$androidwidgetAutoCompleteTextView() {
        if (isPopupShowing()) {
            dismissDropDown();
        }
    }
    ...
    public AutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, Resources.Theme popupTheme) {
        ...
        this.mBackCallback = new OnBackInvokedCallback() { // from class: android.widget.AutoCompleteTextView$$ExternalSyntheticLambda0
            ...
            public final void onBackInvoked() {
                AutoCompleteTextView.this.m5557lambda$new$0$androidwidgetAutoCompleteTextView();
            }
        };
        ...
        listPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: android.widget.AutoCompleteTextView$$ExternalSyntheticLambda1
            ...
            public final void onDismiss() {
                AutoCompleteTextView.this.m5558lambda$new$1$androidwidgetAutoCompleteTextView();
            }
        });
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: T extends android.widget.ListAdapter & android.widget.Filterable */
    ...
    @Override // android.widget.EditText, android.view.View
    ...
    public void m5558lambda$new$1$androidwidgetAutoCompleteTextView() {
