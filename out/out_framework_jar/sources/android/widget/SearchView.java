...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context) {
            ...
            this.mRunShowSoftInputIfNecessary = new Runnable() { // from class: android.widget.SearchView$SearchAutoComplete$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    SearchView.SearchAutoComplete.this.m6011lambda$new$0$androidwidgetSearchView$SearchAutoComplete();
                }
            };
        ...
        public void m6011lambda$new$0$androidwidgetSearchView$SearchAutoComplete() {
            if (this.mHasPendingShowSoftInputRequest) {
