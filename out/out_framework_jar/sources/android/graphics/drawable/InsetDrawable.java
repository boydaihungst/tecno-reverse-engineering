...
public class InsetDrawable extends DrawableWrapper {
    ...
    public static final class InsetState extends DrawableWrapper.DrawableWrapperState {
        ...
        InsetState(InsetState orig, Resources res) {
            super(orig, res);
            if (orig != null) {
                this.mInsetLeft = orig.mInsetLeft.m1082clone();
                this.mInsetTop = orig.mInsetTop.m1082clone();
                this.mInsetRight = orig.mInsetRight.m1082clone();
                this.mInsetBottom = orig.mInsetBottom.m1082clone();
