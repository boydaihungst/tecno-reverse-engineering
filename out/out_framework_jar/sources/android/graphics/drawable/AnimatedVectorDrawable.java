...
public class AnimatedVectorDrawable extends Drawable implements Animatable2 {
    ...
    static /* bridge */ /* synthetic */ long m1051$$Nest$smnCreateAnimatorSet() {
        return nCreateAnimatorSet();
    }

    /* renamed from: -$$Nest$smshouldIgnoreInvalidAnimation  reason: not valid java name */
    static /* bridge */ /* synthetic */ boolean m1064$$Nest$smshouldIgnoreInvalidAnimation() {
    ...
    public static class AnimatedVectorDrawableState extends Drawable.ConstantState {
        ...
        private final boolean mShouldIgnoreInvalidAnim = AnimatedVectorDrawable.m1064$$Nest$smshouldIgnoreInvalidAnimation();
    ...
    public static class VectorDrawableAnimatorUI implements VectorDrawableAnimator {
        ...
        public void init(AnimatorSet set) {
            ...
            AnimatorSet mo54clone = set.mo54clone();
            this.mSet = mo54clone;
            long totalDuration = mo54clone.getTotalDuration();
    ...
    public static class VectorDrawableAnimatorRT implements VectorDrawableAnimator, NativeVectorDrawableAnimator {
        ...
        VectorDrawableAnimatorRT(AnimatedVectorDrawable drawable) {
            this.mSetPtr = 0L;
            this.mDrawable = drawable;
            long m1051$$Nest$smnCreateAnimatorSet = AnimatedVectorDrawable.m1051$$Nest$smnCreateAnimatorSet();
            this.mSetPtr = m1051$$Nest$smnCreateAnimatorSet;
            this.mSetRefBasePtr = new VirtualRefBasePtr(m1051$$Nest$smnCreateAnimatorSet);
        }
