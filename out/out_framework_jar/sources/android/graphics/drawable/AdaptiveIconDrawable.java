                    ...
                    if (type2 == 2 && depth <= innerDepth) {
                        ...
                        switch (c) {
                            ...
                            case 1:
                                childIndex = 1;
                                layer = new ChildDrawable(state.mDensity);
                                TypedArray a2 = obtainAttributes(r, theme, attrs, R.styleable.AdaptiveIconDrawableLayer);
                            ...
                            case 2:
                                childIndex = 2;
                                layer = new ChildDrawable(state.mDensity);
                                TypedArray a22 = obtainAttributes(r, theme, attrs, R.styleable.AdaptiveIconDrawableLayer);
