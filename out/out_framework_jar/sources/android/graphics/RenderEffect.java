...
public final class RenderEffect {
    ...
    static /* bridge */ /* synthetic */ long m1024$$Nest$smnativeGetFinalizer() {
    ...
    private static class RenderEffectHolder {
        public static final NativeAllocationRegistry RENDER_EFFECT_REGISTRY = NativeAllocationRegistry.createMalloced(RenderEffect.class.getClassLoader(), RenderEffect.m1024$$Nest$smnativeGetFinalizer());
