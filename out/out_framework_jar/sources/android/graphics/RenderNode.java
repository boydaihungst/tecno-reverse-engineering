...
public final class RenderNode {
    ...
    static /* bridge */ /* synthetic */ long m1025$$Nest$smnGetNativeFinalizer() {
    ...
    @CriticalNative
    private static native boolean nEnableBackdropBlurFilter(long j, boolean z, float f, int i);
    ...
    private static class NoImagePreloadHolder {
        public static final NativeAllocationRegistry sRegistry = NativeAllocationRegistry.createMalloced(RenderNode.class.getClassLoader(), RenderNode.m1025$$Nest$smnGetNativeFinalizer());
    ...
    public boolean enableBackdropBlurFilter(boolean enable, float radius, int flags) {
        return nEnableBackdropBlurFilter(this.mNativeRenderNode, enable, radius, flags);
    }
