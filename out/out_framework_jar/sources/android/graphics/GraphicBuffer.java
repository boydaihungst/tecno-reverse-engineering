...
public class GraphicBuffer implements Parcelable {
    ...
    private static native long nCreateGraphicBufferFromHandle(long j, int i, int i2, int i3, int i4);
    ...
    private static native long nLockWithFlag(long j, int i);

    /* JADX INFO: Access modifiers changed from: private */
    public static native long nReadGraphicBufferFromParcel(Parcel parcel);

    private static native void nUnlock(long j);
    ...
    public static GraphicBuffer createFromHandle(long nativeHandle, int width, int height, int format, int stride, int usage) {
        long nativeObject = nCreateGraphicBufferFromHandle(nativeHandle, width, height, format, stride);
        if (nativeObject != 0) {
            return new GraphicBuffer(width, height, format, usage, nativeObject);
        }
        return null;
    ...
    public long lock(int flag) {
        return nLockWithFlag(this.mNativeObject, flag);
    }

    public void unlock() {
        nUnlock(this.mNativeObject);
    }
}
