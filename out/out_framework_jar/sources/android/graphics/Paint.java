...
public class Paint {
    ...
    static /* bridge */ /* synthetic */ long m1022$$Nest$smnGetNativeFinalizer() {
    ...
    private static class NoImagePreloadHolder {
        public static final NativeAllocationRegistry sRegistry = NativeAllocationRegistry.createMalloced(Paint.class.getClassLoader(), Paint.m1022$$Nest$smnGetNativeFinalizer());
    ...
    public void set(Paint src) {
        if (this != src) {
            Paint src2 = ITranGraphic.Instance().onPaintSet(this, src);
            nSet(this.mNativePaint, src2.mNativePaint);
            setClassVariablesFrom(src2);
        }
    }
    ...
    public synchronized long getNativeInstance() {
        ...
        ITranGraphic.Instance().onGetNativeInstance(this, this.mNativePaint);
    ...
    public Typeface setTypeface(Typeface typeface) {
        ...
        ITranGraphic.Instance().onSetTypeface(this, typefaceNative);
    ...
    public float ascent() {
        ITranGraphic.Instance().onPaintAscent(this);
    ...
    public float getFontMetrics(FontMetrics metrics) {
        ITranGraphic.Instance().onGetFontMetrics(this, metrics);
    ...
    public int getFontMetricsInt(FontMetricsInt fmi) {
        ITranGraphic.Instance().onGetFontMetricsInt(this, fmi);
    ...
    public float measureText(char[] text, int index, int count) {
        ...
        ITranGraphic.Instance().onPaintMeasureText(this);
    ...
    public float getRunAdvance(char[] text, int start, int end, int contextStart, int contextEnd, boolean isRtl, int offset) {
        ...
        ITranGraphic.Instance().onGetRunAdvance(this);
