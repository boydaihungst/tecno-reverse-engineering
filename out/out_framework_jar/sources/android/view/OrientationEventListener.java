...
import com.transsion.hubcore.server.view.ITranOrientationEventListener;
...
public abstract class OrientationEventListener {
    ...
    class SensorEventListenerImpl implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (ITranOrientationEventListener.Instance().isThunderbackWindow(OrientationEventListener.this.mContext)) {
                orientation = 0;
            }
