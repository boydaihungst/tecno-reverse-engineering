...
public class TextureView extends View {
    ...
    public TextureView(Context context) {
        ...
        this.mUpdateListener = new SurfaceTexture.OnFrameAvailableListener() { // from class: android.view.TextureView$$ExternalSyntheticLambda0
            ...
            public final void onFrameAvailable(SurfaceTexture surfaceTexture) {
                TextureView.this.m4990lambda$new$0$androidviewTextureView(surfaceTexture);
            }
        };
    }
        ...
        if (canvas.isHardwareAccelerated()) {
            ...
            if (layer != null) {
                ...
                if (this.mIsVariableRefreshRateEnabled && !this.mEventScenario.getIsMarked()) {
                    BoostFwkFactory.getInstance().makeBoostFwkManager().perfHint(this.mEventScenario.setScenarioAction(0));
    ...
    public /* synthetic */ void m4990lambda$new$0$androidviewTextureView(SurfaceTexture surfaceTexture) {
        updateLayer();
        invalidate();
    }
}
