...
public final class AutofillManager {
    ...
    public void onVisibleForAutofill() {
        Choreographer.getInstance().postCallback(4, new Runnable() { // from class: android.view.autofill.AutofillManager$$ExternalSyntheticLambda2
            ...
            public final void run() {
                AutofillManager.this.m5243x84fb5ad9();
            }
        }, null);
    }
    ...
    public /* synthetic */ void m5243x84fb5ad9() {
    ...
    /* JADX WARN: Removed duplicated region for block: B:64:0x01d3 A[Catch: TimeoutException -> 0x020e, RemoteException -> 0x0212, TryCatch #4 {RemoteException -> 0x0212, TimeoutException -> 0x020e, blocks: (B:58:0x018c, B:62:0x01a8, B:64:0x01d3, B:65:0x01d5, B:67:0x01e0, B:69:0x01e4, B:71:0x0205, B:73:0x020a), top: B:85:0x018c }] */
    /* JADX WARN: Removed duplicated region for block: B:67:0x01e0 A[Catch: TimeoutException -> 0x020e, RemoteException -> 0x0212, TryCatch #4 {RemoteException -> 0x0212, TimeoutException -> 0x020e, blocks: (B:58:0x018c, B:62:0x01a8, B:64:0x01d3, B:65:0x01d5, B:67:0x01e0, B:69:0x01e4, B:71:0x0205, B:73:0x020a), top: B:85:0x018c }] */
    ...
    */
    private void startSessionLocked(AutofillId id, Rect bounds, AutofillValue value, int flags) {
        ...
        if ((set == null || !set.contains(id)) && !this.mEnabledForAugmentedAutofillOnly) {
            ...
            if (Helper.sVerbose) {
                Log.v("AutofillManager", "Starting session for augmented autofill on " + id);
            }
            flags2 = flags | 8;
        }
        if (Helper.sVerbose) {
            Log.v("AutofillManager", "startSessionLocked(): id=" + id + ", bounds=" + bounds + ", value=" + value + ", flags=" + flags2 + ", state=" + getStateAsStringLocked() + ", compatMode=" + isCompatibilityModeEnabledLocked() + ", augmentedOnly=" + this.mForAugmentedAutofillOnly + ", enabledAugmentedOnly=" + this.mEnabledForAugmentedAutofillOnly + ", enteredIds=" + this.mEnteredIds);
        }
        ...
        if (this.mState != 0 && !isFinishedLocked() && (flags2 & 1) == 0) {
            if (Helper.sVerbose) {
                Log.v("AutofillManager", "not automatically starting session for " + id + " on state " + getStateAsStringLocked() + " and flags " + flags2);
                return;
            }
            return;
        }
            ...
            try {
                if (!this.mEnabledForAugmentedAutofillOnly && (autofillOptions = this.mOptions) != null && autofillOptions.isAutofillDisabledLocked(clientActivity)) {
                    if (this.mOptions.isAugmentedAutofillEnabled(this.mContext)) {
                        if (Helper.sDebug) {
                            Log.d("AutofillManager", "startSession(" + clientActivity + "): disabled by service but allowlisted for augmented autofill");
                            flags3 = flags2 | 8;
                            ...
                            if ((extraFlags & 1) != 0) {
                                if (Helper.sDebug) {
                                    Log.d("AutofillManager", "startSession(" + clientActivity + "): for augmented only");
                                }
                        ...
                        if (Helper.sDebug) {
                            Log.d("AutofillManager", "startSession(" + clientActivity + "): ignored because disabled by service and not allowlisted for augmented autofill");
                        }
                ...
                e = e2;
                flags2 = flags3;
                Log.w("AutofillManager", "Exception getting result from SyncResultReceiver: " + e);
                return;
            }
            flags3 = flags2;
    ...
    public boolean showAutofillDialog(View view) {
        ...
        if (shouldShowAutofillDialog(view, view.getAutofillId())) {
            ...
            post(new Runnable() { // from class: android.view.autofill.AutofillManager$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    AutofillManager.this.m5244xcfaa10cb(wrView);
                }
            });
            return true;
        }
    ...
    public /* synthetic */ void m5244xcfaa10cb(WeakReference wrView) {
    ...
    public boolean showAutofillDialog(View view, final int virtualId) {
        ...
        if (shouldShowAutofillDialog(view, getAutofillId(view, virtualId))) {
            ...
            post(new Runnable() { // from class: android.view.autofill.AutofillManager$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    AutofillManager.this.m5245x98ab080c(wrView, virtualId);
                }
            });
            return true;
        }
    ...
    public /* synthetic */ void m5245x98ab080c(WeakReference wrView, int virtualId) {
        View v = (View) wrView.get();
        if (v != null) {
