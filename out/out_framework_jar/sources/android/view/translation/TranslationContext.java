...
public final class TranslationContext implements Parcelable {
    ...
    static /* bridge */ /* synthetic */ ActivityId m5441$$Nest$smdefaultActivityId() {
        return defaultActivityId();
    }

    /* renamed from: -$$Nest$smdefaultTranslationFlags  reason: not valid java name */
    static /* bridge */ /* synthetic */ int m5442$$Nest$smdefaultTranslationFlags() {
    ...
    public static final class Builder extends BaseBuilder {
        ...
        public TranslationContext build() {
            ...
            if ((j & 4) == 0) {
                this.mTranslationFlags = TranslationContext.m5442$$Nest$smdefaultTranslationFlags();
            }
            if ((this.mBuilderFieldsSet & 8) == 0) {
                this.mActivityId = TranslationContext.m5441$$Nest$smdefaultActivityId();
            }
