...
public final class TranslationResponseValue implements Parcelable {
    ...
    static /* bridge */ /* synthetic */ Bundle m5454$$Nest$smdefaultExtras() {
        return defaultExtras();
    }

    /* renamed from: -$$Nest$smdefaultText  reason: not valid java name */
    static /* bridge */ /* synthetic */ CharSequence m5455$$Nest$smdefaultText() {
        return defaultText();
    }

    /* renamed from: -$$Nest$smdefaultTransliteration  reason: not valid java name */
    static /* bridge */ /* synthetic */ CharSequence m5456$$Nest$smdefaultTransliteration() {
    ...
    public static final class Builder extends BaseBuilder {
        ...
        public TranslationResponseValue build() {
            ...
            if ((j & 2) == 0) {
                this.mText = TranslationResponseValue.m5455$$Nest$smdefaultText();
            }
            if ((this.mBuilderFieldsSet & 4) == 0) {
                this.mExtras = TranslationResponseValue.m5454$$Nest$smdefaultExtras();
            }
            if ((this.mBuilderFieldsSet & 8) == 0) {
                this.mTransliteration = TranslationResponseValue.m5456$$Nest$smdefaultTransliteration();
            }
