...
public class UiTranslationController implements Dumpable {
                    ...
                    if (viewRef != null) {
                        ...
                        if (view == null) {
                            ...
                            this.mActivity.runOnUiThread(new Runnable() { // from class: android.view.translation.UiTranslationController$$ExternalSyntheticLambda2
                                @Override // java.lang.Runnable
                                public final void run() {
                                    UiTranslationController.this.m5459x2413d371(view, response, autofillId, currentState);
                                }
                            });
                        }
                    }
    ...
    public /* synthetic */ void m5459x2413d371(View view, ViewTranslationResponse response, AutofillId autofillId, int currentState) {
    ...
    private void onUiTranslationStarted(final Translator translator, List<AutofillId> views) {
        ...
        synchronized (this.mLock) {
            ...
            this.mActivity.runOnUiThread(new Runnable() { // from class: android.view.translation.UiTranslationController$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    UiTranslationController.this.m5460xef0563c5(roots, viewIds, supportedFormats, capability, requests, translator);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m5460xef0563c5(ArrayList roots, Map viewIds, int[] supportedFormats, TranslationCapability capability, ArrayList requests, Translator translator) {
        for (int rootNum = 0; rootNum < roots.size(); rootNum++) {
