...
public final class TranslationResponse implements Parcelable {
    ...
    static /* bridge */ /* synthetic */ boolean m5449$$Nest$smdefaultFinalResponse() {
        return defaultFinalResponse();
    }

    /* renamed from: -$$Nest$smdefaultTranslationResponseValues  reason: not valid java name */
    static /* bridge */ /* synthetic */ SparseArray m5450$$Nest$smdefaultTranslationResponseValues() {
        return defaultTranslationResponseValues();
    }

    /* renamed from: -$$Nest$smdefaultViewTranslationResponses  reason: not valid java name */
    static /* bridge */ /* synthetic */ SparseArray m5451$$Nest$smdefaultViewTranslationResponses() {
    ...
    public static final class Builder extends BaseBuilder {
        ...
        public TranslationResponse build() {
            ...
            if ((j & 2) == 0) {
                this.mTranslationResponseValues = TranslationResponse.m5450$$Nest$smdefaultTranslationResponseValues();
            }
            if ((this.mBuilderFieldsSet & 4) == 0) {
                this.mViewTranslationResponses = TranslationResponse.m5451$$Nest$smdefaultViewTranslationResponses();
            }
            if ((this.mBuilderFieldsSet & 8) == 0) {
                this.mFinalResponse = TranslationResponse.m5449$$Nest$smdefaultFinalResponse();
            }
