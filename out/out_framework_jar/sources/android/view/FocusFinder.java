    ...
    public static final class FocusSorter {
        ...
        private Comparator<View> mTopsComparator = new Comparator() { // from class: android.view.FocusFinder$FocusSorter$$ExternalSyntheticLambda0
            ...
            public final int compare(Object obj, Object obj2) {
                return FocusFinder.FocusSorter.this.m4761lambda$new$0$androidviewFocusFinder$FocusSorter((View) obj, (View) obj2);
            }
        };
        private Comparator<View> mSidesComparator = new Comparator() { // from class: android.view.FocusFinder$FocusSorter$$ExternalSyntheticLambda1
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return FocusFinder.FocusSorter.this.m4762lambda$new$1$androidviewFocusFinder$FocusSorter((View) obj, (View) obj2);
            }
        };
        ...
        public /* synthetic */ int m4761lambda$new$0$androidviewFocusFinder$FocusSorter(View first, View second) {
            if (first == second) {
                return 0;
            }
        ...
        public /* synthetic */ int m4762lambda$new$1$androidviewFocusFinder$FocusSorter(View first, View second) {
            if (first == second) {
                return 0;
            }
            Rect firstRect = this.mRectByView.get(first);
