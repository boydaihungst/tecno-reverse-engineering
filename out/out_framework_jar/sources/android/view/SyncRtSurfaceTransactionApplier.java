...
public class SyncRtSurfaceTransactionApplier {
    ...
    public void scheduleApply(SurfaceParams... params) {
        ...
        this.mTargetViewRootImpl.registerRtFrameCallback(new HardwareRenderer.FrameDrawingCallback() { // from class: android.view.SyncRtSurfaceTransactionApplier$$ExternalSyntheticLambda0
            ...
            public final void onFrameDraw(long j) {
                SyncRtSurfaceTransactionApplier.this.m4988xb24fe5d1(t, j);
            }
        });
    ...
    public /* synthetic */ void m4988xb24fe5d1(SurfaceControl.Transaction t, long frame) {
    ...
    void applyTransaction(SurfaceControl.Transaction t, long frame) {
        ViewRootImpl viewRootImpl = this.mTargetViewRootImpl;
        if (viewRootImpl != null) {
            viewRootImpl.m5128lambda$applyTransactionOnDraw$11$androidviewViewRootImpl(t, frame);
        } else {
            t.apply();
        }
    }
    ...
    public static void printSurfaceParams(String LOG_TAG, SurfaceParams params) {
        StringBuilder sb = new StringBuilder();
        if ((params.flags & 128) != 0) {
            sb.append(" FLAG_TRANSACTION:").append(params.mergeTransaction);
        }
        if ((params.flags & 2) != 0) {
            sb.append(" FLAG_MATRIX:").append(params.matrix);
        }
        if ((params.flags & 4) != 0) {
            sb.append(" FLAG_WINDOW_CROP:").append(params.windowCrop);
        }
        if ((params.flags & 1) != 0) {
            sb.append(" FLAG_ALPHA:").append(params.alpha);
        }
        if ((params.flags & 8) != 0) {
            sb.append(" FLAG_LAYER:").append(params.layer);
        }
        if ((params.flags & 16) != 0) {
            sb.append(" FLAG_CORNER_RADIUS:").append(params.cornerRadius);
        }
        if ((params.flags & 32) != 0) {
            sb.append(" FLAG_BACKGROUND_BLUR_RADIUS:").append(params.backgroundBlurRadius);
        }
        if ((params.flags & 64) != 0) {
            sb.append(" FLAG_VISIBILITY:").append(params.visible);
        }
        Log.i(LOG_TAG, "printSurfaceParams:" + sb.toString());
    }
