...
public interface IWindow extends IInterface {
    ...
    void dispatchCaptionViewStatus(boolean z, int i) throws RemoteException;
    ...
    public static class Default implements IWindow {
        ...
        @Override // android.view.IWindow
        public void dispatchCaptionViewStatus(boolean show, int multiwindowMode) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IWindow {
        ...
        static final int TRANSACTION_dispatchCaptionViewStatus = 17;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 17:
                    return "dispatchCaptionViewStatus";
                default:
                    return null;
            }
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 17:
                            ...
                            data.enforceNoDataAvail();
                            dispatchCaptionViewStatus(_arg015, _arg111);
                            break;
                        default:
