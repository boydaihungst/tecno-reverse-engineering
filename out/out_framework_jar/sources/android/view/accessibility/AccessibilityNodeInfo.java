...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public void writeToParcelNoRecycle(Parcel parcel, int flags) {
        ...
        if (DEBUG && fieldIndex42 != fieldIndex84 - 1) {
            throw new IllegalStateException("Number of fields mismatch: " + fieldIndex42 + " vs " + fieldIndex);
        }
    }
    ...
    private void init(AccessibilityNodeInfo other) {
        ...
        this.mViewIdResourceName = IAccessibilityLice.Instance().osHookForCtsTest(this.mPackageName, this.mViewIdResourceName);
        ArrayList<AccessibilityAction> arrayList = this.mActions;
        if (arrayList != null) {
            arrayList.clear();
        }
        ...
        if (otherChildNodeIds != null && otherChildNodeIds.size() > 0) {
            ...
            if (longArray2 == null) {
                this.mChildNodeIds = otherChildNodeIds.m4655clone();
            } else {
