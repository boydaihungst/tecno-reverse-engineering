...
public class AnimationSet extends Animation {
    ...
    /* renamed from: clone */
    public AnimationSet mo5218clone() throws CloneNotSupportedException {
        AnimationSet animation = (AnimationSet) super.mo5218clone();
        ...
        for (int i = 0; i < count; i++) {
            animation.mAnimations.add(animations.get(i).mo5218clone());
        }
        return animation;
    }
