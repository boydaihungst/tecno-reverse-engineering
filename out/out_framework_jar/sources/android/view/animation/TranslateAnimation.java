...
public class TranslateAnimation extends Animation {
    ...
    public void setFromXDelta(float xDelta) {
        this.mFromXValue = xDelta;
    }

    public void setFromYDelta(float yDelta) {
        this.mFromYValue = yDelta;
    }
    ...
    public void setToXDelta(float xDelta) {
        this.mToXValue = xDelta;
    }

    public void setToYDelta(float yDelta) {
        this.mToYValue = yDelta;
    }
}
