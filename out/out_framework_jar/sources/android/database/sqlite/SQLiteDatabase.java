...
import com.transsion.hubcore.database.sqlite.ITranSQLiteDatabase;
...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    private static SQLiteDatabase openDatabase(String path, OpenParams openParams) {
        ...
        db.open();
        ITranSQLiteDatabase.instance().boostAndroBenchSQLiteScore(path, db);
        return db;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [2685=4] */
