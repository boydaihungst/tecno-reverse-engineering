...
public class TransitionManager {
    ...
    static /* bridge */ /* synthetic */ ArrayMap m4649$$Nest$smgetRunningTransitions() {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition transitionClone = transition.mo4647clone();
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v) {
            ...
            ArrayList<Transition> runningTransitions = (ArrayList) TransitionManager.m4649$$Nest$smgetRunningTransitions().get(this.mSceneRoot);
        ...
        public boolean onPreDraw() {
            ...
            if (TransitionManager.sPendingTransitions.remove(this.mSceneRoot)) {
                final ArrayMap<ViewGroup, ArrayList<Transition>> runningTransitions = TransitionManager.m4649$$Nest$smgetRunningTransitions();
