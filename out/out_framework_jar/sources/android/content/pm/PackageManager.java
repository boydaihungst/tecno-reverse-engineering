...
public abstract class PackageManager {
    ...
    public boolean isDefaultApplicationIcon(Drawable drawable) {
        ...
        return resId == 17301651 || resId == 17303719;
    }
    ...
    public String getDefaultMusicPackageNameAsUser(int userId) {
        throw new UnsupportedOperationException("getDefaultMusicPackageNameAsUser not implemented in subclass");
    }

    public boolean setDefaultMusicPackageNameAsUser(String musicPkg, int userId) {
        throw new UnsupportedOperationException("setDefaultMusicPackageNameAsUser not implemented in subclass");
    }

    public void checkDefaultMusic() {
        throw new UnsupportedOperationException("checkDefaultMusic not implemented in subclass");
    }
}
