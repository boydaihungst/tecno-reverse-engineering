...
public class PackageParser {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [1246=4] */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [1285=5] */
                        ...
                        if (set == null || set.contains(tagName)) {
                            ...
                            if (tagName.equals(TAG_APPLICATION)) {
                                ...
                                if (tagName.equals("overlay")) {
                                    TypedArray sa3 = res.obtainAttributes(parser, R.styleable.AndroidManifestResourceOverlay);
                                    ...
                                    if (tagName.equals(TAG_KEY_SETS)) {
                                        ...
                                        if (tagName.equals(TAG_USES_PERMISSION_SDK_M)) {
                                            ...
                                            TypedArray sa4 = res.obtainAttributes(parser, R.styleable.AndroidManifestUsesConfiguration);
                                            ...
                                            if (tagName.equals(TAG_USES_FEATURE)) {
                                                ...
                                                int i2 = SDK_VERSION;
                                                if (i2 > 0) {
                                                    TypedArray sa5 = res.obtainAttributes(parser, R.styleable.AndroidManifestUsesSdk);
                                                    int minVers = 1;
                                                    String minCode = null;
                                                    int targetVers = 0;
                                                ...
                                                TypedArray sa6 = res.obtainAttributes(parser, R.styleable.AndroidManifestSupportsScreens);
                                                ...
                                                if (tagName.equals(TAG_PROTECTED_BROADCAST)) {
                                                    TypedArray sa7 = res.obtainAttributes(parser, R.styleable.AndroidManifestProtectedBroadcast);
                                                    ...
                                                    if (tagName.equals(TAG_RESTRICT_UPDATE)) {
                                                        if ((flags & 16) != 0) {
                                                            TypedArray sa10 = res.obtainAttributes(parser, R.styleable.AndroidManifestRestrictUpdate);
    ...
    */
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:321:0x07cd, code lost:
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:325:0x07e9, code lost:
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:331:0x0810, code lost:
        r14.applicationInfo.privateFlags |= 16;
     */
    /* JADX WARN: Code restructure failed: missing block: B:332:0x0819, code lost:
    ...
    */
    ...
    public static final class Package implements Parcelable {
        ...
        /* JADX DEBUG: Type inference failed for r3v55. Raw type applied. Possible types: android.util.ArraySet<? extends java.lang.Object>, android.util.ArraySet<java.lang.String> */
