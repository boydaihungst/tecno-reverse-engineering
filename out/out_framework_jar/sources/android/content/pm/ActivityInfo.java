...
public class ActivityInfo extends ComponentInfo implements Parcelable {
    ...
    public static final int RESIZE_MODE_FORCE_RESIZEABLE_WHITE_LIST = -2;
    ...
    public static final int RESIZE_MODE_UNRESIZEABLE_BLOCK_LIST = -1;
    ...
    public static boolean isResizeableMode(int mode) {
        return mode == 2 || mode == 4 || mode == 6 || mode == 5 || mode == 7 || mode == 1 || mode == -2;
    }
    ...
    public static String resizeModeToString(int mode) {
        switch (mode) {
            case -2:
                return "RESIZE_MODE_FORCE_RESIZEABLE_WHITE_LIST";
            case -1:
                return "RESIZE_MODE_UNRESIZEABLE_BLOCK_LIST";
            case 0:
