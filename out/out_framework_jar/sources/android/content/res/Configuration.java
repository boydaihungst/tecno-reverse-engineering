...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public static final int MULTI_WINDOW_SIZE_BIG = 1000;
    public static final int MULTI_WINDOW_SIZE_SMALL = 1001;
    public static final int MULTI_WINDOW_SIZE_WELT = 1002;
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [1425=7, 1341=5, 1353=4] */
    ...
    */
                        ...
                        case 20:
                            ...
                            try {
                                try {
                                    ...
                                    Slog.e(TAG, "error parsing locale list in configuration.", e13);
                                    str = str8;
                                    token2 = token7;
                                    break;
                                }
    ...
    public int updateFrom(Configuration delta) {
        ...
        ITranActivityThread.Instance().onHandleConfigurationChanged(changed);
        return changed;
    }
    ...
    public boolean isThunderbackWindow() {
        return this.windowConfiguration.isThunderbackWindow();
    }

    public int getMultiWindowSize() {
        if ((this.windowConfiguration.getMultiWindowingMode() & 16) != 0) {
            return 1000;
        }
        if ((this.windowConfiguration.getMultiWindowingMode() & 32) != 0) {
            return 1001;
        }
        return 1002;
    }
