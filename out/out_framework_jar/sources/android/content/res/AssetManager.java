...
import com.transsion.hubcore.content.res.ITranAssetManager;
...
public final class AssetManager implements AutoCloseable {
    ...
    public static void createSystemAssetsInZygoteLocked(boolean reinitialize, String frameworkPath) {
        ...
        try {
            ...
            ITranAssetManager.Instance().onAddSystemAsstetsInZygote(apkAssets);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v5, resolved type: android.content.res.ApkAssets[] */
