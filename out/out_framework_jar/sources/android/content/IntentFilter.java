...
public class IntentFilter implements Parcelable {
    ...
    public final void addDataType(String type) throws MalformedMimeTypeException {
        processMimeType(type, new BiConsumer() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj, Object obj2) {
                IntentFilter.this.m745lambda$addDataType$0$androidcontentIntentFilter((String) obj, (Boolean) obj2);
            }
        });
    }
    ...
    public /* synthetic */ void m745lambda$addDataType$0$androidcontentIntentFilter(String internalType, Boolean isPartial) {
    ...
    public final void addDynamicDataType(String type) throws MalformedMimeTypeException {
        processMimeType(type, new BiConsumer() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda1
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                IntentFilter.this.m746lambda$addDynamicDataType$1$androidcontentIntentFilter((String) obj, (Boolean) obj2);
            }
        });
    }
    ...
    public /* synthetic */ void m746lambda$addDynamicDataType$1$androidcontentIntentFilter(String internalType, Boolean isPartial) {
        if (this.mDataTypes == null) {
            this.mDataTypes = new ArrayList<>();
        }
        if (!this.mDataTypes.contains(internalType)) {
    ...
    public Predicate<Intent> asPredicate() {
        return new Predicate() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda2
            ...
            public final boolean test(Object obj) {
                return IntentFilter.this.m747lambda$asPredicate$2$androidcontentIntentFilter((Intent) obj);
            }
        };
    }
    ...
    public /* synthetic */ boolean m747lambda$asPredicate$2$androidcontentIntentFilter(Intent i) {
    ...
    public Predicate<Intent> asPredicateWithTypeResolution(final ContentResolver resolver) {
        ...
        return new Predicate() { // from class: android.content.IntentFilter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return IntentFilter.this.m748xfc9fa7e7(resolver, (Intent) obj);
            }
        };
    }
    ...
    public /* synthetic */ boolean m748xfc9fa7e7(ContentResolver resolver, Intent i) {
    ...
    public void printAction() {
        ...
        if (this.mActions.size() > 0) {
            ...
            while (it.hasNext()) {
                ...
                sb.append(it.next());
                sb.append("\"");
                Slog.d("ActivityManagerService", " " + sb.toString());
            }
        }
    }
