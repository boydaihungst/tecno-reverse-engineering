...
public class CarrierConfigManager {
    ...
    public static final String KEY_CARRIER_WFC_IMS_WITH_GEO = "carrier_wfc_ims_with_geo";
    ...
    public static final String KEY_HIDE_3G_PLUS_DATA_ICON_BOOL = "hide_3g_plus_data_icon_bool";
    ...
    public static final String KEY_NETWORK_PREFERED_4G_ONLY_ENABLED_BOOL = "enable_network_prefered_4G_only";
    ...
    private static final boolean TRAN_UPS_DATARAT_ALWAYSSHOW_SUPPORT;
    private static final boolean TRAN_UPS_DATARAT_PLUS_SUPPORT;
    ...
    static {
        boolean equals = "1".equals(SystemProperties.get("ro.tran_ups_datarat_alwaysshow_support", AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS));
        TRAN_UPS_DATARAT_ALWAYSSHOW_SUPPORT = equals;
        boolean equals2 = "1".equals(SystemProperties.get("ro.tran_ups_datarat_plus_support", AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS));
        TRAN_UPS_DATARAT_PLUS_SUPPORT = equals2;
        ...
        persistableBundle.putAll(Apn.m4006$$Nest$smgetDefaults());
        ...
        persistableBundle.putString(KEY_CONFIG_IMS_PACKAGE_OVERRIDE_STRING, "com.google.android.ims");
        persistableBundle.putString(KEY_CONFIG_IMS_MMTEL_PACKAGE_OVERRIDE_STRING, "com.google.android.ims");
        ...
        persistableBundle.putBoolean(KEY_USE_WFC_HOME_NETWORK_MODE_IN_ROAMING_NETWORK_BOOL, true);
        ...
        if (equals) {
            persistableBundle.putBoolean(KEY_ALWAYS_SHOW_DATA_RAT_ICON_BOOL, true);
        } else {
            persistableBundle.putBoolean(KEY_ALWAYS_SHOW_DATA_RAT_ICON_BOOL, false);
        }
        if (equals2) {
            persistableBundle.putBoolean(KEY_HIDE_3G_PLUS_DATA_ICON_BOOL, false);
        } else {
            persistableBundle.putBoolean(KEY_HIDE_3G_PLUS_DATA_ICON_BOOL, true);
        }
        ...
        persistableBundle.putInt(KEY_LTE_PLUS_THRESHOLD_BANDWIDTH_KHZ_INT, 2000);
        ...
        persistableBundle.putAll(OpportunisticNetwork.m4019$$Nest$smgetDefaults());
        ...
        persistableBundle.putAll(ImsServiceEntitlement.m4012$$Nest$smgetDefaults());
        persistableBundle.putAll(Gps.m4008$$Nest$smgetDefaults());
        ...
        persistableBundle.putAll(Ims.m4009$$Nest$smgetDefaults());
        persistableBundle.putAll(ImsVoice.m4015$$Nest$smgetDefaults());
        persistableBundle.putAll(ImsSms.m4013$$Nest$smgetDefaults());
        persistableBundle.putAll(ImsRtt.m4011$$Nest$smgetDefaults());
        persistableBundle.putAll(ImsEmergency.m4010$$Nest$smgetDefaults());
        persistableBundle.putAll(ImsVt.m4016$$Nest$smgetDefaults());
        persistableBundle.putAll(ImsWfc.m4017$$Nest$smgetDefaults());
        persistableBundle.putAll(ImsSs.m4014$$Nest$smgetDefaults());
        persistableBundle.putAll(Bsf.m4007$$Nest$smgetDefaults());
        persistableBundle.putAll(Iwlan.m4018$$Nest$smgetDefaults());
        ...
        persistableBundle.putAll(Wifi.m4020$$Nest$smgetDefaults());
        ...
        persistableBundle.putBoolean(KEY_NETWORK_PREFERED_4G_ONLY_ENABLED_BOOL, false);
        persistableBundle.putBoolean(KEY_CARRIER_WFC_IMS_WITH_GEO, false);
    ...
    public static final class Apn {
        ...
        static /* bridge */ /* synthetic */ PersistableBundle m4006$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static class OpportunisticNetwork {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4019$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class ImsServiceEntitlement {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4012$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class Gps {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4008$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class Ims {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4009$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class ImsVoice {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4015$$Nest$smgetDefaults() {
            return getDefaults();
        }
        ...
        private static PersistableBundle getDefaults() {
            ...
            defaults.putInt(KEY_SESSION_EXPIRES_TIMER_SEC_INT, SettingsEnums.SETTINGS_WIFI_CONFIGURE_NETWORK);
    ...
    public static final class ImsSms {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4013$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class ImsRtt {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4011$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class ImsEmergency {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4010$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class ImsVt {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4016$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class ImsWfc {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4017$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class ImsSs {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4014$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class Bsf {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4007$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class Iwlan {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4018$$Nest$smgetDefaults() {
            return getDefaults();
        }
    ...
    public static final class Wifi {
        ...
        /* renamed from: -$$Nest$smgetDefaults  reason: not valid java name */
        static /* bridge */ /* synthetic */ PersistableBundle m4020$$Nest$smgetDefaults() {
            return getDefaults();
        }
