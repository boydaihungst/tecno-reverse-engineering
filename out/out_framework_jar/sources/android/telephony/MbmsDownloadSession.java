...
public class MbmsDownloadSession implements AutoCloseable {
    ...
    /* JADX DEBUG: Another duplicated slice has different insns count: {[IGET, INVOKE, CHECK_CAST]}, finally: {[IGET, INVOKE, CHECK_CAST, INVOKE, IF] complete} */
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [784=4, 785=4, 786=4, 787=4] */
    ...
    /* JADX DEBUG: Another duplicated slice has different insns count: {[IGET, INVOKE, CHECK_CAST]}, finally: {[IGET, INVOKE, CHECK_CAST, INVOKE, IF] complete} */
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [896=4, 897=4, 898=4, 899=4] */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [1056=4] */
