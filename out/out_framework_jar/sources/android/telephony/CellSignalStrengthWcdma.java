...
import com.transsion.hubcore.telephony.ITranCellSignalStrength;
...
public final class CellSignalStrengthWcdma extends CellSignalStrength implements Parcelable {
    ...
    private static final int[] sRssiThresholds = {-107, -97, WCDMA_RSSI_GOOD, -77, -70};
    ...
    @Override // android.telephony.CellSignalStrength
    public int getLevel() {
        return ITranCellSignalStrength.Instance().getSignalStrengthLevelWcdma(getDbm());
    }
