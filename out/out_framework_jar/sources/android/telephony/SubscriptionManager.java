...
public class SubscriptionManager {
    ...
    public List<SubscriptionInfo> getActiveSubscriptionInfoList(boolean userVisibleOnly) {
        ...
        return (List) activeList.stream().filter(new Predicate() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda16
            ...
            public final boolean test(Object obj) {
                return SubscriptionManager.this.m4102xe0664b6e((SubscriptionInfo) obj);
            }
    ...
    public int setDisplayName(final String displayName, final int subId, final int nameSource) {
        logd(Log.getStackTraceString(new Throwable()));
    ...
    public void setDefaultDataSubIdWithReason(int subscriptionId, int cause) {
        try {
            if (!Build.IS_USER) {
                Thread.dumpStack();
            }
            ISub iSub = TelephonyManager.getSubscriptionService();
            if (iSub != null) {
                iSub.setDefaultDataSubIdWithReason(subscriptionId, cause);
            }
        } catch (RemoteException e) {
        }
    }
    ...
    public boolean setOpportunistic(final boolean opportunistic, final int subId) {
        return setSubscriptionPropertyHelper(subId, "setOpportunistic", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda12
            @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
            public final int callMethod(ISub iSub) {
                return SubscriptionManager.this.m4103lambda$setOpportunistic$6$androidtelephonySubscriptionManager(opportunistic, subId, iSub);
            }
        }) == 1;
    }
    ...
    public /* synthetic */ int m4103lambda$setOpportunistic$6$androidtelephonySubscriptionManager(boolean opportunistic, int subId, ISub iSub) throws RemoteException {
    ...
    public boolean m4102xe0664b6e(SubscriptionInfo info) {
        if (info == null) {
            return false;
        }
    ...
    void setUsageSetting(final int subscriptionId, final int usageSetting) {
        setSubscriptionPropertyHelper(subscriptionId, "setUsageSetting", new CallISubMethodHelper() { // from class: android.telephony.SubscriptionManager$$ExternalSyntheticLambda2
            @Override // android.telephony.SubscriptionManager.CallISubMethodHelper
            public final int callMethod(ISub iSub) {
                return SubscriptionManager.this.m4104lambda$setUsageSetting$12$androidtelephonySubscriptionManager(usageSetting, subscriptionId, iSub);
            }
        });
    }
    ...
    public /* synthetic */ int m4104lambda$setUsageSetting$12$androidtelephonySubscriptionManager(int usageSetting, int subscriptionId, ISub iSub) throws RemoteException {
