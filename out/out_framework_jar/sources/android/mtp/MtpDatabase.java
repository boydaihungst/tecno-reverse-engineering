...
public class MtpDatabase implements AutoCloseable {
    ...
    public void addStorage(StorageVolume storage) {
        MtpStorage mtpStorage = this.mManager.addMtpStorage(storage, new Supplier() { // from class: android.mtp.MtpDatabase$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return MtpDatabase.this.m2685lambda$addStorage$0$androidmtpMtpDatabase();
            }
        });
    ...
    public /* synthetic */ Boolean m2685lambda$addStorage$0$androidmtpMtpDatabase() {
    ...
    private int getDeviceProperty(int property, long[] outIntValue, char[] outStringValue) {
        switch (property) {
            ...
            case MtpConstants.DEVICE_PROPERTY_DEVICE_FRIENDLY_NAME /* 54274 */:
                String value = SystemProperties.get("persist.sys.tran.device.name");
