...
public final class StrictMode {
    ...
    static /* bridge */ /* synthetic */ boolean m3046$$Nest$smtooManyViolationsThisLoop() {
    ...
    public static class AndroidBlockGuardPolicy implements BlockGuard.Policy {
        ...
        public void onWriteToDisk() {
            if ((this.mThreadPolicyMask & 1) == 0 || StrictMode.m3046$$Nest$smtooManyViolationsThisLoop()) {
                return;
            }
        ...
        void onCustomSlowCall(String name) {
            if ((this.mThreadPolicyMask & 8) == 0 || StrictMode.m3046$$Nest$smtooManyViolationsThisLoop()) {
                return;
            }
        ...
        void onResourceMismatch(Object tag) {
            if ((this.mThreadPolicyMask & 16) == 0 || StrictMode.m3046$$Nest$smtooManyViolationsThisLoop()) {
                return;
            }
        ...
        public void onUnbufferedIO() {
            if ((this.mThreadPolicyMask & 32) == 0 || StrictMode.m3046$$Nest$smtooManyViolationsThisLoop()) {
                return;
            }
        ...
        public void onReadFromDisk() {
            if ((this.mThreadPolicyMask & 2) == 0 || StrictMode.m3046$$Nest$smtooManyViolationsThisLoop()) {
                return;
            }
        ...
        public void onNetwork() {
            ...
            if (StrictMode.m3046$$Nest$smtooManyViolationsThisLoop()) {
                return;
            }
        ...
        public void onExplicitGc() {
            if ((this.mThreadPolicyMask & 64) == 0 || StrictMode.m3046$$Nest$smtooManyViolationsThisLoop()) {
                return;
            }
        ...
        void handleViolationWithTimingAttempt(ViolationInfo info) {
            ...
            ((Handler) StrictMode.THREAD_HANDLER.get()).postAtFrontOfQueue(new Runnable() { // from class: android.os.StrictMode$AndroidBlockGuardPolicy$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    StrictMode.AndroidBlockGuardPolicy.this.m3047x9f2643d1(windowManager, records);
                }
            });
        }
        ...
        public /* synthetic */ void m3047x9f2643d1(IWindowManager windowManager, ArrayList records) {
