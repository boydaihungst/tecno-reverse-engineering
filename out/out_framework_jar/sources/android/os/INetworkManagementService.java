...
public interface INetworkManagementService extends IInterface {
    ...
    void destorySocketByUid(int i) throws RemoteException;
    ...
    boolean setAcceleratedEnabledByPhone(boolean z) throws RemoteException;
    ...
    boolean setMultiLink(int i, Network network, boolean z) throws RemoteException;
    ...
    boolean switchAppNetWorkAccelerated(boolean z, String str) throws RemoteException;
    ...
    public static class Default implements INetworkManagementService {
        ...
        @Override // android.os.INetworkManagementService
        public void destorySocketByUid(int uid) throws RemoteException {
        }

        @Override // android.os.INetworkManagementService
        public boolean setMultiLink(int uid, Network network, boolean isMultiLink) throws RemoteException {
            return false;
        }
        ...
        @Override // android.os.INetworkManagementService
        public boolean switchAppNetWorkAccelerated(boolean isOpen, String pkgName) throws RemoteException {
            return false;
        }

        @Override // android.os.INetworkManagementService
        public boolean isAcceleratedEnabled(String pkgName) throws RemoteException {
            return false;
        }

        @Override // android.os.INetworkManagementService
        public boolean setAcceleratedEnabledByPhone(boolean enable) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements INetworkManagementService {
        ...
        static final int TRANSACTION_bindAppUidToNetwork = 56;
        static final int TRANSACTION_clearInterfaceAddresses = 6;
        static final int TRANSACTION_denyProtect = 51;
        static final int TRANSACTION_destorySocketByUid = 57;
        ...
        static final int TRANSACTION_isAcceleratedEnabled = 61;
        static final int TRANSACTION_isAppNetWorkAccelerated = 59;
        ...
        static final int TRANSACTION_setAcceleratedEnabledByPhone = 62;
        ...
        static final int TRANSACTION_setMultiLink = 58;
        ...
        static final int TRANSACTION_switchAppNetWorkAccelerated = 60;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 56:
                    return "bindAppUidToNetwork";
                case 57:
                    return "destorySocketByUid";
                case 58:
                    return "setMultiLink";
                case 59:
                    return "isAppNetWorkAccelerated";
                case 60:
                    return "switchAppNetWorkAccelerated";
                case 61:
                    return "isAcceleratedEnabled";
                case 62:
                    return "setAcceleratedEnabledByPhone";
                default:
                    return null;
            }
        }
                ...
                default:
                    switch (code) {
                        ...
                        case 56:
                            ...
                            Network _arg122 = (Network) data.readTypedObject(Network.CREATOR);
                            data.enforceNoDataAvail();
                            boolean _result13 = bindAppUidToNetwork(_arg047, _arg122);
                            reply.writeNoException();
                        ...
                        case 57:
                            ...
                            data.enforceNoDataAvail();
                            destorySocketByUid(_arg048);
                            reply.writeNoException();
                            break;
                        case 58:
                            int _arg049 = data.readInt();
                            Network _arg123 = (Network) data.readTypedObject(Network.CREATOR);
                            boolean _arg23 = data.readBoolean();
                            data.enforceNoDataAvail();
                            boolean _result14 = setMultiLink(_arg049, _arg123, _arg23);
                            reply.writeNoException();
                            reply.writeBoolean(_result14);
                            break;
                        case 59:
                            boolean _result15 = isAppNetWorkAccelerated();
                            reply.writeNoException();
                        ...
                        case 60:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result16 = switchAppNetWorkAccelerated(_arg050, _arg124);
                            reply.writeNoException();
                        ...
                        case 61:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result17 = isAcceleratedEnabled(_arg051);
                            reply.writeNoException();
                        ...
                        case 62:
                            ...
                            data.enforceNoDataAvail();
                            boolean _result18 = setAcceleratedEnabledByPhone(_arg052);
                            reply.writeNoException();
