...
public class Environment {
    ...
    private static final File DIR_TR_CARRIER_ROOT;
    private static final File DIR_TR_COMPANY_ROOT;
    private static final File DIR_TR_MI_ROOT;
    private static final File DIR_TR_PRELOAD_ROOT;
    private static final File DIR_TR_PRODUCT_ROOT;
    private static final File DIR_TR_REGION_ROOT;
    private static final File DIR_TR_THEME_ROOT;
    ...
    private static final String ENV_TR_CARRIER_ROOT = "TR_CARRIER_ROOT";
    private static final String ENV_TR_COMPANY_ROOT = "TR_COMPANY_ROOT";
    private static final String ENV_TR_MI_ROOT = "TR_MI_ROOT";
    private static final String ENV_TR_PRELOAD_ROOT = "TR_PRELOAD_ROOT";
    private static final String ENV_TR_PRODUCT_ROOT = "TR_PRODUCT_ROOT";
    private static final String ENV_TR_REGION_ROOT = "TR_REGION_ROOT";
    private static final String ENV_TR_THEME_ROOT = "TR_THEME_ROOT";
    ...
    static {
        ...
        DIR_TR_PRODUCT_ROOT = getDirectory(ENV_TR_PRODUCT_ROOT, "/tr_product");
        DIR_TR_MI_ROOT = getDirectory(ENV_TR_MI_ROOT, "/tr_mi");
        DIR_TR_THEME_ROOT = getDirectory(ENV_TR_THEME_ROOT, "/tr_theme");
        DIR_TR_PRELOAD_ROOT = getDirectory(ENV_TR_PRELOAD_ROOT, "/tr_preload");
        DIR_TR_REGION_ROOT = getDirectory(ENV_TR_REGION_ROOT, "/tr_region");
        DIR_TR_CARRIER_ROOT = getDirectory(ENV_TR_CARRIER_ROOT, "/tr_carrier");
        DIR_TR_COMPANY_ROOT = getDirectory(ENV_TR_COMPANY_ROOT, "/tr_company");
        initForCurrentUser();
    ...
    public static File getTrProductDirectory() {
        return DIR_TR_PRODUCT_ROOT;
    }

    public static File getTrMiDirectory() {
        return DIR_TR_MI_ROOT;
    }

    public static File getTrThemeDirectory() {
        return DIR_TR_THEME_ROOT;
    }

    public static File getTrPreloadDirectory() {
        return DIR_TR_PRELOAD_ROOT;
    }

    public static File getTrRegionDirectory() {
        return DIR_TR_REGION_ROOT;
    }

    public static File getTrCarrierDirectory() {
        return DIR_TR_CARRIER_ROOT;
    }

    public static File getTrCompanyDirectory() {
        return DIR_TR_COMPANY_ROOT;
    }
