...
public final class Parcel {
    ...
    @CriticalNative
    private static native long nReadAa(long j);
    ...
    public final long readAa() {
        return nReadAa(this.mNativePtr);
    }
    ...
    */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: android.os.Parcel */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean readArrayMap(ArrayMap<? super String, Object> map, int size, boolean sorted, boolean lazy, ClassLoader loader) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: android.util.SparseArray<T> */
    /* JADX WARN: Multi-variable type inference failed */
