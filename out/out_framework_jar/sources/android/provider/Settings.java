...
import com.transsion.hubcore.provider.ITranSettings;
...
public final class Settings {
    ...
    public static class NameValueCache {
        ...
        public boolean putStringForUser(ContentResolver cr, String name, String value, String tag, boolean makeDefault, int userHandle, boolean overrideableByRestore) {
            try {
                if (ITranSettings.instance().isRestrictPutStringForUser(name, value, Process.myUid(), ActivityThread.currentApplication())) {
                    return false;
                }
        ...
        /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [3268=6] */
        /* JADX WARN: Removed duplicated region for block: B:163:0x02a3  */
        /* JADX WARN: Removed duplicated region for block: B:83:0x0168 A[Catch: RemoteException -> 0x01c0, TryCatch #13 {RemoteException -> 0x01c0, blocks: (B:54:0x00de, B:57:0x00ed, B:70:0x010f, B:72:0x0115, B:74:0x011f, B:77:0x013f, B:83:0x0168, B:85:0x0172, B:81:0x014b, B:109:0x01bf, B:76:0x0125, B:87:0x0175, B:90:0x0188, B:92:0x0192, B:93:0x0195, B:94:0x01a3, B:96:0x01a7, B:98:0x01ad, B:99:0x01b2), top: B:176:0x00de }] */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:66:0x0107 -> B:108:0x01be). Please submit an issue!!! */
        /*
        ...
        */
                                                    ...
                                                    if (array != null && index >= 0) {
                                                        ...
                                                        this.mGenerationTracker = new GenerationTracker(array, index, generation, new Runnable() { // from class: android.provider.Settings$NameValueCache$$ExternalSyntheticLambda1
                                                            ...
                                                            public final void run() {
                                                                Settings.NameValueCache.this.m3267xf1f1dc4d();
                                                            }
                                                        });
        ...
        public /* synthetic */ void m3267xf1f1dc4d() {
            synchronized (this) {
        ...
        /* JADX WARN: Removed duplicated region for block: B:67:0x0123 A[Catch: RemoteException -> 0x01c6, TryCatch #8 {RemoteException -> 0x01c6, blocks: (B:40:0x00a5, B:41:0x00b1, B:48:0x00c3, B:50:0x00cb, B:52:0x00d1, B:54:0x00db, B:57:0x00f9, B:67:0x0123, B:69:0x0132, B:70:0x013a, B:72:0x0140, B:64:0x0109, B:56:0x00e1), top: B:126:0x00a5 }] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
                        ...
                        try {
                            synchronized (this) {
                                try {
                                    ...
                                    try {
                                        if (namespace.equals(DeviceConfig.NAMESPACE_DEVICE_POLICY_MANAGER) && Settings.isInSystemServer() && Binder.getCallingUid() != Process.myUid()) {
                                            long token = Binder.clearCallingIdentity();
                                                ...
                                                if (needsGenerationTracker) {
                                                    ...
                                                    if (array != null && index >= 0) {
                                                        ...
                                                        this.mGenerationTracker = new GenerationTracker(array, index, generation, new Runnable() { // from class: android.provider.Settings$NameValueCache$$ExternalSyntheticLambda0
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                Settings.NameValueCache.this.m3268xa3977f64();
                                                            }
                                                        });
                                                        currentGeneration = generation;
                                                    }
        ...
        public /* synthetic */ void m3268xa3977f64() {
            synchronized (this) {
                Log.e(Settings.TAG, "Error accessing generation tracker - removing");
                GenerationTracker generationTracker = this.mGenerationTracker;
                if (generationTracker != null) {
    ...
    public static final class System extends NameValueTable {
        ...
        public static final Uri DEFAULT_NOTIFICATION2_URI;
        public static final Uri DEFAULT_NOTIFICATION_URI;
        public static final Uri DEFAULT_RINGTONE2_URI;
        ...
        public static final String DYNAMIC_COLOR_STATE = "dynamic_color_state";
        @Readable
        ...
        public static final String FACE_LIGHT_SCREEN_SWITCH = "face_light_screen_switch";
        public static final String FACE_LIGHT_SWITCH = "face_light_switch";
        public static final String FACE_UNLOCK_SWITCH = "face_unlock_switch";
        ...
        public static final String KEYGUARD_GESTURE = "keyguard_gesture";
        public static final String LED_CHARGE = "led_charge";
        public static final String LED_LIGHT_CONTROL = "led_light_control";
        public static final String LED_LOWPOWER = "led_lowpower";
        public static final String LED_MISS_CALL = "led_miss_call";
        public static final String LED_MISS_MSG = "led_miss_msg";
        public static final String LED_NOTIFICATION = "led_notification";
        public static final String LED_NOTIFICATION_STATUS = "led_notification_status";
        public static final String LED_RECORD = "led_record";
        ...
        public static final String NOTIFICATION2_CACHE = "notification2_cache";
        public static final Uri NOTIFICATION2_CACHE_URI;
        @Readable
        @Deprecated
        ...
        public static final String NTRA_STATUS = "ntra_status";
        @Deprecated
        ...
        public static final String RINGTONE2 = "ringtone_sim2";
        ...
        @Readable
        @Deprecated
        public static final String THIRD_NLP_LOCATION_PROVIDER_ENBLE = "com.here.consent.COLLECT_RADIO_SIGNALS";
        @Readable
        ...
        static {
            ...
            hashSet.add("sysui_rounded_size");
            hashSet.add("com.here.consent.COLLECT_RADIO_SIGNALS");
            ...
            hashSet2.add(Global.SIMLOCK_NODISPLAY);
            hashSet2.add(Global.SYNC_HEARTBEAT_ENABLE);
            hashSet2.add(Global.WIFI_ASSISTANT_SWITCH);
            hashSet2.add(Global.WIFI_ASSISTANT_STATUS);
            hashSet2.add(Global.OTG_MODE);
            ...
            DEFAULT_RINGTONE2_URI = getUriFor(RINGTONE2);
            ...
            DEFAULT_NOTIFICATION2_URI = getUriFor(NOTIFICATION2);
            NOTIFICATION2_CACHE_URI = getUriFor(NOTIFICATION2_CACHE);
            ...
            arraySet.add(RINGTONE2);
            arraySet.add(NOTIFICATION2);
        ...
        public static String getStringForUser(ContentResolver resolver, String name, int userHandle) {
            ...
            if (MOVED_TO_LOCK_SETTINGS.contains(name)) {
                ...
                if (sLockSettings != null && !sIsSystemProcess) {
                    ...
                    if (isPreMnc) {
                        try {
                            return sLockSettings.getString(name, AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS, userHandle);
                        } catch (RemoteException e) {
                        }
                    } else {
    ...
    public static final class Global extends NameValueTable {
        ...
        public static final String OTG_MODE = "otg_mode";
        @Readable
        ...
        public static final String SIMLOCK_NODISPLAY = "simlock_nodisplay";
        public static final String SMART5G_SWITCH = "smart5G_switch";
        @Readable
        ...
        public static final String SYNC_HEARTBEAT_ENABLE = "sync_heartbeat_enable";
        @Readable
        ...
        @Readable
        public static final String TRANSITION_ANIMATION_SCALE = "transition_animation_scale";
        public static final String TRAN_DNS_RECORD_ENABLE = "tds_dns_record_enable";
        public static final String TRAN_DS_ATHENA_ENABLE = "tds_athena_state";
        public static final String TRAN_SIGNAL_SMOOTH_ENABLE = "tran_signal_smooth_enable";
        public static final String TRAN_SMART_DATA_ENOUGH = "ts_data_enough";
        public static final String TRAN_SMART_DATA_SWITCH_STATE = "ts_data_switch_state";
        public static final String TRAN_SMOOTH_DATA_STATE = "ts_data_state";
        public static final String TRAN_SS_ATHENA_ENABLE = "tss_athena_state";
        @Readable
        ...
        public static final String WIFI_ASSISTANT_STATUS = "wifi_assistant_status";
        public static final String WIFI_ASSISTANT_SWITCH = "wifi_assistant_switch";
        @SystemApi
        @Readable
        ...
        public static boolean putStringForUser(ContentResolver resolver, String name, String value, String tag, boolean makeDefault, int userHandle, boolean overrideableByRestore) {
            if (Secure.QS_TILES.equals(name) || Secure.THEME_CUSTOMIZATION_OVERLAY_PACKAGES.equals(name)) {
                Log.d(Settings.TAG, "Callstack for name: " + name + " , value: " + value + ", userHandle:" + userHandle, new Throwable());
            }
            if (MOVED_TO_SECURE.contains(name)) {
    ...
    public static final class Config extends NameValueTable {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static boolean deleteString(ContentResolver resolver, String namespace, String name) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static void setSyncDisabledMode(ContentResolver resolver, int disableSyncMode) {
            try {
                Bundle args = new Bundle();
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static int getSyncDisabledMode(ContentResolver resolver) {
            try {
