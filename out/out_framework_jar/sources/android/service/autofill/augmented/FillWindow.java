...
public final class FillWindow implements AutoCloseable {
        ...
        synchronized (this.mLock) {
            ...
            rootView.setOnTouchListener(new View.OnTouchListener() { // from class: android.service.autofill.augmented.FillWindow$$ExternalSyntheticLambda0
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return FillWindow.this.m3457lambda$update$0$androidserviceautofillaugmentedFillWindow(view, motionEvent);
                }
            });
            this.mShowing = false;
    ...
    public /* synthetic */ boolean m3457lambda$update$0$androidserviceautofillaugmentedFillWindow(View view, MotionEvent motionEvent) {
