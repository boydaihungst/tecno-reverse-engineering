...
public final class Presentations {
    ...
    public static final class Builder {
        ...
        public Presentations build() {
            ...
            if ((j & 1) == 0) {
                this.mMenuPresentation = Presentations.m3417$$Nest$smdefaultMenuPresentation();
            }
            if ((this.mBuilderFieldsSet & 2) == 0) {
                this.mInlinePresentation = Presentations.m3415$$Nest$smdefaultInlinePresentation();
            }
            if ((this.mBuilderFieldsSet & 4) == 0) {
                this.mDialogPresentation = Presentations.m3414$$Nest$smdefaultDialogPresentation();
            }
            if ((this.mBuilderFieldsSet & 8) == 0) {
                this.mInlineTooltipPresentation = Presentations.m3416$$Nest$smdefaultInlineTooltipPresentation();
            }
