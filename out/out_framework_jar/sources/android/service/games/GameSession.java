...
public abstract class GameSession {
    ...
    public void takeScreenshot(Executor executor, final ScreenshotCallback callback) {
        ...
        AndroidFuture<GameScreenshotResult> takeScreenshotResult = new AndroidFuture().whenCompleteAsync(new BiConsumer() { // from class: android.service.games.GameSession$$ExternalSyntheticLambda2
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                GameSession.this.m3543lambda$takeScreenshot$0$androidservicegamesGameSession(callback, (GameScreenshotResult) obj, (Throwable) obj2);
            }
        }, executor);
        try {
    ...
    public void m3543lambda$takeScreenshot$0$androidservicegamesGameSession(ScreenshotCallback callback, GameScreenshotResult result, Throwable error) {
        if (error != null) {
