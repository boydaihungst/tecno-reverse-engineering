...
public class TrustAgentService extends Service {
        ...
        synchronized (this.mLock) {
            ...
            future.thenAccept(new Consumer() { // from class: android.service.trust.TrustAgentService$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    TrustAgentService.this.m3692lambda$grantTrust$1$androidservicetrustTrustAgentService(resultCallback, (GrantTrustResult) obj);
                }
            });
    ...
    public /* synthetic */ void m3692lambda$grantTrust$1$androidservicetrustTrustAgentService(final Consumer resultCallback, final GrantTrustResult result) {
