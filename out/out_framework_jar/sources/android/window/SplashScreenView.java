...
public final class SplashScreenView extends FrameLayout {
    ...
    public static class Builder {
                ...
                if (consumer != null) {
                    consumer.accept(new Runnable() { // from class: android.window.SplashScreenView$Builder$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            SplashScreenView.Builder.this.m6244lambda$build$0$androidwindowSplashScreenView$Builder(view);
                        }
                    });
                } else {
        ...
        public /* synthetic */ void m6244lambda$build$0$androidwindowSplashScreenView$Builder(SplashScreenView view) {
            view.mIconView = createSurfaceView(view);
        }
