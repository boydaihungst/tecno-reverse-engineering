...
public class AppWidgetProviderInfo implements Parcelable {
    ...
    /* JADX DEBUG: Method merged with bridge method */
    /* renamed from: clone */
    public AppWidgetProviderInfo m681clone() {
        AppWidgetProviderInfo that = new AppWidgetProviderInfo();
        ComponentName componentName = this.provider;
        that.provider = componentName == null ? null : componentName.m720clone();
        ...
        that.configure = componentName2 != null ? componentName2.m720clone() : null;
