...
public class AppWidgetHostView extends FrameLayout {
    ...
    private RemoteViews.InteractionHandler getHandler(final RemoteViews.InteractionHandler handler) {
        return new RemoteViews.InteractionHandler() { // from class: android.appwidget.AppWidgetHostView$$ExternalSyntheticLambda0
            ...
            public final boolean onInteraction(View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse remoteResponse) {
                return AppWidgetHostView.this.m680lambda$getHandler$1$androidappwidgetAppWidgetHostView(handler, view, pendingIntent, remoteResponse);
            }
        };
    }
    ...
    public /* synthetic */ boolean m680lambda$getHandler$1$androidappwidgetAppWidgetHostView(RemoteViews.InteractionHandler handler, View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse response) {
    ...
    public void setColorResources(SparseIntArray colorMapping) {
        ...
        SparseIntArray m4680clone = colorMapping.m4680clone();
        this.mColorMapping = m4680clone;
        this.mColorResources = RemoteViews.ColorResources.create(this.mContext, m4680clone);
