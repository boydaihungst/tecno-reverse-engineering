...
public class TextToSpeech {
    ...
    public void dispatchOnInit(final int result) {
        Runnable onInitCommand = new Runnable() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda1
            ...
            public final void run() {
                TextToSpeech.this.m3791lambda$dispatchOnInit$0$androidspeechttsTextToSpeech(result);
            }
        };
    ...
    public /* synthetic */ void m3791lambda$dispatchOnInit$0$androidspeechttsTextToSpeech(int result) {
        synchronized (this.mStartLock) {
        ...
        synchronized (this.mStartLock) {
            ...
            runActionNoReconnect(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda15
                ...
                public final Object run(ITextToSpeechService iTextToSpeechService) {
                    return TextToSpeech.this.m3798lambda$shutdown$1$androidspeechttsTextToSpeech(iTextToSpeechService);
                }
            }, null, "shutdown", false);
        }
    }
    ...
    public /* synthetic */ Object m3798lambda$shutdown$1$androidspeechttsTextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public int speak(final CharSequence text, final int queueMode, final Bundle params, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda16
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3799lambda$speak$2$androidspeechttsTextToSpeech(text, queueMode, params, utteranceId, iTextToSpeechService);
            }
        }, -1, "speak")).intValue();
    }
    ...
    public /* synthetic */ Integer m3799lambda$speak$2$androidspeechttsTextToSpeech(CharSequence text, int queueMode, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public int playEarcon(final String earcon, final int queueMode, final Bundle params, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda3
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3794lambda$playEarcon$3$androidspeechttsTextToSpeech(earcon, queueMode, params, utteranceId, iTextToSpeechService);
            }
    ...
    public /* synthetic */ Integer m3794lambda$playEarcon$3$androidspeechttsTextToSpeech(String earcon, int queueMode, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public int playSilentUtterance(final long durationInMs, final int queueMode, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda9
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3795lambda$playSilentUtterance$4$androidspeechttsTextToSpeech(durationInMs, queueMode, utteranceId, iTextToSpeechService);
            }
    ...
    public /* synthetic */ Integer m3795lambda$playSilentUtterance$4$androidspeechttsTextToSpeech(long durationInMs, int queueMode, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public int stop() {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda4
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3800lambda$stop$7$androidspeechttsTextToSpeech(iTextToSpeechService);
            }
        }, -1, "stop")).intValue();
    }
    ...
    public /* synthetic */ Integer m3800lambda$stop$7$androidspeechttsTextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public int setLanguage(final Locale loc) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda7
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3796lambda$setLanguage$9$androidspeechttsTextToSpeech(loc, iTextToSpeechService);
            }
    ...
    public /* synthetic */ Integer m3796lambda$setLanguage$9$androidspeechttsTextToSpeech(Locale loc, ITextToSpeechService service) throws RemoteException {
        if (loc == null) {
            return -2;
        }
        try {
    ...
    public Locale getLanguage() {
        return (Locale) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda0
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3792lambda$getLanguage$10$androidspeechttsTextToSpeech(iTextToSpeechService);
            }
        }, null, "getLanguage");
    }
    ...
    public /* synthetic */ Locale m3792lambda$getLanguage$10$androidspeechttsTextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public int setVoice(final Voice voice) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda8
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3797lambda$setVoice$13$androidspeechttsTextToSpeech(voice, iTextToSpeechService);
            }
        }, -2, "setVoice")).intValue();
    }
    ...
    public /* synthetic */ Integer m3797lambda$setVoice$13$androidspeechttsTextToSpeech(Voice voice, ITextToSpeechService service) throws RemoteException {
    ...
    public Voice getVoice() {
        return (Voice) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda10
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3793lambda$getVoice$14$androidspeechttsTextToSpeech(iTextToSpeechService);
            }
        }, null, "getVoice");
    }
    ...
    public /* synthetic */ Voice m3793lambda$getVoice$14$androidspeechttsTextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public int synthesizeToFile(final CharSequence text, final Bundle params, final ParcelFileDescriptor fileDescriptor, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda5
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.m3801lambda$synthesizeToFile$17$androidspeechttsTextToSpeech(text, fileDescriptor, params, utteranceId, iTextToSpeechService);
            }
    ...
    public /* synthetic */ Integer m3801lambda$synthesizeToFile$17$androidspeechttsTextToSpeech(CharSequence text, ParcelFileDescriptor fileDescriptor, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
